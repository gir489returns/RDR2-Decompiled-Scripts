...
bool func_13()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Beaver Hollow - m_volTown Agg");
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2345.187f, 1352.787f, 107.6561f, 0.036552f, 0f, 0f, 40.20085f, 40.78676f, 12.88943f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2357.265f, 1391.395f, 109.9775f, 2.692848f, 0f, 0f, 17.41357f, 20.79141f, 16.64382f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2318.457f, 1444.692f, 87.40137f, 179.4571f, 0f, 0f, 51.88874f, 33.18848f, 11.92861f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2347.961f, 1414.832f, 96.40656f, 0.534309f, -14.06188f, -34.73259f, 31.42639f, 14.92058f, 9.380316f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2255.09f, 1458.163f, 93.38544f, 0f, 0f, 0f, 21.93718f, 27.58467f, 4.980723f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2272.888f, 1487.881f, 103.2379f, 11.51613f, 0f, 0f, 19.99748f, 13.49523f, 3.545758f);
	return true;
}
...
{
	if (((func_60(Global_33, iLocal_14, 1, 0) && iLocal_16 < MISC::GET_GAME_TIMER()) && func_62(func_61())) && func_63(6, 18))
	{
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_85(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
...
char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_131(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_133(func_132(Global_34));
	}
...
{
	func_138(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_139(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_115(int iParam0)
{
	...
	if (func_89(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_141(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_142(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_143(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_144(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_146(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_122(int iParam0, bool bParam1)
{
	...
	else if (func_156(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_146(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_168(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
