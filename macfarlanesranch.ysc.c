...
bool func_13()
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_20, iLocal_21);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -2397.539f, -2380.358f, 63.54964f, 0f, 0f, 69.87277f, 10.05736f, 10.47319f, 16.92971f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2455.174f, -2384.14f, 35f, 0f, 0f, 25.5349f, 24.66208f, 30.76534f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2412.317f, -2374.972f, 63.25839f, 0f, 0f, -32.90815f, 13.07416f, 14.51878f, 9.688599f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2432.721f, -2360.609f, 66.342f, 0f, 0f, -59.51217f, 44.12811f, 56.53022f, 19.75536f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2428.935f, -2393.028f, 64.86296f, 0f, 0f, 30.36721f, 35.19614f, 20.94381f, 14.33946f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2405.119f, -2471.914f, 63.25839f, 0f, 0f, 16.82132f, 13.84418f, 7.762568f, 9.688599f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2418.961f, -2436.719f, 63.54964f, 0f, 0f, 22.63921f, 15.31493f, 15.94952f, 16.92971f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2407.512f, -2449.14f, 64.5022f, 0f, 0f, 48.91291f, 13.99343f, 21.49771f, 12.90299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2416.311f, -2452.443f, 64.20742f, 0f, 0f, 3.371748f, 14.65324f, 19.53584f, 12.77374f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2399.068f, -2464.15f, 64.86296f, 0f, 0f, 18.69488f, 16.30252f, 23.22957f, 14.33946f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2414.51f, -2467.064f, 61.83258f, 0f, 0f, -78.00346f, 14.14975f, 15.2253f, 17.07607f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -2397.539f, -2380.358f, 63.54964f, 0f, 0f, 69.87277f, 10.05736f, 10.47319f, 16.92971f);
		iLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacFarlanes' Ranch - m_volRancherWarning Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_18, iLocal_20);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2407.745f, -2461.009f, 63.25839f, 0f, 0f, 21.61882f, 21.58509f, 25.8055f, 9.688599f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2418.961f, -2436.719f, 63.54964f, 0f, 0f, 22.63921f, 19.83966f, 22.38591f, 16.92971f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2395.625f, -2381.142f, 35f, 0f, 0f, 29.59317f, 9.273087f, 11.13545f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2424.377f, -2394.976f, 35f, 0f, 0f, 122.1515f, 8.7505f, 40.19938f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2409.492f, -2351.147f, 35f, 0f, 0f, 29.59317f, 9.273087f, 29.27413f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2466.104f, -2392.814f, 35f, 0f, 0f, 29.59317f, 12.03543f, 28.7101f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2450.099f, -2347.51f, 35f, 0f, 0f, 122.1515f, 8.311909f, 37.10839f, 39.15789f);
		iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacFarlanes' Ranch - m_volRancherRegistration Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_19, iLocal_18);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -2395.549f, -2409.981f, 35f, 0f, 0f, -2f, 115f, 87f, 50f);
		sLocal_17 = "MACFARLANES_RANCH";
		LAW::_CREATE_GUARD_ZONE(sLocal_17);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_17, iLocal_16);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_17, iLocal_19);
		LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_17, iLocal_21);
		LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_17, iLocal_20);
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_17, iLocal_18);
...
{
	func_60(1061997773 /* Float: 0.8f */, 1045220557 /* Float: 0.2f */, 0f, 0f);
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_65(Global_1940186, 32768)) || func_65(Global_1940186, 2.350989E-38f))
	{
		return;
	}
...
void func_60(int iParam0, int iParam1, int iParam2, float fParam3)
{
...
void func_64()
{
	...
	iVar0 = PERSCHAR::_0x112DDF56300BC6E5(7.069739E-26f);
	iVar1 = PERSCHAR::_0x112DDF56300BC6E5(4.022939E-07f);
	iVar2 = PERSCHAR::_0x112DDF56300BC6E5(1.515688E+08f);
	iVar3 = PERSCHAR::_0x112DDF56300BC6E5(-3.541862E+14f);
	iVar4 = PERSCHAR::_0x112DDF56300BC6E5(-4.960894E+27f);
	iVar5 = PERSCHAR::_0x112DDF56300BC6E5(-2.863026E+36f);
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar0))
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar0) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f, false);
			return;
		}
	}
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar1))
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar1) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f, false);
			return;
		}
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar2) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f, false);
			return;
		}
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar3) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f, false);
			return;
		}
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar4) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f, false);
			return;
		}
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar5) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f, false);
		}
		else if (PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar5) && !TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f, true);
		}
	}
}
...
bool func_67()
{
	return func_65(Global_1940186, 8192);
}
...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_62(iParam0) && func_86(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_110(&cVar6, 4.808429E-35f), sVar9, func_110(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_110(&cVar6, 4.808429E-35f), func_110(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_111(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_74(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_113(&Global_1940186, 16384);
	func_115(func_114(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_115(func_114(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_115(func_114(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_115(func_114(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_115(func_114(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_115(func_114(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_115(func_114(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_81(int iParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_20))
	{
		...
		VOLUME::DELETE_VOLUME(iLocal_20);
	}
	func_60(1061578342 /* Float: 0.775f */, 1045220557 /* Float: 0.2f */, 1020054733 /* Float: 0.025f */, 0f);
}
...
bool func_87(int iParam0)
{
	...
	return func_86(iParam0, 9.403955E-38f);
}
...
char* func_98(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_134(Global_1893611.f_162);
	}
...
int func_111(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	int iVar16;
...
{
	func_141(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_142(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_118(int iParam0)
{
	...
	if (func_90(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_144(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_145(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_146(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_147(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_149(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_125(int iParam0, bool bParam1)
{
	...
	else if (func_159(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_149(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_171(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
