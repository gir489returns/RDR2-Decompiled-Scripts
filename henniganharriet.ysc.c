...
bool func_13()
{
	...
	iLocal_22 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-9.406495E-20f, -2183.285f, -2133.454f, 73.87f, 0f, 0f, 130f, 1f, 1f, 2f);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_HORSE(iLocal_22, true);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_PLAYER(iLocal_22, true);
	iLocal_23 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-9.406495E-20f, -2184.635f, -2132.268f, 73.87f, 0f, 0f, 130f, 3.2f, 7.3f, 2f);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_HORSE(iLocal_23, true);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_PLAYER(iLocal_23, false);
	return true;
}
...
{
	func_58(39, iLocal_19, iParam0, iLocal_20, iLocal_21, 2097164, 1, 0, -1f, 0);
	func_59(39, 65536);
	func_59(39, 32768);
	func_60(39, 4096);
...
void func_60(int iParam0, int iParam1)
{
	...
	func_101(&(Global_1915643.f_3[iParam0 /*447*/].f_7), iParam1);
}
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_118(&cVar6, 4.808429E-35f), sVar9, func_118(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_118(&cVar6, 4.808429E-35f), func_118(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_119(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_72(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_121(&Global_1940186, 16384);
	func_123(func_122(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_123(func_122(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_123(func_122(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_123(func_122(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_123(func_122(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_123(func_122(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_123(func_122(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_95(int iParam0, bool bParam1)
{
	...
	else if (func_150(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_153(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
char* func_106(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_163(Global_1893611.f_162);
	}
...
char* func_118(char* sParam0, int iParam1)
{
	...
	return func_169(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
struct<2> func_122(float fParam0, float fParam1)
{
	struct<2> Var0;
...
{
	func_170(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_171(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_125(int iParam0)
{
	...
	if (func_88(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_173(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_174(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_175(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_176(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_153(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_159(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_197(12, func_196(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
{
	func_205(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_184(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_214(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_215())
	{
		return func_214(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_214(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_228(struct<2> Param0, bool bParam2)
{
	if (!func_200(Param0))
	{
		return false;
