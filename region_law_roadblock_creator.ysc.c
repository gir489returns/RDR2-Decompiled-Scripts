...
void __EntryFunction__()
{
	...
	fLocal_15 = 1f;
	iLocal_16 = 1;
	iLocal_26 = 1.086761E+14f;
	fLocal_31 = -7.670383E-09f;
	fLocal_32 = 8.542354E-31f;
...
void func_1()
{
	...
	func_11(vLocal_33, 1092616192 /* Float: 10f */, 5);
...
void func_6()
{
	...
	if (func_21(&uLocal_125) > 1108082688 && iLocal_16 <= 4)
	{
		iLocal_16 = 6;
	}
	switch (iLocal_16)
	{
		...
		case 2:
			...
			STREAMING::REQUEST_MODEL(fLocal_32, false);
			if (((STREAMING::HAS_MODEL_LOADED(fLocal_30) && STREAMING::HAS_MODEL_LOADED(fLocal_31)) && STREAMING::HAS_MODEL_LOADED(fLocal_32)) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_16 = 3;
			}
			break;
		case 3:
			if (func_24(Global_34, &Local_17, &bVar1, 16, 1, 1110704128 /* Float: 45f */, 1103626240 /* Float: 25f */, 1120403456 /* Float: 100f */, 1127481344 /* Float: 180f */, 0))
			{
		...
		case 4:
			...
			{
				func_28();
				func_29(vLocal_33, 1092616192 /* Float: 10f */, 0, 0, 5, 1);
				...
				while (iVar2 < iLocal_39)
				{
					if (func_9(iLocal_39[iVar2], 0))
					{
						...
						TASK::TASK_USE_SCENARIO_POINT(iLocal_39[iVar2], iVar3, 0, 0, false, true, 0, false, -1f, false);
					}
					iVar2++;
				}
				iLocal_16 = 5;
		...
		case 5:
			...
			while (iVar4 < iLocal_39)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_39[iVar4]))
				{
					...
					if (func_31(Global_33, iLocal_39[iVar4], 1, 1) > 1128792064)
					{
						iLocal_16 = 6;
						return;
					}
...
bool func_18(int iParam0)
{
	...
	return func_43(iParam0, 9.403955E-38f);
}
...
bool func_19()
{
	...
	if (func_44(Global_38.f_198[iVar0 /*12*/].f_1) || Global_38.f_198[iVar0 /*12*/].f_4 < 1f)
	{
		return false;
	}
	if (func_45(Global_33, Global_38.f_198[iVar0 /*12*/].f_1, (Global_38.f_198[iVar0 /*12*/].f_4 + 1092616192), 1, 1))
	{
		return true;
	}
	return false;
...
bool func_20(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_46(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_47())
	{
		return func_46(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_46(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
void func_23()
{
	...
	Local_80[0 /*4*/] = -1.104392E+38f;
	Local_80[0 /*4*/].f_1 = { 1069547520 /* Float: 1.5f */, 0f, 0f };
	Local_80[1 /*4*/] = 8.349141E-24f;
	Local_80[1 /*4*/].f_1 = { -1079194419 /* Float: -1.35f */, 0f, 0f };
	Local_80[2 /*4*/] = 4.874238E+36f;
	Local_80[2 /*4*/].f_1 = { 1f, -1071644672 /* Float: -2.5f */, 0f };
	Local_80[3 /*4*/] = 4.874238E+36f;
	Local_80[3 /*4*/].f_1 = { 1f, 6f, 0f };
	Local_80[4 /*4*/] = -1.369324E-07f;
	Local_80[4 /*4*/].f_1 = { 2f, -1071644672 /* Float: -2.5f */, 0f };
	Local_80[5 /*4*/] = 1.114469E-07f;
	Local_80[5 /*4*/].f_1 = { 2f, 1075838976 /* Float: 2.5f */, 0f };
	Local_80[6 /*4*/] = -3.768898E+29f;
	Local_80[6 /*4*/].f_1 = { -1073741824 /* Float: -2f */, 1075838976 /* Float: 2.5f */, 0f };
	Local_80[7 /*4*/] = -1.104392E+38f;
	Local_80[7 /*4*/].f_1 = { -1073741824 /* Float: -2f */, -1071644672 /* Float: -2.5f */, 0f };
	Local_47[0 /*4*/] = -1.104392E+38f;
	Local_47[1 /*4*/] = 1.733792E-17f;
	Local_47[2 /*4*/] = 2.538692E+08f;
	Local_47[3 /*4*/] = 4.874238E+36f;
	Local_47[4 /*4*/] = -60.48201f;
	Local_47[5 /*4*/] = 5.186376E+13f;
	Local_47[6 /*4*/] = -3.768898E+29f;
	Local_47[7 /*4*/] = 1.114469E-07f;
}

bool func_24(vector3 vParam0, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, int iParam10, float fParam11)
{
	int iVar0;
	...
	switch (*iParam3)
	{
		case 0:
			...
			func_52(&(iParam3->f_1), iParam3->f_2, vParam0, iParam5, iParam7, iParam8, iParam9, iParam10, fParam11);
...
void func_25(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
	if (!func_34(iParam0))
	{
...
void func_27()
{
	...
	iLocal_39[iLocal_28] = func_56(fLocal_30, vVar0, (fLocal_36 + MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 60f)), 1, 1, 0, 1, 1, 1, 0, 0);
...
void func_28()
{
	...
	vVar0 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vLocal_33, fLocal_36, 2f, 0f, 0f) };
	func_55(&vVar0, 50, 10, 0, 0);
	iLocal_45 = VEHICLE::CREATE_VEHICLE(fLocal_31, vVar0, (fLocal_36 + MISC::GET_RANDOM_FLOAT_IN_RANGE(15f, 30f)), true, true, false, false);
	iVar11 = 0;
	while (iVar11 < iLocal_27)
	{
		...
		iLocal_119[iVar11] = TASK::CREATE_SCENARIO_POINT_HASH(Var7, vVar3, fVar6, 0, 0, false);
		iVar11++;
	}
	vVar0 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vLocal_33, fLocal_36, -3f, -3f, 0f) };
	func_55(&vVar0, 50, 10, 0, 0);
	iLocal_46 = OBJECT::CREATE_OBJECT(fLocal_32, vVar0, true, true, false, false, true);
	iVar15 = 0;
	while (iVar15 < iLocal_27)
	{
		Var7 = { func_58(&Local_47) };
		fVar16 = 1069547520; /* Float: 1.5f */
		vVar12 = { func_60(((1135869952 / IntToFloat(iLocal_27)) * IntToFloat(iVar15))) };
		vVar3 = { vVar0 + vVar12 * Vector(fVar16, fVar16, fVar16) };
		fVar6 = func_59(vVar3, vVar0);
		func_55(&vVar3, 50, 10, 0, 0);
		iLocal_113[iVar15] = TASK::CREATE_SCENARIO_POINT_HASH(Var7, vVar3, fVar6, 0, 0, false);
		iVar15++;
	}
}
...
void func_52(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, float fParam8, float fParam9, float fParam10)
{
	int iVar0;
	int iVar1;
	...
	if (fParam8 == -1138501878)
	{
		switch (iParam5)
		{
			...
			case 36:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1092616192 /* Float: 10f */, 1109393408 /* Float: 40f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1106247680 /* Float: 30f */, 1114636288 /* Float: 60f */, 5f, iParam1));
			...
			case 37:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1109393408 /* Float: 40f */, 1117782016 /* Float: 80f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1112014848 /* Float: 50f */, 1119092736 /* Float: 90f */, 5f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 1092616192 /* Float: 10f */);
			...
			case 38:
				TASK::_0x2EB977293923C723(*uParam0, 1106247680 /* Float: 30f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1106247680 /* Float: 30f */, 1114636288 /* Float: 60f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1112014848 /* Float: 50f */, 1117782016 /* Float: 80f */, 5f, iParam1));
			...
			case 39:
				TASK::_0x2EB977293923C723(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(0f, 1092616192 /* Float: 10f */, 1f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(5f, 1097859072 /* Float: 15f */, 1f, iParam1));
			...
			case 40:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1114636288 /* Float: 60f */, 1123024896 /* Float: 120f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1120403456 /* Float: 100f */, 1124204544 /* Float: 130f */, 5f, iParam1));
			...
			case 41:
				TASK::_0x2EB977293923C723(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1092616192 /* Float: 10f */, 1108082688 /* Float: 35f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1103626240 /* Float: 25f */, 1112014848 /* Float: 50f */, 5f, iParam1));
			...
			case 45:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1114636288 /* Float: 60f */, 1117782016 /* Float: 80f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1117126656 /* Float: 75f */, 1119748096 /* Float: 95f */, 5f, iParam1));
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 1092616192 /* Float: 10f */);
			...
			case 50:
				TASK::_0x2EB977293923C723(*uParam0, 1106247680 /* Float: 30f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1106247680 /* Float: 30f */, 1116471296 /* Float: 70f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1115815936 /* Float: 65f */, 1119748096 /* Float: 95f */, 5f, iParam1));
			...
			case 51:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1103626240 /* Float: 25f */, 1108082688 /* Float: 35f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */, 5f, iParam1));
			...
			case 52:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1109393408 /* Float: 40f */, 1120403456 /* Float: 100f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 42:
				TASK::_0x2EB977293923C723(*uParam0, 1112014848 /* Float: 50f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1112014848 /* Float: 50f */, 1116471296 /* Float: 70f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1115815936 /* Float: 65f */, 1118437376 /* Float: 85f */, 5f, iParam1));
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x450080DDEDB91258(*uParam0, 1103626240 /* Float: 25f */);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 49:
				...
				TASK::_0x2EB977293923C723(*uParam0, 1112014848 /* Float: 50f */);
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1092616192 /* Float: 10f */, 1112014848 /* Float: 50f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 43:
				TASK::_0x2EB977293923C723(*uParam0, func_67(1119748096 /* Float: 95f */, 1119092736 /* Float: 90f */, 1117782016 /* Float: 80f */, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, func_67(1119748096 /* Float: 95f */, 1119092736 /* Float: 90f */, 1117782016 /* Float: 80f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1123680256 /* Float: 125f */, 1122369536 /* Float: 115f */, 1120403456 /* Float: 100f */, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 5f);
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 46:
				...
				{
					TASK::_0x2EB977293923C723(*uParam0, func_67(1120403456 /* Float: 100f */, 1117782016 /* Float: 80f */, -1063256064 /* Float: -5f */, iParam1));
					TASK::_0x954451EA2D2120FB(*uParam0, func_67(1120403456 /* Float: 100f */, 1117782016 /* Float: 80f */, -1063256064 /* Float: -5f */, iParam1));
					TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1121714176 /* Float: 110f */, 1126170624 /* Float: 160f */, 1095237632 /* Float: 12.5f */, iParam1));
				}
				else
				{
					TASK::_0x2EB977293923C723(*uParam0, func_67(1120403456 /* Float: 100f */, 1116471296 /* Float: 70f */, -1058013184 /* Float: -7.5f */, iParam1));
					TASK::_0x954451EA2D2120FB(*uParam0, 70f);
					TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1117782016 /* Float: 80f */, 1125515264 /* Float: 150f */, 1099694080 /* Float: 17.5f */, iParam1));
				}
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x450080DDEDB91258(*uParam0, 1103626240 /* Float: 25f */);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
			...
			case 47:
				...
				TASK::_0x2EB977293923C723(*uParam0, 1112014848 /* Float: 50f */);
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1112014848 /* Float: 50f */, 1119092736 /* Float: 90f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				if (iParam1 <= 2)
				{
					TASK::_0x764DB5A48390FBAD(*uParam0, 1);
			...
			case 48:
				...
				TASK::_0x2EB977293923C723(*uParam0, func_67(1120403456 /* Float: 100f */, 1116471296 /* Float: 70f */, -1058013184 /* Float: -7.5f */, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, 70f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_67(1125515264 /* Float: 150f */, 1128136704 /* Float: 190f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				if (iParam1 <= 2)
				{
					TASK::_0x764DB5A48390FBAD(*uParam0, 1);
...
struct<4> func_58(float fParam0)
{
	struct<4> Var0;
	int iVar4;
	int iVar5;
	...
	while (iVar5 < 8)
	{
		if ((*fParam0)[iVar4 /*4*/] != iLocal_26)
		{
			Var0 = { *(fParam0[iVar4 /*4*/]) };
			(*fParam0)[iVar4 /*4*/] = iLocal_26;
		}
		else
		{
			iVar4++;
...
float func_67(int iParam0, float fParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_78(vector3 vParam0)
{
	...
	return func_79(vParam0, Global_1892764[iVar0 /*3*/].f_1, Global_1892764[iVar0 /*3*/].f_2, Global_1892764[iVar0 /*3*/], 4);
}
