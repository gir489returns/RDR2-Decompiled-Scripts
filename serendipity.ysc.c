...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_63(Global_1940186, 32768)) || func_63(Global_1940186, 2.350989E-38f))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-1.042271E+15f, 0.4424044f))
		{
			switch (iLocal_52)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_76(iLocal_52, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
...
void func_62(int iParam0, bool bParam1)
{
	...
	func_98(Var30.f_6, Var30, -1f, -1f, 1, 1, 1);
	if (bParam1)
	{
		func_97(0);
	}
...
bool func_65()
{
	return func_63(Global_1940186, 8192);
}
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_84(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_113(&cVar6, 4.808429E-35f), sVar9, func_113(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_113(&cVar6, 4.808429E-35f), func_113(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_114(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_72(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_116(&Global_1940186, 16384);
	func_118(func_117(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_118(func_117(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_118(func_117(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_118(func_117(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_118(func_117(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_118(func_117(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_118(func_117(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
{
	iParam0 = iParam0;
	func_119(&uLocal_16, 0);
	func_119(&uLocal_26, 0);
	func_119(&uLocal_36, 0);
}
...
bool func_85(int iParam0)
{
	...
	return func_84(iParam0, 9.403955E-38f);
}
...
bool func_93(Vector3* vParam0, float* fParam1)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (func_136(uVar0, iVar2, vParam0, fParam1))
		{
			return true;
		}
	}
...
void func_96(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	if (func_138(255) == 4)
	{
		return;
...
void func_98(vector3 vParam0, float fParam3, float fParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	float fVar3;
	...
	fVar3 = fParam3;
	if (!func_145(Global_1295619.f_12, &vVar0, &fVar3))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false) };
		fVar3 = fParam3;
	}
	func_146(vParam0, fParam3, vVar0, fVar3, fParam4, fParam5, iParam6, fParam7, fParam8, 1);
}
...
char* func_101(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_150(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_152(func_151(Global_34));
	}
...
struct<2> func_117(float fParam0, float fParam1)
{
	struct<2> Var0;
...
void func_121(int iParam0)
{
	...
	if (func_88(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_164(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
...
bool func_134(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_184(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_185())
	{
		return func_184(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_184(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_136(var uParam0, int iParam1, Vector3* vParam2, float* fParam3)
{
	struct<5> Var0;
...
void func_142(struct<29> Param0, var uParam29, int iParam30)
{
	switch (Param0.f_5)
	{
		case 1:
...
void func_143(struct<6> Param0, var uParam6, var uParam7, var uParam8, int iParam9)
{
	switch (Param0.f_5)
	{
		case 1:
...
bool func_144(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
bool func_145(vector3 vParam0, Vector3* vParam3, float* fParam4)
{
	var uVar0;
	int iVar1;
	int iVar2;

	uVar0 = Global_1072759.f_23824.f_383[func_186(vParam0) /*272*/];
	iVar1 = func_135(uVar0);
	if (iVar1 <= 0)
	{
		return false;
	...
	{
		iVar2 = MISC::GET_RANDOM_INT_IN_RANGE(0, iVar1);
		if (func_136(uVar0, iVar2, vParam3, fParam4))
		{
			return true;
		}
	}
...
void func_146(vector3 vParam0, float fParam3, vector3 vParam4, float fParam7, float fParam8, float fParam9, bool bParam10, float fParam11, float fParam12, int iParam13)
{
	if (func_138(255) == 4)
	{
		return;
...
bool func_157(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	return VOLUME::DOES_VOLUME_EXIST(iParam0);
}

void func_158(struct<6> Param0, var uParam6)
{
...
{
	func_197(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_188()
{
	...
	if (!func_190(Global_1051268) && Global_1572887.f_8 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_192(vector3 vParam0, int iParam3)
{
	...
	func_218(iParam3, &vVar0, &Var3, &uVar6);
	if (func_219(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
void func_218(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_219(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
