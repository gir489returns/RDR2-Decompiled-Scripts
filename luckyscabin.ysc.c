...
void __EntryFunction__()
{
	...
	fLocal_14 = 1f;
	fLocal_15 = 1f;
	fLocal_17 = 2.051394E-09f;
	vLocal_19 = { -1004972419, 1141137732, 1119671157 };
	vLocal_22 = { 0f, 0f, -1035468800 /* Float: -50f */ };
	iLocal_31 = 20000;
...
void func_60()
{
	...
	{
		case 0:
			STREAMING::REQUEST_MODEL(fLocal_17, false);
			STREAMING::REQUEST_ANIM_DICT("MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A");
			if (STREAMING::HAS_MODEL_LOADED(fLocal_17) && STREAMING::HAS_ANIM_DICT_LOADED("MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A"))
			{
				func_91();
				if (NETWORK::NETWORK_AWARD_HAS_REACHED_MAXCLAIM(-5.906448E+22f))
				{
					iLocal_18 = OBJECT::CREATE_OBJECT(2.051394E-09f, vLocal_19, false, false, false, true, true);
				}
				else if (!UNLOCK::UNLOCK_IS_UNLOCKED(-3.523351E-16f))
				{
					iLocal_18 = OBJECT::CREATE_OBJECT(2.051394E-09f, vLocal_19, false, false, false, true, true);
				}
				else
				{
					iLocal_18 = OBJECT::CREATE_OBJECT(2.051394E-09f, vLocal_19, false, false, false, false, true);
				}
				...
				if (NETWORK::NETWORK_AWARD_HAS_REACHED_MAXCLAIM(-5.906448E+22f))
				{
					TASK::_SET_SCENARIO_CONTAINER_OPENING_STATE(iLocal_18, true);
		...
		case 1:
			...
			{
				if (!func_93(-5.906448E+22f, 0, 255, 1, 0))
				{
				}
				iLocal_26 = 2;
			}
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_83(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_108(&cVar6, 4.808429E-35f), sVar9, func_108(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_108(&cVar6, 4.808429E-35f), func_108(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_109(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_111(&Global_1940186, 16384);
	func_113(func_112(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_113(func_112(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_113(func_112(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_113(func_112(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_113(func_112(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_113(func_112(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_113(func_112(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_91()
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_16))
	{
		vVar0 = { -1004931695, 1141150007, 1119739576 };
		vVar3 = { 0f, 0f, -1022612799 };
		vVar6 = { 7f, 1090519040 /* Float: 8f */, 5f };
		iLocal_16 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, "LuckysCabin");
		NETWORK::_NETWORK_SPAWN_CONFIG_ADD_EXCLUSION_VOLUME(iLocal_16);
	}
}
...
bool func_92(int iParam0)
{
	...
	{
		if (SCRIPTS::GET_EVENT_AT_INDEX(0, iVar4) == 2.024716E+10f)
		{
...
int func_93(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<2> Var0;
	struct<2> Var12;
	var uVar25;
	...
	Var0.f_1 = 10;
	Var12.f_1 = 11;
	return func_128(bParam0, &uVar25, &Var12, &Var0, iParam1, iParam2, iParam3, bParam4);
}
...
char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_132(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_134(func_133(Global_34));
	}
...
int func_109(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	int iVar16;
...
struct<2> func_112(float fParam0, float fParam1)
{
	struct<2> Var0;
...
{
	func_139(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_140(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_115(int iParam0)
{
	...
	if (func_87(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_142(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_143(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_144(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_145(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_147(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_122(int iParam0, bool bParam1)
{
	...
	else if (func_157(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_147(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
int func_128(bool bParam0, var uParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	if (iVar1 != 0)
	{
		func_162(iParam2, -3.005759E+25f);
	}
	if (!bParam7)
	{
...
void func_163(var uParam0, bool bParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
