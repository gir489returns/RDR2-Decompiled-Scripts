...
void func_2()
{
	iLocal_16 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-3685.423f, -2597.155f, -10f, 0f, 0f, -24.7897f, 116.6365f, 76.68949f, 15f, "m_volArmadillo_Restriction");
	func_9(iLocal_16);
	iLocal_17 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-4800.448f, -2704.913f, 28.17212f, 0f, 0f, -47.25f, 134.75f, 95.75f, 50f, "m_VolRidgewoodFarm_Restriction");
	func_10(iLocal_17);
	iLocal_18 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-3959.882f, -2132.151f, -5.324f, 0f, 0f, 0f, 35f, 35f, 20f, "m_volTwinRocks_Restriction");
	func_10(iLocal_18);
}
...
void func_3()
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_11() && !func_12())
		{
			iLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volGuardThreat");
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -3960.03f, -2122.22f, -4.99f, 0f, 0f, 51f, 4.85f, 7.96f, 13.94f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -3955.38f, -2127.12f, -4.19f, 0f, 0f, 51f, 7.61f, 7.5f, 12.32f);
			iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volGuardRestricted");
			VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_20, iLocal_21);
			VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3962.87f, -2135.84f, -5.32f, 0f, 0f, 0f, 27f, 27f, 20f);
			VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3934.91f, -2138.85f, -5.32f, 0f, 0f, 0f, 10f, 10f, 20f);
			iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volGuardRegistration");
			VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_19, iLocal_20);
			VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -3959.88f, -2132.15f, -5.32f, 0f, 0f, 0f, 50f, 50f, 20f);
			sLocal_26 = "TWIN_ROCKS";
			LAW::_CREATE_GUARD_ZONE(sLocal_26);
			LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_26, iLocal_19);
			LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_26, iLocal_20);
			LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_26, iLocal_20);
			LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_26, iLocal_21);
		}
	}
}
...
void func_6()
{
	...
	iVar0 = PERSCHAR::_0x112DDF56300BC6E5(283.5186f);
	iVar1 = PERSCHAR::_0x112DDF56300BC6E5(1682600f);
	iVar2 = PERSCHAR::_0x112DDF56300BC6E5(76.79709f);
	iVar3 = PERSCHAR::_0x112DDF56300BC6E5(3.635147E+13f);
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar3))
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar3) && func_13(-2.041119E+33f))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-2.729991E+29f, Global_34))
			{
				func_14(-2.041119E+33f);
			}
		}
	}
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar2))
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar2) && func_13(-2.041119E+33f))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-2.729991E+29f, Global_34))
			{
				func_14(-2.041119E+33f);
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar1) && func_13(-2.041119E+33f))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-2.729991E+29f, Global_34))
			{
				func_14(-2.041119E+33f);
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar0) && func_13(-2.041119E+33f))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-2.729991E+29f, Global_34))
			{
				func_14(-2.041119E+33f);
		...
		else if (PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar0) && !func_13(-2.041119E+33f))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(-2.729991E+29f, Global_34))
			{
				func_15(-2.041119E+33f);
			}
		}
	}
}
...
void func_16()
{
	func_20(-1.616865E-24f);
	func_20(-0.3154291f);
	func_20(-1.591639E-31f);
	func_20(8.183708E+29f);
	func_20(0.0005582368f);
	func_20(6.543406E+24f);
	func_20(-1.807036E+36f);
	func_20(2.891021E+31f);
	func_20(1.421677E+23f);
	func_20(-0.03798556f);
	func_20(6.216828E+08f);
	func_20(-186871.9f);
	func_20(2.184205E-13f);
	func_20(-6.940664E+11f);
	func_20(7.024284E-21f);
	func_20(-1.787519E+24f);
	func_20(2.536711E-18f);
	func_20(-84.64201f);
	func_20(-1.86477E-09f);
	func_20(-4.182385E-20f);
	func_20(1.076769E-29f);
	func_20(-2.687638E+37f);
	func_20(-1.670703E-13f);
	func_20(-1.297406E+11f);
	func_20(0.01220651f);
	func_20(1.228785E-13f);
	func_20(-1.285511E-37f);
	func_20(8.576427E-38f);
	func_20(-0.007248363f);
	func_20(0.008344787f);
	func_20(1.029218E-37f);
	func_20(1.246054E-21f);
	func_20(-6.587331E+20f);
	func_20(7.032715E-35f);
	func_20(-1.099604E-13f);
	func_20(3.421749E-14f);
	func_20(-1.143616E-24f);
	func_20(-8.679586E-24f);
	func_20(2.871342E+28f);
	func_20(9.685376E+36f);
	func_20(0.2721131f);
	func_20(-6.87686E+28f);
	func_20(3.837618E-33f);
	func_20(-2.537217E+09f);
	func_20(-2.077047E-07f);
	func_20(-6.365671E+28f);
	func_20(5.00685E+36f);
	func_20(1.027703f);
	func_20(-3.675381E+32f);
	func_20(-3.603114E+21f);
	func_20(-2.008843E-19f);
	iLocal_22[0] = 0;
	iLocal_22[1] = 0;
	iLocal_22[2] = 0;
}
