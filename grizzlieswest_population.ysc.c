...
void func_2()
{
	iLocal_16 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-600f, 2695f, 330f, 0f, 0f, 0f, 250f, 200f, 200f, "m_volAdlerRanch_Restriction");
	func_9(iLocal_16);
	iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volColter_Restriction");
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -1320f, 2425f, 305f, 0f, 0f, 0f, 115f, 115f, 15f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -1410f, 2435f, 327.5f, 0f, 0f, 0f, 25f, 25f, 25f);
	func_9(iLocal_17);
	iLocal_18 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-411.5007f, 1732.159f, 220.7082f, 0f, 0f, 17.18846f, 71.74252f, 70.79237f, 31.05772f, "m_volChezPorter_Restriction");
	func_10(iLocal_18, 0, 0);
	iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volWinterMiningTown_Restriction");
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -1947.5f, 1332.25f, 216f, 0f, 0f, 0f, 8f, 8f, 30f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -1898.5f, 1346.5f, 216f, 0f, 0f, 0f, 48f, 48f, 30f);
	func_10(iLocal_19, 0, 0);
	iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volLakeIsabella_Restriction");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1888.756f, 1801.481f, 235.7563f, 0f, 0f, 25.73841f, 74.84248f, 98.28612f, 31.18848f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1954.793f, 1783.318f, 243.2873f, 0f, 0f, 0f, 46.64574f, 29.92818f, 11.7102f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1762.221f, 1695.654f, 241.4712f, 0f, 0f, 41.08257f, 79.25368f, 154.9331f, 19.56473f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1701.788f, 1569.332f, 236.8674f, 0f, 0f, 0f, 35.55024f, 41.68321f, 26.91513f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1778.828f, 1559.399f, 224.9684f, 0f, 0f, 52.77263f, 63.78292f, 40.76912f, 36.18432f);
	func_11(iLocal_20, 0, 0);
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-166.7533f, 1728.319f, 179.9066f, 0f, 0f, -50.0001f, 19.31775f, 14.36033f, 21.41382f, "m_volGranitePass_Restriction");
	POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_21, 2228767, 0, 0, -1, -1, 2);
	POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(iLocal_21, 2228767, 0, 0, -1, -1, 0);
	func_12();
}
...
void func_5()
{
	if (BUILTIN::VDIST(Global_34, -573.6422f, 2709.223f, 320.4839f) < 1120403456)
	{
		switch (Global_1939583.f_314)
		{
			case 0:
				Global_1939583.f_313 = ENTITY::PIN_CLOSEST_MAP_ENTITY(-3.843805E+24f, -573.6422f, 2709.223f, 320.4839f, 11);
				Global_1939583.f_314 = 1;
				break;
			case 1:
				if (ENTITY::IS_MAP_ENTITY_PINNED(Global_1939583.f_313))
				{
					ENTITY::SET_ENTITY_VISIBLE(ENTITY::_GET_PINNED_MAP_ENTITY(Global_1939583.f_313), false);
					ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(ENTITY::_GET_PINNED_MAP_ENTITY(Global_1939583.f_313), false, false);
					func_13(1.353372E-25f);
					Global_1939583.f_314 = 2;
				}
				break;
			case 3:
				Global_1939583.f_314 = 1;
...
void func_7()
{
	if (ENTITY::IS_MAP_ENTITY_PINNED(Global_1939583.f_313))
	{
		ENTITY::_UNPIN_MAP_ENTITY(Global_1939583.f_313);
	}
	Global_1939583.f_314 = 0;
}
...
void func_12()
{
	...
	iVar0 = 5;
	VOLUME::REQUEST_VOLUME_LOCK(-1779.387f, 1638.848f, 235.6611f, 17f, iVar0, 8192);
	VOLUME::REQUEST_VOLUME_LOCK(-1782.244f, 1654.248f, 235.6611f, 19f, iVar0, 8192);
	VOLUME::REQUEST_VOLUME_LOCK(-1803.302f, 1669.097f, 235.6611f, 22f, iVar0, 8192);
}
