...
void func_1(int iParam0, var uParam1, var uParam2)
{
	...
	func_10(NETWORK::_NETWORK_GET_SIZE_OF_PLAYER_BROADCAST_DATA_STORAGE(&(Local_40[0 /*2*/])), 65, "m_sNetCampDogPlayerData");
...
int func_14(var uParam0, var uParam1, int* iParam2)
{
	...
	switch (iVar1)
	{
		...
		case 3:
			break;
		case 4:
			PED::_PED_EMOTIONAL_PRESET_LOCO_MOTION(iVar0, "Interaction_Happy", 0, 20000, 4);
			break;
		case 5:
			break;
		case 6:
...
bool func_25(var uParam0, var uParam1, int* iParam2, var uParam3, var uParam4, var uParam5)
{
	...
	switch (iVar0)
	{
		...
		case 6:
			...
			{
				func_67(uParam0->f_2, 9.800182E-23f);
				func_60(uParam0, 7);
			}
			break;
		case 7:
...
bool func_28(var uParam0, var uParam1, int* iParam2)
{
	...
	if (!func_91(vVar14, 1125515264 /* Float: 150f */))
	{
		return true;
	}
	return false;
...
int func_29(var uParam0, var uParam1, int* iParam2)
{
	...
	else if (!PED::_IS_PED_QUEUED_FOR_DELETION(iVar0))
	{
		PED::FADE_AND_DESTROY_PED(&iVar0);
	}
	return 1;
}
...
int func_35(var uParam0, var uParam1, int* iParam2)
{
	...
	iVar0 = NETWORK::NET_TO_PED(uParam0->f_1);
	if (!func_96(iVar0, 1.498129E+22f))
	{
...
int func_36(var uParam0, var uParam1, int* iParam2)
{
	...
	bVar2 = func_99(iVar0, iVar1, 1, 1) > 1090519040;
	if (bVar2)
	{
		if (!func_96(iVar0, 672823.8f))
		{
	...
	if (!func_96(iVar0, -4.648159E-31f))
	{
...
int func_37(var uParam0, var uParam1, int* iParam2)
{
	...
	if (!func_96(iVar0, 2.446422E-13f))
	{
...
int func_38(var uParam0, var uParam1, int* iParam2)
{
	...
	bVar12 = func_106(iVar1, vVar2, 1114636288 /* Float: 60f */, &iVar10, &uVar11);
...
void func_41(var uParam0, int iParam1)
{
	...
	func_112(2, Global_1147572.f_6, 1.576726E-13f);
	func_112(6, Global_1147572.f_6, 4.101503E-35f);
	func_112(6, Global_1147572.f_6, -1.059077E+37f);
	func_112(6, Global_1147572.f_6, 459146.8f);
	func_112(6, Global_1147572.f_6, -1.933807E+26f);
	func_112(6, Global_1147572.f_6, -5.446338E-17f);
	func_112(6, Global_1147572.f_6, -7.673307E-14f);
	func_112(6, Global_1147572.f_6, 2.19083E-29f);
	func_112(6, Global_1147572.f_6, 5.223972E-19f);
	func_112(6, Global_1147572.f_6, -1.456021E-21f);
	func_112(6, Global_1147572.f_6, -1.4958E-33f);
	func_112(6, Global_1147572.f_6, 3.125337f);
	func_112(6, Global_1147572.f_6, 4.170437E-12f);
	func_112(6, Global_1147572.f_6, -2.523327E+37f);
	if (Global_1142409.f_2060 != 0)
	{
		func_112(2, Global_1147572.f_6, Global_1142409.f_2060);
	}
}
...
void func_47(var uParam0, int iParam1)
{
	...
	if (bVar2)
	{
		if (!func_118(iParam1, -1.25922E+36f))
		{
			return;
		}
	...
	ENTITY::_SET_ENTITY_FADE_IN(iParam1);
}
...
void func_48(int* iParam0)
{
	...
	func_112(2, PED::GET_PED_RELATIONSHIP_GROUP_HASH(iVar0), Global_1147572.f_6);
}
...
void func_49(var uParam0, int* iParam1)
{
	...
	if (bVar5)
	{
		...
		{
			iParam1->f_9 = MAP::BLIP_ADD_FOR_ENTITY(-4.450028E+35f, iVar1);
		}
	}
...
void func_50(int iParam0, int iParam1)
{
	...
	iVar1 = NETWORK::_NETWORK_GET_PLAYER_FAST_INSTANCE_ID(iParam0);
...
void func_51(var uParam0, int* iParam1, int iParam2, int iParam3)
{
	...
	if (!func_30(iParam1, 1))
	{
		if (fVar4 <= BUILTIN::POW(5f, 2f))
		{
			...
			bVar14 = MISC::REGISTER_INTERACTION_LOCKON_PROMPT(iParam3, &cVar5, 2.5f, 0f, 0, 0f, 0f, 0, bVar13, -1);
			if (bVar14 || bVar15)
			{
				func_32(iParam1, 1);
			}
	...
	{
		bVar14 = MISC::UNREGISTER_INTERACTION_LOCKON_PROMPT(iParam3);
		if (bVar14)
		{
			func_117(iParam1, 1);
		}
...
void func_56(var uParam0, var uParam1, int iParam2)
{
	...
	iVar1 = PLAYER::GET_PLAYER_PED(iVar0);
	if (func_99(iParam2, iVar1, 1, 1) > 1090519040)
	{
		return;
	}
	if (!func_127())
	...
	iVar2 = MAP::_BLIP_ADD_FOR_STYLE(4.405368E-11f);
	Global_1904398.f_8870 = PLAYER::PLAYER_ID();
	func_128(620, iVar2, 1);
	func_107(uParam1, 2);
}
...
{
	PED::REMOVE_RELATIONSHIP_GROUP(Global_1147572.f_6);
	return true;
}
...
bool func_64(int iParam0)
{
	...
	if (func_130(&(Global_1147579[iParam0 /*12*/]), 2))
	{
		return true;
	}
	return false;
...
bool func_65(int iParam0)
{
	...
	if (func_130(&(Global_1147579[iParam0 /*12*/]), 3))
	{
		return true;
	}
	return false;
...
bool func_74(var uParam0, var uParam1, int* iParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT_PRESET(iVar6, iVar7, false);
	if (!NETWORK::NETWORK_HAS_ENTITY_BEEN_REGISTERED_WITH_THIS_THREAD(iVar6))
	{
	...
	NETWORK::NETWORK_ALLOW_ENTITY_FADING_FOR_INSTANCES(iVar6, false);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iVar6, Global_1147572.f_6);
...
int func_79(var uParam0, var uParam1, int* iParam2)
{
	...
	vVar12 = { vVar2 };
	iVar15 = PED::GET_PED_MOTION_FOCUS_ENTITY(iVar0);
...
bool func_87(int iParam0)
{
	...
	bVar0 = func_130(&(Global_1147579[iParam0 /*12*/]), 0);
	return bVar0;
}
...
bool func_88(int iParam0)
{
	...
	bVar0 = func_130(&(Global_1147579[iParam0 /*12*/]), 1);
	return bVar0;
}
...
bool func_89(int iParam0)
{
	...
	if (func_130(&(Global_1147579[iParam0 /*12*/]), 4))
	{
		return true;
	}
	return false;
...
{
	return func_145(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 4.795139E-15f, iParam0, iParam1);
}
...
int func_97(int iParam0, int iParam1, bool bParam2)
{
	...
	if (TASK::IS_PED_EXITING_SCENARIO(iParam1, true))
	{
		return 0;
	}
	...
	TASK::TASK_USE_SCENARIO_POINT(iParam1, iVar0, 0, 0, bVar6, bParam2, iVar7, false, fVar8, false);
	return 1;
}
...
int func_98(int iParam0, int iParam1)
{
	...
	TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(iParam0, iParam1, 0, 0, 2f, 2f, 8, 0, 0, 1.5f, 2f);
	PED::_0xAAC0EE3B4999ABB5(iParam0, iParam1);
	PED::_0xF634E2892220EF34(iParam0, 0);
	PED::SET_PED_RESET_FLAG(iParam0, 229, true);
	PED::_PED_EMOTIONAL_PRESET_LOCO_MOTION(iParam0, "Interaction_Happy", iParam1, 20000, 4);
	return 1;
}
...
int func_101(int iParam0, int iParam1)
{
	...
	fVar0 = -1.023774E-29f;
	TASK::TASK_BARK(iParam0, iParam1, fVar0);
	return 1;
}
...
Vector3 func_103(int iParam0)
{
	if (iParam0 == 255)
	{
		return Global_1144511[func_146() /*83*/].f_38.f_4;
	}
	return Global_1144511[iParam0 /*83*/].f_38.f_4;
}
...
int func_106(int iParam0, vector3 vParam1, float fParam4, int iParam5, var uParam6)
{
	...
	iVar1 = ENTITY::_GET_ENTITIES_NEAR_POINT(vParam1, fParam4, iVar0, 1);
	fVar3 = 1232348160;
	bVar4 = false;
	iVar5 = 0;
	while (iVar5 < iVar1)
...
bool func_111(var uParam0, int iParam1)
{
	...
	bVar8 = PED::ADD_RELATIONSHIP_GROUP(&cVar0, &(Global_1147572.f_6));
	return bVar8;
}
...
bool func_115(var uParam0)
{
	...
	fVar14 = 1109393408; /* Float: 40f */
	fVar15 = 1117782016; /* Float: 80f */
	iVar16 = (uParam0->f_2 % 20);
	fVar10 = (fVar10 + ((BUILTIN::TO_FLOAT(iVar16) * 1106247680) * func_150((uParam0->f_2 % 2) == 0, 1f, -1f)));
	vVar17 = { vVar7 + Vector(0f, -BUILTIN::COS(fVar10), BUILTIN::SIN(fVar10)) * FtoV(((fVar15 + fVar14) * 1056964608)) };
	...
	switch (iVar20)
	{
		...
		case 1:
			...
			while (iVar21 < 10)
			{
				if (!PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(vVar17, iVar21, &vVar3, 1, 3f, 0))
				{
					func_154(uParam0, 2);
					return false;
				}
			...
			break;
		case 2:
			if (func_156(vVar17, &(uParam0->f_3), &bVar22, iVar6, 0, 180f, 20f, -0.01f, -0.01f, 0))
			{
		...
		case 3:
			if (uParam0->f_13 == 0)
			{
				...
				iVar30 = 23;
				uParam0->f_13 = PATHFIND::NAVMESH_REQUEST_PATH(0, vVar27, vVar7, iVar30);
				if (uParam0->f_13 == -1)
				{
					uParam0->f_14++;
					uParam0->f_13 = 0;
			...
			{
				iVar31 = PATHFIND::_NAVMESH_REQUESTED_QUERY_STATUS(uParam0->f_13);
				switch (iVar31)
				{
					case 2:
						break;
					...
					case 1:
						...
						iVar32 = PATHFIND::_NAVMESH_REQUESTED_PATH_WAYPOINTS_TERRAIN(uParam0->f_13);
						if (func_157(iVar32, 2))
						{
							PATHFIND::_NAVMESH_CLEAR_REQUESTED_PATH(uParam0->f_13);
							func_154(uParam0, 5);
							return false;
...
bool func_120(var uParam0, int* iParam1, int iParam2, char[4] cParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_122(int iParam0, char[4] cParam1)
{
	...
	*cParam1 = { Global_1147579[iParam0 /*12*/].f_2 };
	return true;
}
...
int func_124(int iParam0)
{
	...
	if (PED::_IS_ANIMAL_INTERACTION_RUNNING(iParam0))
	{
		return 1;
	}
	return 0;
...
void func_126(int iParam0)
{
	...
	func_160(&(Global_1147579[iParam0 /*12*/]), 3);
}
...
int func_134(bool bParam0)
{
	...
	if (func_169(bParam0, -3.954944E-11f))
	{
		iVar0 = 0;
	}
	else if (func_169(bParam0, 0.05128385f))
	{
		iVar0 = 1;
	}
	else if (func_169(bParam0, 2.708889E+07f))
	{
		iVar0 = 2;
	}
	else
...
void func_140(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = BUILTIN::ROUND(func_178(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 1094713344 /* Float: 12f */));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
bool func_156(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, float fParam7, int iParam8, int iParam9, int iParam10, float fParam11)
{
	int iVar0;
	...
	switch (*iParam3)
	{
		case 0:
			...
			func_191(&(iParam3->f_1), iParam3->f_2, vParam0, iParam5, fParam7, iParam8, iParam9, iParam10, fParam11);
...
bool func_164(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_165(iParam0, 262144) || !Global_1904398.f_8866)
		{
			return false;
		}
	}
...
void func_186(var uParam0, var uParam1, int* iParam2)
{
	...
	bVar1 = MISC::UNREGISTER_INTERACTION_LOCKON_PROMPT(iVar0);
	func_117(iParam2, 1);
	func_117(iParam2, 3);
	func_32(iParam2, 2);
	func_32(iParam2, 4);
...
void func_189(var uParam0, var uParam1)
{
	...
	bVar1 = UNLOCK::UNLOCK_IS_UNLOCKED(uParam0->f_6);
	func_212(uParam1->f_2, 9.800182E-23f, bVar1);
}
...
void func_191(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, float fParam8, float fParam9, float fParam10)
{
	int iVar0;
	int iVar1;
	...
	if (fParam8 == -1138501878)
	{
		switch (iParam5)
		{
			...
			case 36:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1092616192 /* Float: 10f */, 1109393408 /* Float: 40f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1106247680 /* Float: 30f */, 1114636288 /* Float: 60f */, 5f, iParam1));
			...
			case 37:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1109393408 /* Float: 40f */, 1117782016 /* Float: 80f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1112014848 /* Float: 50f */, 1119092736 /* Float: 90f */, 5f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 1092616192 /* Float: 10f */);
			...
			case 38:
				TASK::_0x2EB977293923C723(*uParam0, 1106247680 /* Float: 30f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1106247680 /* Float: 30f */, 1114636288 /* Float: 60f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1112014848 /* Float: 50f */, 1117782016 /* Float: 80f */, 5f, iParam1));
			...
			case 39:
				TASK::_0x2EB977293923C723(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(0f, 1092616192 /* Float: 10f */, 1f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(5f, 1097859072 /* Float: 15f */, 1f, iParam1));
			...
			case 40:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1114636288 /* Float: 60f */, 1123024896 /* Float: 120f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1120403456 /* Float: 100f */, 1124204544 /* Float: 130f */, 5f, iParam1));
			...
			case 41:
				TASK::_0x2EB977293923C723(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1092616192 /* Float: 10f */, 1108082688 /* Float: 35f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1103626240 /* Float: 25f */, 1112014848 /* Float: 50f */, 5f, iParam1));
			...
			case 45:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1114636288 /* Float: 60f */, 1117782016 /* Float: 80f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1117126656 /* Float: 75f */, 1119748096 /* Float: 95f */, 5f, iParam1));
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 1092616192 /* Float: 10f */);
			...
			case 50:
				TASK::_0x2EB977293923C723(*uParam0, 1106247680 /* Float: 30f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1106247680 /* Float: 30f */, 1116471296 /* Float: 70f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1115815936 /* Float: 65f */, 1119748096 /* Float: 95f */, 5f, iParam1));
			...
			case 51:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1103626240 /* Float: 25f */, 1108082688 /* Float: 35f */, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */, 5f, iParam1));
			...
			case 52:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1109393408 /* Float: 40f */, 1120403456 /* Float: 100f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 42:
				TASK::_0x2EB977293923C723(*uParam0, 1112014848 /* Float: 50f */);
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1112014848 /* Float: 50f */, 1116471296 /* Float: 70f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1115815936 /* Float: 65f */, 1118437376 /* Float: 85f */, 5f, iParam1));
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x450080DDEDB91258(*uParam0, 1103626240 /* Float: 25f */);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 49:
				...
				TASK::_0x2EB977293923C723(*uParam0, 1112014848 /* Float: 50f */);
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1092616192 /* Float: 10f */, 1112014848 /* Float: 50f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 43:
				TASK::_0x2EB977293923C723(*uParam0, func_213(1119748096 /* Float: 95f */, 1119092736 /* Float: 90f */, 1117782016 /* Float: 80f */, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, func_213(1119748096 /* Float: 95f */, 1119092736 /* Float: 90f */, 1117782016 /* Float: 80f */, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1123680256 /* Float: 125f */, 1122369536 /* Float: 115f */, 1120403456 /* Float: 100f */, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 5f);
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 46:
				...
				{
					TASK::_0x2EB977293923C723(*uParam0, func_213(1120403456 /* Float: 100f */, 1117782016 /* Float: 80f */, -1063256064 /* Float: -5f */, iParam1));
					TASK::_0x954451EA2D2120FB(*uParam0, func_213(1120403456 /* Float: 100f */, 1117782016 /* Float: 80f */, -1063256064 /* Float: -5f */, iParam1));
					TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1121714176 /* Float: 110f */, 1126170624 /* Float: 160f */, 1095237632 /* Float: 12.5f */, iParam1));
				}
				else
				{
					TASK::_0x2EB977293923C723(*uParam0, func_213(1120403456 /* Float: 100f */, 1116471296 /* Float: 70f */, -1058013184 /* Float: -7.5f */, iParam1));
					TASK::_0x954451EA2D2120FB(*uParam0, 70f);
					TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1117782016 /* Float: 80f */, 1125515264 /* Float: 150f */, 1099694080 /* Float: 17.5f */, iParam1));
				}
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 1092616192 /* Float: 10f */);
				TASK::_0x450080DDEDB91258(*uParam0, 1103626240 /* Float: 25f */);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
			...
			case 47:
				...
				TASK::_0x2EB977293923C723(*uParam0, 1112014848 /* Float: 50f */);
				TASK::_0x954451EA2D2120FB(*uParam0, 0f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1112014848 /* Float: 50f */, 1119092736 /* Float: 90f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				if (iParam1 <= 2)
				{
					TASK::_0x764DB5A48390FBAD(*uParam0, 1);
			...
			case 48:
				...
				TASK::_0x2EB977293923C723(*uParam0, func_213(1120403456 /* Float: 100f */, 1116471296 /* Float: 70f */, -1058013184 /* Float: -7.5f */, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, 70f);
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_213(1125515264 /* Float: 150f */, 1128136704 /* Float: 190f */, 1092616192 /* Float: 10f */, iParam1));
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				if (iParam1 <= 2)
				{
					TASK::_0x764DB5A48390FBAD(*uParam0, 1);
...
float func_213(int iParam0, float fParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_224(vector3 vParam0)
{
	...
	return func_225(vParam0, Global_1892764[iVar0 /*3*/].f_1, Global_1892764[iVar0 /*3*/].f_2, Global_1892764[iVar0 /*3*/], 4);
}
