...
bool func_13()
{
	iLocal_16 = Global_1887363[101 /*36*/].f_5;
	return true;
}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-1.042271E+15f, 0.4424044f))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_75(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
void func_112(bool bParam0)
{
	if (bParam0)
	{
		...
		func_138(&Global_1940186, 8388608);
	}
	else
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
		func_109(&Global_1940186, 8388608);
	}
