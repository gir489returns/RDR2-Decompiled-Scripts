...
void func_1(int iParam0)
{
	...
	func_10(NETWORK::_NETWORK_GET_SIZE_OF_HOST_BROADCAST_DATA_STORAGE(&Local_0), 10, "m_hostData");
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&vLocal_10, 97, 43);
	func_11(NETWORK::_NETWORK_GET_SIZE_OF_PLAYER_BROADCAST_DATA_STORAGE(&(vLocal_10[0 /*3*/])), 97, "m_clientData");
	func_12(0);
...
void func_13(bool bParam0)
{
	...
	iVar0 = 255;
	MISC::COPY_SCRIPT_STRUCT(&Local_107, bParam0, 5);
...
void func_41()
{
	...
	iVar0 = Global_1207465.f_231.f_1066[Local_107.f_12 /*17*/].f_5;
	Var1.f_10 = 30f;
	Var1.f_15 = 4;
	Var1.f_20 = 4;
	Var1.f_26 = -1;
	...
	Local_0.f_6 = func_107(GANG::NETWORK_GET_GANG_LEADER(GANG::NETWORK_GET_GANG_ID(iVar0)));
	func_108(256);
...
void func_59()
{
	...
	func_157(Local_107.f_9, iVar0, 0, 255, 0);
	func_130(4);
	if (bVar1)
	{
		func_158(Local_107.f_1, Local_107.f_2);
		if (!func_60(256))
		{
			if (iVar0 == 1)
			{
				func_159(Local_107.f_18, 1);
			}
			else
			{
				func_159(Local_107.f_18, 0);
			}
			func_130(256);
		}
		func_160(Local_107.f_18);
	}
	else
	{
		func_159(Local_107.f_18, 2);
	}
}

bool func_60(int iParam0)
{
	return func_161(Local_107.f_7, iParam0);
}
...
void func_62()
{
	...
	if (bVar0)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(Local_107.f_19.f_4))
		{
...
int func_64(var uParam0)
{
	...
	iVar0 = func_164(uParam0, uParam0->f_9);
	if (iVar0 != -1)
	{
		return iVar0;
	}
	...
	*bParam0 = 1;
	...
	switch (iParam1)
	{
		case 0:
			...
			bParam0->f_11 = { func_173(func_107(iParam2)) };
			break;
	}
}
...
void func_93(bool bParam0, int iParam1, int iParam2)
{
	...
	*bParam0 = 10;
	...
	func_182(bParam0, iParam1, iParam2);
	switch (iParam1)
	{
		case 0:
...
void func_100(bool bParam0, int iParam1, int iParam2)
{
	...
	*bParam0 = func_186(iVar0);
	bParam0->f_1 = 0;
	bParam0->f_6 = 2;
	func_171(bParam0, 32);
	if (iParam2 != -1)
	{
		bParam0->f_9 = func_188(func_187(iVar0), iParam2);
		bParam0->f_15[0] = func_189(func_187(iVar0), iParam2);
		bParam0->f_5 = func_190(iVar0, iParam2);
		bParam0->f_11 = { func_191(iVar0, iParam2) };
	}
}
...
bool func_109(int iParam0)
{
	...
	return (func_194(iParam0) && Global_1141317[iParam0 /*27*/].f_18.f_1 != 0);
}
...
bool func_111(struct<31> Param0, var uParam31)
{
	...
	{
		if (VOLUME::DOES_VOLUME_COLLIDE_WITH_ANY_VOLUME_LOCK(Local_107.f_15, Param0.f_10, false, 0, 0))
		{
			VOLUME::_0xFA15C9A320E707B0();
			*uParam31 = 1;
			return false;
		}
		func_196(&uVar1, Param0);
		Local_0.f_3 = VOLUME::REQUEST_VOLUME_LOCK_WITH_ARGS(&uVar1);
		func_132(128);
	}
	else if (!func_115(128, 255))
	{
		Local_0.f_3.f_1 = func_197(Param0);
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(Local_0.f_3.f_1))
		{
			return true;
		}
...
bool func_115(int iParam0, int iParam1)
{
	...
	return func_161(vLocal_10[iParam1 /*3*/], iParam0);
}

bool func_116(int iParam0)
{
	return func_161(Local_0.f_1, iParam0);
}
	...
	while (iVar2 <= 0)
	{
		if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_0.f_7.f_1[iVar2]))
		{
			...
			else
			{
				if (iVar2 == 0)
				{
					ENTITY::PLACE_ENTITY_ON_GROUND_PROPERLY(NETWORK::NET_TO_ENT(Local_0.f_7.f_1[iVar2]), false);
...
void func_128(int iParam0)
{
	if (func_60(iParam0))
	{
		func_207(&(Local_107.f_7), iParam0);
	}
}
...
int func_129(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_209(&(Global_1144511[iVar1 /*83*/].f_70.f_1), 1);
	}
	else
	{
		func_210(&(Global_1144511[iVar1 /*83*/].f_70.f_1), 1);
	}
	return 1;
}
...
void func_130(int iParam0)
{
	if (!func_60(iParam0))
	{
		func_193(&(Local_107.f_7), iParam0);
	}
}

void func_131(int iParam0)
{
	if (func_161(vLocal_10[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/], iParam0))
	{
		func_207(&(vLocal_10[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]), iParam0);
	}
}
...
void func_132(int iParam0)
{
	...
	{
		func_193(&(vLocal_10[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/]), iParam0);
	}
}
...
bool func_135()
{
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(1.731201E+17f, 15, 0, 0);
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(1.731201E+17f, false))
	{
		iVar1 = 0;
	}
	iVar2 = 0;
...
bool func_139()
{
	if (!TASK::DOES_SCENARIO_POINT_EXIST(Local_107.f_19.f_4))
	{
		Local_107.f_19.f_4 = TASK::CREATE_SCENARIO_POINT_HASH(1.731201E+17f, Local_107.f_15, func_216(), 0, 0, false);
	}
	return TASK::DOES_SCENARIO_POINT_EXIST(Local_107.f_19.f_4);
}
...
void func_157(struct<2> Param0, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	iVar0 = func_230(func_229(Param0));
...
{
	func_113(&(Global_1260791.f_3351[iParam0]));
	switch (iParam1)
	{
		case 0:
			Global_1260791.f_3357[iParam0] = func_235(iParam0);
			break;
		case 1:
			Global_1260791.f_3357[iParam0] = func_236(iParam0);
			break;
		case 2:
			Global_1260791.f_3357[iParam0] = func_237(iParam0);
			break;
	}
}
...
int func_164(var uParam0, int iParam1)
{
	...
	{
		iVar1 = ((iVar0 + func_240(iParam1)) - 1);
	}
...
void func_182(bool bParam0, int iParam1, int iParam2)
{
	switch (iParam1)
	{
		case 0:
...
var func_188(int iParam0, int iParam1)
{
	...
	if (func_253(&Var1, iParam0) && func_254(&Var1, iParam1))
	{
		func_255(Var1, 16.1929f, &uVar0, 0);
	}
	return uVar0;
}
...
int func_189(int iParam0, int iParam1)
{
	...
	if (func_253(&Var1, iParam0) && func_254(&Var1, iParam1))
	{
		func_255(Var1, -12.40885f, &iVar0, 0);
	}
	return iVar0;
}
...
void func_196(var uParam0, struct<12> Param1, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31)
{
	*uParam0 = { Param1.f_11 };
...
int func_197(struct<31> Param0)
{
	var uVar0;

	func_196(&uVar0, Param0);
...
int func_199(int iParam0, int iParam1)
{
	...
	if (!func_260(&(Local_0.f_7.f_1[iParam0]), func_214(iParam0), func_259(), 1, 0))
	{
		*iParam1 = 1;
		return 0;
	}
...
{
	return func_161(Local_107.f_5, iParam0);
}

bool func_202(int iParam0)
{
	return func_161(Local_107.f_6, iParam0);
}
...
void func_217(struct<2> Param0)
{
	if (func_231(Param0) == 0)
	{
	}
	else if (!STATS::STATSTRACKER_IS_INITIALIZED(func_231(Param0)))
	{
		STATS::_0x99230691875FC218(func_229(Param0), func_231(Param0), Global_34);
	}
}
...
bool func_219(int iParam0, int iParam1)
{
	...
	Var0 = { func_268(iParam0, 12648.71f) };
...
bool func_222()
{
	...
	bVar0 = true;
	if (bVar0 && !UNLOCK::UNLOCK_IS_UNLOCKED(Local_107.f_14))
	{
		return false;
	}
	if (func_269())
	...
	if (func_270(PLAYER::GET_PLAYER_INDEX()))
	{
		return false;
	}
	return true;
...
void func_225()
{
	if (func_271(Local_107.f_15, 1f, 1101004800 /* Float: 20f */))
	{
		func_272();
	}
}
...
void func_226()
{
	if (!ENTITY::DOES_ENTITY_EXIST(Local_107.f_19.f_5))
	{
		Local_107.f_19.f_5 = TASK::GET_PROP_FOR_SCENARIO_POINT(Local_107.f_19.f_4, "PrimaryItem");
		if (ENTITY::DOES_ENTITY_EXIST(Local_107.f_19.f_5))
		{
			PLAYER::_REGISTER_EAGLE_EYE_FOR_ENTITY(PLAYER::PLAYER_ID(), Local_107.f_19.f_5, false);
			PLAYER::_0x6ECFC621A168424C(Local_107.f_19.f_5, Local_107.f_19.f_5, 0, 0f);
			ENTITY::SET_ENTITY_PROOFS(Local_107.f_19.f_5, 2, false);
			ENTITY::SET_ENTITY_PROOFS(Local_107.f_19.f_5, 4, false);
		}
	}
	if (PED::IS_PED_USING_SCENARIO_HASH(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 1.731201E+17f) && ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), -9.538731E+13f))
	{
		func_273(1);
		func_274(1);
	}
...
void func_227()
{
	...
	if (func_275(1))
	{
		if (!PED::IS_PED_USING_SCENARIO_HASH(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 1.731201E+17f) && !func_276())
		{
			Var0 = { func_277(-1.209973E+11f) };
	...
	if (func_281(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), Local_107.f_15, 1) > 1109393408)
	{
		func_274(2);
	}
	else
...
void func_232(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<2> func_238(int iParam0)
{
	...
	{
		case 1:
			return func_290(-1.11244E+21f);
		case 2:
			return func_290(-0.03766548f);
		case 3:
			return func_290(20967.98f);
		case 4:
			return func_290(20967.98f);
	}
	return Var0;
...
int func_255(vector3 vParam0, int iParam3, var uParam4, float fParam5, int iParam6, bool bParam7)
{
	var uVar0;
...
Vector3 func_259()
{
	...
	{
		case 0:
			vVar0 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_107.f_15, func_216(), 1f, -0.5f, 0f) };
			break;
		case 2:
			vVar0 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Local_107.f_15, func_216(), -1f, -0.5f, 0f) };
			break;
...
bool func_260(var uParam0, int iParam1, vector3 vParam2, bool bParam5, int iParam6)
{
...
{
	return func_161(Local_107.f_19.f_7, iParam0);
}

bool func_263(int iParam0)
{
	return func_161(Local_107.f_19.f_6, iParam0);
}
...
bool func_266(var uParam0, int iParam1)
{
	...
	if (uParam0->f_4.f_1 != Local_107.f_1)
	{
		return false;
	}
	if (uParam0->f_4 != Local_107)
	{
		return false;
	}
	if (uParam0->f_4.f_2 != Local_107.f_2)
	{
		return false;
	}
	if (uParam0->f_4.f_3 != Local_107.f_3)
	{
		return false;
	}
	return true;
...
void func_267(var uParam0)
{
	...
	switch (uParam0->f_9)
	{
		case -773758976:
			func_293();
			iVar1 = GANG::NETWORK_GET_GANG_ID(uParam0->f_10);
			iVar2 = GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
			if (((GANG::NETWORK_IS_GANG_ID_VALID(iVar1) && GANG::NETWORK_IS_GANG_IN_SESSION(iVar1)) && GANG::NETWORK_IS_GANG_ID_VALID(iVar2)) && GANG::NETWORK_IS_GANG_IN_SESSION(iVar2))
			{
				if (iVar1 == iVar2)
				{
					bVar0 = true;
			...
			if (uParam0->f_10 == PLAYER::PLAYER_ID() || bVar0)
			{
				func_272();
				func_282();
				func_294(1);
...
struct<2> func_268(int iParam0, int iParam1)
{
	struct<2> Var0;
	struct<2> Var2;
	int iVar4;
...
bool func_270(int iParam0)
{
	...
	if (func_297(iParam0, &uVar0, &iVar1, 1))
	{
		if (iVar1 != -1)
		{
			return true;
...
bool func_271(vector3 vParam0, float fParam3, float fParam4)
{
	if (fParam4 + fParam3) < MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, func_298(PLAYER::GET_PLAYER_INDEX()), true)
	{
		return false;
	}
...
void func_272()
{
	...
	if (!func_115(32, 255))
	{
		func_299(Local_107.f_1, Local_107.f_3);
		if (!func_115(1024, 255))
		{
			func_300(Local_107.f_1);
			func_132(1024);
		}
		iVar0 = func_233(Local_107.f_1, Local_107.f_2);
		func_301(iVar0);
		func_302(iVar0);
		func_130(2);
		func_303(Local_107.f_9);
		func_304(Local_107.f_1);
		func_305(Local_107.f_1, Local_107.f_2, Local_107.f_3);
		if (func_306(Local_107.f_1))
		{
			func_307(0, 3.031687E-09f);
			func_130(1024);
		}
		func_132(32);
	}
...
{
	func_193(&(Local_107.f_19.f_1), iParam0);
}
...
void func_274(int iParam0)
{
	...
	func_193(&(vLocal_10[iVar0 /*3*/].f_1.f_1), iParam0);
}

bool func_275(int iParam0)
{
	return func_161(Local_107.f_19.f_1, iParam0);
}

bool func_276()
{
	if (ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), -8.475671E+16f))
	{
		return true;
	}
	return false;
...
struct<15> func_277(float fParam0)
{
	struct<15> Var0;

	Var0.f_10 = 255;
	MISC::COPY_SCRIPT_STRUCT(&(Var0.f_4), &Local_107, 5);
	Var0.f_9 = fParam0;
	Var0 = 185;
...
{
	func_309(uParam0, func_308(4, 117));
}
...
void func_279()
{
	...
	iVar0 = func_310(Global_34, 1);
	func_311(iVar0, 0);
}

void func_280(int iParam0)
{
	func_207(&(Local_107.f_19.f_1), iParam0);
}

float func_281(int iParam0, vector3 vParam1, bool bParam4)
{
...
void func_283(int iParam0)
{
	...
	func_207(&(vLocal_10[iVar0 /*3*/].f_1.f_1), iParam0);
}
...
void func_289(var uParam0)
{
	...
	*uParam0 = 183;
	...
	func_314(uParam0, uParam0->f_1);
}

struct<2> func_290(float fParam0)
{
	struct<2> Var0;
...
void func_293()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_107.f_19.f_5))
	{
		...
		vVar0 = { vVar0.x, vVar0.y, (vVar0.z - 1092616192) };
...
struct<2> func_296(int iParam0, int iParam1)
{
	struct<2> Var0;
...
bool func_297(int iParam0, var uParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_299(int iParam0, int iParam1)
{
	...
	Var31 = { func_268(iParam0, 1.309684E+10f) };
	...
	if (!func_105(&Var0, 4) && func_315(iVar33) == Var0.f_1)
	{
		iVar33 = 0;
	}
...
void func_301(int iParam0)
{
	...
	if (func_112(Global_1260791[iParam0 /*4*/]))
	{
		return;
	}
	func_317(iParam0, &iVar0, &iVar1);
	Var2.f_10 = 30f;
	Var2.f_15 = 4;
	Var2.f_20 = 4;
	Var2.f_26 = -1;
	...
	func_113(&(Global_1260791[iParam0 /*4*/]));
	iVar33 = Var2.f_5;
	if (iVar33 != 0)
	{
		Var34 = { func_290(2.053409E-33f) };
		STATS::STAT_ID_SET_INT(&Var34, iVar33, true);
		Var34 = { func_290(3.713784E-31f) };
		STATS::STAT_ID_SET_INT(&Var34, Global_1295619.f_16, true);
	}
	iVar36 = Var2.f_9;
	if (iVar36 != 0)
	{
		Var37 = { func_290(5.118777E-05f) };
		STATS::STAT_ID_SET_INT(&Var37, iVar36, true);
		Var37 = { func_290(5.331718E-07f) };
...
void func_303(struct<2> Param0)
{
	...
	{
		STATS::STATSTRACKER_DEED_STARTED(func_231(Param0), Global_265213.f_122484.f_80.f_12);
		if (func_318(Param0, &Var0))
		{
...
void func_304(int iParam0)
{
	...
	Var0 = { func_268(iParam0, -2.211749E-26f) };
...
int func_307(bool bParam0, float fParam1)
{
	if (!NETWORK::NETWORK_IS_IN_SESSION())
	{
		return 0;
...
{
	return func_321(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 4.795139E-15f, iParam0, iParam1);
}
...
int func_311(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_323(&Var4, 2.95884E+10f);
	return func_324(iParam0, &Var4, &uVar0, iParam1, 0);
}

bool func_312(struct<2> Param0, bool bParam2)
{
	if (!func_36(Param0))
	{
		return false;
...
void func_316(int iParam0)
{
	...
	Var1 = { func_268(iParam0, 12648.71f) };
...
bool func_318(struct<2> Param0, var uParam2)
{
	vector3 vVar0;

	vVar0.f_1 = -1;
	vVar0.f_2 = -1;
	func_312(Param0, &vVar0);
	if (func_326(Param0, vVar0.x, uParam2))
	{
		return true;
	}
	return false;
...
var func_321(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_328());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_328());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_328());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_329(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1295619.f_149[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_331(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
int func_324(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	var uVar0;
	struct<15> Var1;
...
bool func_326(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_337(iParam0, uParam1, &uVar0))
	{
		func_338(iParam0, &uVar0, uParam2);
	}
	else
	{
		return false;
...
{
	func_323(uParam0, 8.505438E-34f);
	if (func_342() == 3.272964E+34f)
	{
		func_323(uParam0, 8.967694E-17f);
	}
	else
	{
		func_323(uParam0, 1.721179E-28f);
	}
}

void func_335(var uParam0, int iParam1, struct<15> Param2)
{
	int iVar0;
	struct<22> Var1;
...
bool func_337(int iParam0, var uParam1, bool bParam2)
{
	*bParam2 = Global_1149417.f_7;
	bParam2->f_2 = 1.841357E+10f;
	bParam2->f_3 = func_344(iParam0);
	bParam2->f_4 = uParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(bParam2->f_1), bParam2);
}

void func_338(int iParam0, bool bParam1, var uParam2)
{
	int iVar0;
	...
	*uParam2 = iParam0;
	...
	uParam2->f_3 = func_345(iParam0, uParam2->f_1);
...
bool func_339(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_351(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_352())
	{
		return func_351(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_351(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
int func_345(int iParam0, var uParam1)
{
	...
	if (func_355(iParam0, uParam1, &vVar0))
	{
		return vVar0.z;
	}
	return 0;
...
bool func_355(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_356(iParam0, uParam1, &uVar0))
	{
		func_357(&uVar0, iParam0, uParam2);
	}
	else
	{
		return false;
...
void func_357(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
