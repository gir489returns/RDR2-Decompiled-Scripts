...
{
	PED::SET_PED_MODEL_IS_SUPPRESSED(1.025309E-07f, true);
}
...
bool func_13()
{
	iLocal_19 = Global_1887363[127 /*36*/].f_5;
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3686.114f, -2623.858f, -12.89814f, 0f, 0f, 0f, 5.86845f, 3.98367f, 3.717603f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3681.782f, -2626.667f, -12.97999f, 0f, 0f, 0f, 3.247781f, 3.506042f, 3.000762f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3685.422f, -2627.413f, -12.92333f, 0f, 0f, 0f, 4.057125f, 5.521852f, 3.439446f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3683.131f, -2624.525f, -13.041f, 0f, 0f, 44.914f, 3.072f, 3.99f, 2.949f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3689.379f, -2628.766f, -12.813f, 0f, 0f, 0f, 3.741f, 5.57f, 3.389f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -3688.071f, -2623.283f, -9.7791f, 0f, 0f, 0f, 2.257698f, 2.906237f, 3.016091f);
	iLocal_21 = VOLUME::CREATE_VOLUME_BOX(-3685.352f, -2623.258f, -13.4981f, 0f, 0f, 0f, 1.100183f, 2.220348f, 1.996734f);
	iLocal_22 = VOLUME::CREATE_VOLUME_BOX(-3687.81f, -2623.527f, -13.30467f, 0f, 0f, 0f, 2.162535f, 3.2466f, 2.122298f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_20, 10111);
	iLocal_23 = VOLUME::CREATE_VOLUME_BOX(-3701.056f, -2595.456f, -14.37373f, 0f, 0f, 0f, 21.94766f, 22.09092f, 14.36038f);
...
void func_27()
{
	func_58(0, -983084825, -987613363, -1050281270, iLocal_23, 127);
}
...
{
	func_59(3, iLocal_20, iParam0, iLocal_21, iLocal_22, 4, 0, 0, -1f, 0);
	func_60(3, 8192);
	func_61(3, 0);
	func_59(2, iLocal_24, iParam0, iLocal_25, 0, 1277952, 0, 0, -1f, 0);
	func_61(2, 0);
	func_59(35, iLocal_26, iParam0, iLocal_27, 0, 4, 0, 0, -1f, 0);
	func_61(35, 0);
	func_62();
	func_63(110);
}
...
bool func_40(int iParam0)
{
	if (func_68(&bLocal_34))
	{
		if (bLocal_34)
		{
			func_69(-7.05592E+28f, 1);
			func_69(-5.111117E+36f, 1);
			func_69(2.347893E-30f, 1);
		}
	}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_71(Global_1940186, 32768)) || func_71(Global_1940186, 2.350989E-38f))
	{
		return;
	}
...
void func_58(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	Global_1939946.f_5[iParam0 /*11*/].f_6 = func_101(iParam5, iParam0);
}
...
int func_61(int iParam0, bool bParam1)
{
	...
	if ((func_113(iParam0, 16384) || func_113(iParam0, 32768)) || func_99(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
...
void func_63(int iParam0)
{
	...
	if (func_115(Global_1051832.f_3654[iVar0 /*19*/], &iVar1, &fVar2, &vVar3))
	{
		Global_1051832.f_3654[iVar0 /*19*/].f_6 = func_122(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	iVar6 = func_123(Global_1051832.f_3654[iVar0 /*19*/]);
	bVar7 = iVar6 != -1;
	if (bVar7)
	{
		Global_1051832.f_3654[iVar0 /*19*/].f_9 = iVar6;
		if (func_115(iVar6, &iVar1, &fVar2, &vVar3))
		{
			Global_1051832.f_3654[iVar0 /*19*/].f_13 = func_122(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	Global_1051832.f_3654[iVar0 /*19*/].f_5 = func_108(Global_1051832.f_3654[iVar0 /*19*/]);
	if (!func_124(30, 4))
	{
		func_110(30, 4);
		func_111(30);
...
bool func_73()
{
	return func_71(Global_1940186, 8192);
}
...
void func_78(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_66(iParam0) && func_92(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_146(&cVar6, 4.808429E-35f), sVar9, func_146(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_146(&cVar6, 4.808429E-35f), func_146(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_147(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_80(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_149(&Global_1940186, 16384);
	func_131(func_150(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_131(func_150(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_131(func_150(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_131(func_150(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_131(func_150(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_131(func_150(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_131(func_150(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_87(int iParam0)
{
	...
	{
		if (VOLUME::DOES_VOLUME_EXIST(iLocal_28[iVar0]))
		{
			PATHFIND::_REMOVE_NAVMESH_BLOCKING_VOLUME(iLocal_28[iVar0]);
			VOLUME::DELETE_VOLUME(iLocal_28[iVar0]);
		}
		iVar0++;
	}
...
bool func_93(int iParam0)
{
	...
	return func_92(iParam0, 9.403955E-38f);
}
...
{
	func_162(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_163(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_106(int iParam0, bool bParam1)
{
	...
	else if (func_124(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_178(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
int func_115(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_183(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", vParam3);
}

bool func_116(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_183(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", vParam3);
}
...
void func_117(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_122(iParam1, vParam2, fParam5, 0, 0, 0);
...
int func_122(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, bool bParam7)
{
...
struct<2> func_130(int iParam0)
{
	...
	return func_150(-7.709348E+28f, iVar0);
}
...
char* func_134(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_195(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_197(func_196(Global_34));
	}
...
char* func_146(char* sParam0, int iParam1)
{
	...
	return func_201(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

int func_147(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	int iVar16;
...
struct<2> func_150(float fParam0, int iParam1)
{
	struct<2> Var0;
...
void func_151(int iParam0)
{
	...
	if (func_96(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_202(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_203(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_204(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_205(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_178(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
{
	func_210(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
int func_182(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_224(12, func_223(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_183(int iParam0, char* sParam1, int* iParam2, char* sParam3, float* fParam4, char* sParam5, Vector3* vParam6)
{
	struct<4> Var0;
...
bool func_256(struct<2> Param0, bool bParam2)
{
	if (!func_229(Param0))
	{
		return false;
