...
bool func_13()
{
	iLocal_19 = Global_1887363[121 /*36*/].f_5;
	...
	iLocal_23 = VOLUME::CREATE_VOLUME_BOX(-5508.212f, -2964.63f, -0.4536f, 0f, 0f, 15.48608f, 1.15206f, 1.211619f, 2.44214f);
	iLocal_24 = VOLUME::CREATE_VOLUME_BOX(-5506.212f, -2964.24f, -0.546059f, 0f, 0f, 15.38209f, 1.208323f, 1.559606f, 2.24757f);
	iLocal_22 = VOLUME::CREATE_VOLUME_BOX(-5508.861f, -2960.149f, -0.730614f, 0f, 0f, 14.06083f, 5.590748f, 1.871594f, 1.963433f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_25, -5486.925f, -2936.908f, -0.632f, 0f, 0f, 37.506f, 12.127f, 6.213f, 4.544f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_25, -5479.758f, -2933.356f, -0.464321f, 0f, 0f, 37.59521f, 2.825781f, 2.131215f, 1.882721f);
	iLocal_26 = VOLUME::CREATE_VOLUME_BOX(-5487.416f, -2939.017f, -0.416119f, 0f, 0f, 36.36512f, 1.251111f, 3.269273f, 2.026726f);
	iLocal_28 = VOLUME::CREATE_VOLUME_BOX(-5485.543f, -2937.639f, -0.416119f, 0f, 0f, 36.36512f, 2.087f, 2.06f, 2.027f);
	iLocal_27 = VOLUME::CREATE_VOLUME_BOX(-5492.82f, -2941.371f, -0.730614f, 0f, 0f, 127.4349f, 6.522694f, 1.871594f, 1.963433f);
	...
	iLocal_33 = VOLUME::CREATE_VOLUME_BOX(-5507.816f, -2947.645f, -1.491075f, 0f, 0f, -17.45158f, 8.984022f, 7.283852f, 4.458558f);
	iLocal_34 = VOLUME::CREATE_VOLUME_BOX(-5507.615f, -2947.708f, -1.491075f, 0f, 0f, -17.45158f, 1.750185f, 2.572302f, 2.75889f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_36, -5529.713f, -2927.539f, -1.328089f, 0f, 0f, 24.83998f, 6.747131f, 6.870256f, 6.016601f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_36, -5534.146f, -2922.72f, -1.771596f, 0f, 0f, 24.83998f, 10.62026f, 7.054735f, 6.016601f);
...
void func_27()
{
	func_59(0, -978562143, -986321138, 1044969771, iLocal_20, 121);
}
...
{
	func_60(3, iLocal_25, iParam0, iLocal_26, iLocal_28, 4, 0, 0, -1f, 0);
	func_61(3, -2.071668E+22f, 0, 0, 0);
	func_61(3, 2.772269E-14f, 0, 0, 0);
	func_62(3, 8192);
	func_63(3, 0);
	func_64();
	func_65(105);
	func_60(6, iLocal_21, iParam0, iLocal_23, iLocal_24, 20, 0, 0, -1f, 0);
	func_61(6, 1.818314E+29f, 0, 0, 0);
	func_63(6, 0);
	ENTITY::CREATE_MODEL_HIDE(-5479.709f, -2932.554f, -1.3902f, 1f, -4.894714E-29f, false);
	func_60(10, iLocal_33, iParam0, iLocal_34, 0, 460, 0, 0, -1f, 0);
	func_62(10, 1.084202E-19f);
	func_63(10, 0);
	func_60(9, iLocal_30, iParam0, 0, 0, 2, 1, 0, -1f, 0);
	func_62(9, 1.084202E-19f);
	func_62(9, 16384);
	func_62(9, 32768);
	func_62(9, 1);
	func_62(9, 8388608);
	func_62(9, 8192);
	func_62(9, 4);
	func_62(9, 2.350989E-38f);
	func_62(9, 1.504633E-36f);
	if (!func_66() && func_67())
	{
		func_61(9, -1.241939E+09f, 0, 0, 0);
		func_61(9, 4.788092E-13f, 0, 0, 0);
	}
	else
	{
		func_61(9, -1.241939E+09f, 1f, 1, 1);
		func_61(9, 4.788092E-13f, -1f, 1, 1);
	}
}
...
{
	func_69(1061997773 /* Float: 0.8f */, 1045220557 /* Float: 0.2f */, 0f, 0f);
}
...
bool func_40(int iParam0)
{
	if (func_73(&bLocal_44))
	{
		if (bLocal_44)
		{
			func_74(0.03464689f, 1);
			func_74(6.319034E-35f, 1);
		}
	}
	return false;
}
...
void func_59(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	Global_1939946.f_5[iParam0 /*11*/].f_6 = func_105(iParam5, iParam0);
}
...
void func_61(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0] = func_116(iParam1, 0, 0);
	if (func_117(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_118(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0]))
		{
			func_119(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
int func_63(int iParam0, bool bParam1)
{
	...
	if ((func_121(iParam0, 16384) || func_121(iParam0, 32768)) || func_103(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
...
void func_65(int iParam0)
{
	...
	if (func_123(Global_1051832.f_3654[iVar0 /*19*/], &iVar1, &fVar2, &vVar3))
	{
		Global_1051832.f_3654[iVar0 /*19*/].f_6 = func_130(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	iVar6 = func_131(Global_1051832.f_3654[iVar0 /*19*/]);
	bVar7 = iVar6 != -1;
	if (bVar7)
	{
		...
		{
			Global_1051832.f_3654[iVar0 /*19*/].f_13 = func_130(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	Global_1051832.f_3654[iVar0 /*19*/].f_5 = func_111(Global_1051832.f_3654[iVar0 /*19*/]);
	if (!func_132(30, 4))
	{
		func_113(30, 4);
		func_114(30);
...
void func_82(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_71(iParam0) && func_96(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
...
void func_84(int iParam0, bool bParam1)
{
	...
	func_158(func_157(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_158(func_157(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_158(func_157(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_158(func_157(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_158(func_157(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_158(func_157(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_158(func_157(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
{
	func_69(1061578342 /* Float: 0.775f */, 1045220557 /* Float: 0.2f */, 1020054733 /* Float: 0.025f */, 0f);
	ENTITY::REMOVE_MODEL_HIDE(-978633300, -986232609, -1078857197, 1f, -4.894714E-29f, 0);
...
{
	func_169(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_170(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_109(int iParam0, bool bParam1)
{
	...
	else if (func_132(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
...
int func_123(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_195(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", vParam3);
}

bool func_124(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_195(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", vParam3);
}
...
void func_125(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_130(iParam1, vParam2, fParam5, 0, 0, 0);
...
int func_130(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, bool bParam7)
{
...
char* func_141(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_201(Global_1893611.f_162);
	}
...
char* func_153(char* sParam0, int iParam1)
{
	...
	return func_207(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
struct<2> func_157(float fParam0, float fParam1)
{
	struct<2> Var0;
...
void func_159(int iParam0)
{
	...
	if (func_100(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_208(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_209(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_210(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_211(iParam0, 1.084202E-19f);
...
{
	func_216(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
int func_188(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_229(12, func_228(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_195(int iParam0, char* sParam1, int* iParam2, char* sParam3, float* fParam4, char* sParam5, Vector3* vParam6)
{
	struct<4> Var0;
...
bool func_217(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_246(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_247())
	{
		return func_246(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_246(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_233()
{
	...
	if (!func_231(Global_1051268) && Global_1572887.f_8 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_259(struct<2> Param0, bool bParam2)
{
	if (!func_231(Param0))
	{
		return false;
