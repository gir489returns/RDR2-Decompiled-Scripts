...
bool func_13()
{
	iLocal_16 = Global_1887363[62 /*36*/].f_5;
	iLocal_17 = VOLUME::CREATE_VOLUME_CYLINDER(1411.869f, -7032.472f, 71.50774f, 0f, 0f, -25.35288f, 142.4495f, 133.1683f, 45.87774f);
	return true;
}
...
{
	func_58(1061997773 /* Float: 0.8f */, 1045220557 /* Float: 0.2f */, 0f, 0f);
}
...
void func_58(int iParam0, int iParam1, int iParam2, float fParam3)
{
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_62(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_106(&cVar6, 4.808429E-35f), sVar9, func_106(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_106(&cVar6, 4.808429E-35f), func_106(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_107(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_72(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_109(&Global_1940186, 16384);
	func_111(func_110(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_111(func_110(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_111(func_110(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_111(func_110(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_111(func_110(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_111(func_110(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_111(func_110(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
{
	func_58(1061578342 /* Float: 0.775f */, 1045220557 /* Float: 0.2f */, 1020054733 /* Float: 0.025f */, 0f);
	iParam0 = iParam0;
}
...
bool func_84(int iParam0)
{
	...
	return func_62(iParam0, 9.403955E-38f);
}
...
char* func_94(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_129(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_131(func_130(Global_34));
	}
...
int func_107(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	int iVar16;
...
{
	func_136(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_137(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_113(int iParam0)
{
	...
	if (func_87(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_139(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_140(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_141(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_142(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_144(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_120(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_144(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_166(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
