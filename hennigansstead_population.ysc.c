...
void func_2()
{
	iLocal_16 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2395f, -2410f, 35f, 0f, 0f, 0f, 150f, 120f, 50f, "m_volMacFarlanesRanch_Restriction");
	func_7(iLocal_16);
	iLocal_17 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1405.399f, -2279.227f, 70f, 0f, 0f, 7f, 65f, 107.5f, 40f, "m_volThievesLanding_Restriction");
	func_8(iLocal_17, 0, 0);
	iLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volStillwaterCreek_Aquatic_Restriction");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -1747.279f, -2431.148f, 38f, 0f, 0f, -18f, 20f, 50f, 20f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -1800.653f, -2314.105f, 38f, 0f, 0f, 15f, 60f, 25f, 20f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -1787.128f, -2348.89f, 38f, 0f, 0f, -36f, 20f, 20f, 20f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -1668.215f, -2341.46f, 38f, 0f, 0f, 25f, 25f, 15f, 20f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -1671.046f, -2320.505f, 38f, 0f, 0f, 6f, 20f, 20f, 20f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -1666.093f, -2360.316f, 38f, 0f, 0f, 25f, 20f, 15f, 20f);
	func_9(iLocal_18);
}
...
void func_5()
{
	...
	{
		if (!func_10(4770.254f))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(1.204927E+24f, Global_34))
			{
				func_11(4770.254f);
			}
		}
	}
	else if (func_10(4770.254f))
	{
		if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(1.204927E+24f, Global_34))
		{
			func_12(4770.254f);
