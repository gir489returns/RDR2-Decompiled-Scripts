...
bool func_13()
{
	...
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_19, VOLUME::CREATE_VOLUME_BOX(-2844.917f, 138.528f, 183f, 0f, 0f, 20.486f, 7.713f, 16.738f, 5.708f));
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_19, VOLUME::CREATE_VOLUME_BOX(-2837.196f, 136.839f, 183f, 0f, 0f, 20.486f, 5.852f, 7.961f, 5.708f));
...
{
	func_58(15, iLocal_19, iParam0, iLocal_20, iLocal_21, 12, 0, 0, -1f, 0);
	func_59(15, 1.084202E-19f);
	func_60(15, 0);
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_Naturalist_Camp", true, true);
	AUDIO::_SET_AMBIENT_ZONE_POSITION("AZ_Naturalist_Camp", VOLUME::GET_VOLUME_COORDS(iLocal_19), 0f);
}
...
void func_59(int iParam0, float fParam1)
{
	func_101(&(Global_1051832.f_92[iParam0 /*75*/].f_49), fParam1);
}
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_61(iParam0) && func_84(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
...
void func_95(int iParam0, bool bParam1)
{
	...
	else if (func_153(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_156(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	return func_163(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", vParam3);
}

bool func_106(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_163(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", vParam3);
}
...
void func_107(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_164(iParam1, vParam2, fParam5, 0, 0, 0);
...
char* func_111(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_168(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_170(func_169(Global_34));
	}
...
char* func_123(char* sParam0, int iParam1)
{
	...
	return func_174(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_175(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_176(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_130(int iParam0)
{
	...
	if (func_88(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_178(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_179(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_180(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_181(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_156(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_162(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_202(12, func_201(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_163(int iParam0, char* sParam1, int* iParam2, char* sParam3, float* fParam4, char* sParam5, Vector3* vParam6)
{
	struct<4> Var0;
...
int func_164(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, bool bParam7)
{
...
char* func_174(char* sParam0, int iParam1)
{
...
{
	func_211(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_179(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
bool func_189(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_221(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_222())
	{
		return func_221(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_221(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_225(int iParam0, int iParam1, bool bParam2)
{
	*bParam2 = Global_1149417.f_7;
	...
	bParam2->f_3 = func_234(iParam0);
	bParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(bParam2->f_1), bParam2);
}

void func_226(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_235(struct<2> Param0, bool bParam2)
{
	if (!func_206(Param0))
	{
		return false;
