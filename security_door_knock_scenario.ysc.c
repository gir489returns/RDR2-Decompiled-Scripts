...
void func_6()
{
	...
	if (func_12(1))
	{
		if (PAD::IS_CONTROL_PRESSED(2, -8.087782E+23f) || PAD::IS_DISABLED_CONTROL_PRESSED(2, -8.087782E+23f))
		{
			if (!func_12(3))
			{
				func_13(1);
	...
	switch (iLocal_19)
	{
		case 0:
			...
			func_19(Global_33, &vLocal_62, &iVar0);
		...
		case 1:
			...
			{
				OBJECT::_DOOR_SYSTEM_FORCE_SHUT(iLocal_72, true);
				func_22(&uLocal_20, 0);
			}
		...
		case 2:
			...
			if (func_23(&uLocal_20, 1080033280 /* Float: 3.5f */))
			{
				func_14();
				func_13(1);
				func_15(3);
	...
	if (!PED::IS_PED_USING_ANY_SCENARIO(Global_33))
	{
		...
		OBJECT::_DOOR_SYSTEM_FORCE_SHUT(iLocal_72, false);
		iLocal_13 = 0;
	}
}
...
Vector3 func_16()
{
	return 1160341791, -996055450, 1111655711 /* Float: 48.63f */;
}

Vector3 func_17()
{
	return -1013879276, 1145788170, 1122817802;
}

Vector3 func_18()
{
	return -1014200074, 1145818972, 1122817802;
}
...
int func_20(int iParam0)
{
	...
	{
		case 0:
			return 9.463395E-09f;
		case 1:
			return 1.020193E-05f;
		case 2:
			return -1.40772E+08f;
		default:
			break;
...
bool func_26()
{
	...
	switch (iLocal_72)
	{
		case joaat("DOOR_NEW_GUNSHOP_INT_BACK"):
			fVar7 = 1122369536; /* Float: 115f */
			break;
		case joaat("DOOR_VAL_DOC_BACK_RM"):
			fVar7 = 1092616192; /* Float: 10f */
			break;
		case joaat("DOOR_VAL_DOC_BACK"):
			fVar7 = 1120403456; /* Float: 100f */
			break;
	}
	fVar7 = (fVar7 + vVar4.z);
	func_41(&uLocal_23, vVar1, vVar4.x, vVar4.y, fVar7, 1108082688 /* Float: 35f */, 20, 10, 3f, 20f, 1, 0, 1047904911 /* Float: 0.24f */, 0, 0, 0.19f);
	func_25(2);
	return true;
}
...
void func_27(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (bParam4)
	{
		uParam0->f_29[2] = BUILTIN::FLOOR((PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(2, 0.0398756f) * 1123942400));
		uParam0->f_29[3] = BUILTIN::FLOOR((PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(2, -2.335535E+26f) * 1123942400));
	}
	else
	{
		uParam0->f_29[2] = BUILTIN::FLOOR((PAD::GET_CONTROL_UNBOUND_NORMAL(2, 0.0398756f) * 1123942400));
		uParam0->f_29[3] = BUILTIN::FLOOR((PAD::GET_CONTROL_UNBOUND_NORMAL(2, -2.335535E+26f) * 1123942400));
	}
	...
	if (bParam2)
	{
		uParam0->f_13.f_2 = (-(BUILTIN::TO_FLOAT(uParam0->f_29[2]) / 1123942400) * IntToFloat(uParam0->f_25));
		uParam0->f_13.f_1 = ((-uParam0->f_13.f_2 * uParam0->f_27) / IntToFloat(uParam0->f_25));
		if (PAD::IS_LOOK_INVERTED())
		{
			uParam0->f_13 = ((BUILTIN::TO_FLOAT(uParam0->f_29[3]) / 1123942400) * IntToFloat(uParam0->f_26));
		}
		else
		{
			uParam0->f_13 = (-(BUILTIN::TO_FLOAT(uParam0->f_29[3]) / 1123942400) * IntToFloat(uParam0->f_26));
	...
	fVar0 = (1106247680 * BUILTIN::TIMESTEP());
	...
	uParam0->f_19 = (uParam0->f_19 + func_44((((vVar2.x - uParam0->f_19) * 1028443341) * fVar0), -1069547520 /* Float: -3f */, 3f));
	uParam0->f_19.f_1 = (uParam0->f_19.f_1 + func_44((((vVar2.y - uParam0->f_19.f_1) * 1028443341) * fVar0), -1069547520 /* Float: -3f */, 3f));
	uParam0->f_19.f_2 = (uParam0->f_19.f_2 + func_44((((vVar2.z - uParam0->f_19.f_2) * 1028443341) * fVar0), -1069547520 /* Float: -3f */, 3f));
	if (uParam0->f_36)
	{
	...
	if (bParam1)
	{
		if (bParam3)
		{
			...
			{
				uParam0->f_22 = (uParam0->f_22 + IntToFloat(BUILTIN::ROUND(((BUILTIN::TO_FLOAT(uParam0->f_29[1]) / 1124073472) * uParam0->f_24))));
			}
		}
		else
		{
	...
	uParam0->f_23 = (uParam0->f_23 + (((uParam0->f_22 - uParam0->f_23) * MISC::GET_FRAME_TIME()) * (1075838976 / 1059481190)));
...
Vector3 func_39()
{
	return 1058400134, 1051121976, 1071117029;
}

Vector3 func_40()
{
	return -1057455342, 0f, 1127169969;
}

void func_41(var uParam0, vector3 vParam1, vector3 vParam4, float fParam7, float fParam8, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, bool bParam15, float fParam16, float fParam17)
{
	uParam0->f_1 = { vParam1 };
	uParam0->f_4 = { vParam4 };
	uParam0->f_7 = fParam7;
	uParam0->f_25 = fParam8;
	uParam0->f_26 = fParam9;
