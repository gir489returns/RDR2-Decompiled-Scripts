...
bool func_13()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1301.158f, 398.81f, 95.65845f, 0f, 0f, 61.99999f, 1.32f, 1.421f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1299.192f, 402.038f, 95.658f, 0f, 0f, 61.99999f, 1.537f, 2.022f, 3f);
	iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("WalStn-m_volPostOfficeOwner");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -1301.045f, 400.748f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 5f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -1301.309f, 398.458f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 2.006f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -1298.877f, 402.661f, 95.8015f, 0f, 0f, 61.99999f, 3.035f, 2.644f, 3f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -1303.001f, 395.221f, 95.824f, 0f, 0f, 62f, 13.808f, 6.791f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -1296.65f, 397.28f, 95.553f, 0f, 0f, 62f, 3.882f, 2.263f, 2.603f);
...
{
	func_58(3, iLocal_21, iParam0, iLocal_22, iLocal_23, 4, 0, 0, -1f, 0);
	func_59(3, 1.799133E-35f, 0, 0, 0);
	func_59(3, 2.950396E-25f, 0, 0, 0);
	func_60(3, 8192);
	func_61(3, 0);
	func_58(2, iLocal_19, iParam0, iLocal_20, 0, 1277952, 0, 0, -1f, 0);
	func_59(2, 1.799133E-35f, 0, 0, 0);
	func_59(2, 2.950396E-25f, 0, 0, 0);
	func_61(2, 0);
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_67(Global_1940186, 32768)) || func_67(Global_1940186, 2.350989E-38f))
	{
		return;
	}
...
void func_59(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0] = func_106(iParam1, 0, 0);
	if (func_107(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_108(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0]))
		{
			func_109(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
int func_61(int iParam0, bool bParam1)
{
	...
	if ((func_111(iParam0, 16384) || func_111(iParam0, 32768)) || func_112(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
...
void func_66(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_121(Global_33, iParam1, 1, 0))
		{
			func_123(func_122(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_121(Global_33, iParam1, 1, 0))
	{
		*uParam2 = 0;
	}
}
...
bool func_69()
{
	return func_67(Global_1940186, 8192);
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_64(iParam0) && func_88(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_138(&cVar6, 4.808429E-35f), sVar9, func_138(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_138(&cVar6, 4.808429E-35f), func_138(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_139(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_76(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_141(&Global_1940186, 16384);
	func_123(func_142(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_123(func_142(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_123(func_142(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_123(func_142(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_123(func_142(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_123(func_142(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_123(func_142(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_89(int iParam0)
{
	...
	return func_88(iParam0, 9.403955E-38f);
}
...
void func_99(int iParam0, bool bParam1)
{
	...
	else if (func_166(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_168(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
void func_109(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_107(iParam0))
	{
		...
		if (bParam3)
		{
			func_176(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_114(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_181(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", vParam3);
}

bool func_115(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_181(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", vParam3);
}
...
void func_116(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_182(iParam1, vParam2, fParam5, 0, 0, 0);
...
struct<2> func_122(int iParam0)
{
	...
	return func_142(-7.709348E+28f, iVar0);
}
...
char* func_126(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_188(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_190(func_189(Global_34));
	}
...
int func_129(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_193(PLAYER::PLAYER_ID()) };
...
char* func_138(char* sParam0, int iParam1)
{
	...
	return func_194(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

int func_139(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	int iVar16;
...
struct<2> func_142(float fParam0, int iParam1)
{
	struct<2> Var0;
...
{
	func_195(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_196(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_144(int iParam0)
{
	...
	if (func_92(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_198(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_199(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_200(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_201(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_168(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_174(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_221(12, func_220(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_176(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_107(iParam0))
	{
...
int func_181(int iParam0, char* sParam1, int* iParam2, char* sParam3, float* fParam4, char* sParam5, Vector3* vParam6)
{
	struct<4> Var0;
...
int func_182(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, bool bParam7)
{
...
char* func_188(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_194(char* sParam0, int iParam1)
{
...
{
	func_230(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_209(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_239(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_240())
	{
		return func_239(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_239(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_223()
{
	...
	if (!func_225(Global_1051268) && Global_1572887.f_8 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_242(int iParam0, int iParam1, bool bParam2)
{
	*bParam2 = Global_1149417.f_7;
	bParam2->f_2 = 1.841357E+10f;
	bParam2->f_3 = func_251(iParam0);
	bParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(bParam2->f_1), bParam2);
}

void func_243(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_252(struct<2> Param0, bool bParam2)
{
	if (!func_225(Param0))
	{
		return false;
