...
void __EntryFunction__()
{
	...
	func_5(&uLocal_42, 1.697414E-07f, -4.198817E-06f, 1.017927E-13f, 2.699275E+13f, 5, 1);
...
void func_5(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6)
{
	*uParam0 = 5;
