...
bool func_13()
{
	iLocal_19 = Global_1887363[60 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(iLocal_19, 14);
	POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_19, 12519, 18432, 0, -1, -1, 2);
	POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(iLocal_19, 12775, 18432, 0, -1, -1, 0);
...
{
	func_61(1061578342 /* Float: 0.775f */, 1045220557 /* Float: 0.2f */, 1020054733 /* Float: 0.025f */, 0f);
}
...
void func_61(int iParam0, int iParam1, int iParam2, float fParam3)
{
...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_63(iParam0) && func_85(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
...
void func_80(int iParam0)
{
	...
	if (bLocal_40)
	{
		...
		Local_23.f_13 = 14;
		Local_23 = Global_33;
		Local_23.f_15 = 6.533019E+26f;
		MISC::_CREATE_AI_MEMORY(&Local_23, 17);
	}
...
void func_116(bool bParam0)
{
	if (bParam0)
	{
		...
		func_140(&Global_1940186, 8388608);
	}
	else
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0f);
		func_111(&Global_1940186, 8388608);
	}
...
void func_118(int iParam0)
{
	...
	if (func_89(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_144(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
