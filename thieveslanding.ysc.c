...
bool func_13()
{
	...
	func_53(&Local_21, -995530506, -988837192, 1109555937 /* Float: 40.62f */, 0f, 0f, 0f, 6f, 5f, 3f, "HTL_VOLUME_BOAT_INTERIOR");
	Local_21.f_1 = 0;
	Local_21.f_2 = 0;
	return true;
}
...
void func_29(int iParam0)
{
	...
	{
		func_59(4, iLocal_19, iParam0, iLocal_20, 0, 44, 0, 0, -1f, 0);
		func_60(4, 0);
	}
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_64(Global_1940186, 32768)) || func_64(Global_1940186, 2.350989E-38f))
	{
		return;
	}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_102(iParam0, 16384) || func_102(iParam0, 32768)) || func_103(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
...
void func_63()
{
	if (!Local_21.f_1)
	{
		...
		{
			Local_21.f_3 = ENTITY::_SEARCH_BUILDING_POOL_FOR_ENTITY_WITH_THIS_MODEL(-0.009121083f);
	...
	if (!VOLUME::DOES_VOLUME_EXIST(Local_21))
	{
		func_53(&Local_21, -995530506, -988837192, 1109555937 /* Float: 40.62f */, 0f, 0f, 0f, 6f, 5f, 3f, "HTL_VOLUME_BOAT_INTERIOR");
	}
	if (Local_21.f_2)
...
bool func_66()
{
	return func_64(Global_1940186, 8192);
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_61(iParam0) && func_85(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
...
bool func_86(int iParam0)
{
	...
	return func_85(iParam0, 9.403955E-38f);
}
...
void func_96(int iParam0, bool bParam1)
{
	...
	else if (func_154(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_157(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
bool func_105(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_164(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", vParam3);
}

bool func_106(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_164(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", vParam3);
}
...
void func_107(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_165(iParam1, vParam2, fParam5, 0, 0, 0);
...
char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_169(Global_1893611.f_162);
	}
...
char* func_124(char* sParam0, int iParam1)
{
	...
	return func_175(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_176(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_177(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_131(int iParam0)
{
	...
	if (func_89(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_179(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_180(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_181(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_182(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_157(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_163(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_203(12, func_202(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_164(int iParam0, char* sParam1, int* iParam2, char* sParam3, float* fParam4, char* sParam5, Vector3* vParam6)
{
	struct<4> Var0;
...
int func_165(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, bool bParam7)
{
...
{
	func_212(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_190(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_222(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_223())
	{
		return func_222(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_222(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_226(int iParam0, int iParam1, bool bParam2)
{
	*bParam2 = Global_1149417.f_7;
	...
	bParam2->f_3 = func_235(iParam0);
	bParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(bParam2->f_1), bParam2);
}

void func_227(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_236(struct<2> Param0, bool bParam2)
{
	if (!func_207(Param0))
	{
		return false;
