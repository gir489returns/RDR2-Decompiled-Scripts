...
void func_14(int iParam0)
{
	...
	if (iParam0->f_1 == 3.487792E+25f)
	{
		func_15(5.852861E-15f, 0, 1f, 1, 0, 0, 0, -1);
	}
	else if (iParam0->f_1 == -6.810042E-17f)
	{
		func_15(5.852861E-15f, 0, 1f, 1, 0, 0, 0, -1);
	}
	else if (iParam0->f_1 == 2.026605E-07f)
	{
		func_15(5.852861E-15f, 0, 1f, 1, 0, 0, 0, -1);
	}
}
...
int func_18(int iParam0, bool bParam1, int iParam2)
{
	...
	while (iVar24 < Var1)
	{
		...
		else
		{
			...
			if (func_24(bVar25, 0) && func_25(bVar25, -7.721469E-31f))
			{
				return BUILTIN::CEIL((IntToFloat(Var1.f_12[iVar24]) * fVar0));
			}
		}
...
void func_19(int iParam0, char* sParam1, int iParam2, bool bParam3)
{
	...
	func_27(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 3.428622E+27f, 0, 4.808429E-35f, 0, 0, 0, 1);
}
...
void func_20(int iParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_27(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -3.959475E-32f, 0, 4.808429E-35f, 0, 0, 0, 1);
		iParam0 = (iParam0 - iVar0);
		if (iVar0 > 0)
		{
		}
		func_27(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 3.428622E+27f, 0, 4.808429E-35f, 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_31(func_30(6.480143E+20f), iVar1);
	}
}
...
int func_27(char* sParam0, char* sParam1, int iParam2, int iParam3, float fParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
	struct<4> Var0;
	struct<7> Var13;
	int iVar20;
...
struct<2> func_30(float fParam0)
{
	struct<2> Var0;
...
{
	func_21(uParam0, 8.505438E-34f);
	if (func_42() == 3.272964E+34f)
	{
		func_21(uParam0, 8.967694E-17f);
	}
	else
	{
		func_21(uParam0, 1.721179E-28f);
	}
}
...
bool func_35(bool bParam0, int iParam1)
{
	...
	bVar0 = func_44(bParam0, iParam1);
	Var4.f_9 = -5.45926E-19f;
	if (func_45("ALL WEAPONS", &iVar1, &iVar2, -5.45926E-19f, 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
...
bool func_36(bool bParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_51(&(Global_17418.f_55.f_664.f_1354.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
...
bool func_44(bool bParam0, int iParam1)
{
	...
	if (func_25(bParam0, 9.811189E+11f))
	{
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_55(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<4> func_60(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1292096.f_4 = { func_64(8.681942E-06f, func_65(bParam0), -1.942248E+12f, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1292096.f_16 = { func_64(8.681942E-06f, func_65(bParam0), -1.942248E+12f, 0) };
		}
		return Global_1292096.f_16;
	}
	return func_64(8.681942E-06f, func_65(bParam0), -1.942248E+12f, 0);
}
...
struct<5> func_63(bool bParam0, bool bParam1, int iParam2)
{
	...
	{
		case joaat("CLOTHING"):
			Var0 = { func_64(5.207907E-07f, Var0, 0.08386164f, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (iParam2 && func_66(bParam0, 1))
			{
				...
				if (!func_67(bParam0, &Var0, 6.282013E+23f, 0, 0))
				{
					Var0.f_4 = 6.282013E+23f;
				}
				else if (!func_67(bParam0, &Var0, -3.587391E+15f, 0, 0))
				{
					Var0.f_4 = -3.587391E+15f;
				}
				else if (func_68(bParam0, &Var6, 6.282013E+23f))
				{
					Var0.f_4 = 6.282013E+23f;
				}
				else
		...
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_70(bParam0, -2.580501E-27f))
			{
				Var0 = { func_64(-7.437896E-28f, Var0, 4.978612f, bParam1) };
				Var0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, -7.437896E-28f);
			}
			else if (func_70(bParam0, -4.220332E-15f))
			{
				Var0 = { func_64(5.207907E-07f, Var0, 0.08386164f, bParam1) };
				Var0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, 5.207907E-07f);
			}
			...
			else if (func_70(bParam0, -3.171238E-21f))
			{
				Var0 = { func_64(2.884954E+11f, Var0, 6.727819E+25f, bParam1) };
...
struct<4> func_64(bool bParam0, var uParam1, float fParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
struct<4> func_65(bool bParam0)
{
	...
	if (Global_1572887.f_14 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1292096 = { func_64(2.982335E+09f, func_72(), -5.45926E-19f, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1292096.f_12 = { func_64(2.982335E+09f, func_72(), -5.45926E-19f, 0) };
			}
			return Global_1292096.f_12;
		}
	}
	return func_64(2.982335E+09f, func_72(), -5.45926E-19f, bParam0);
}

int func_66(bool bParam0, bool bParam1)
{
	if (func_49(bParam0) == 4.161967E+25f)
	{
		return 0;
	}
...
bool func_67(bool bParam0, var uParam1, float fParam2, int iParam3, float fParam4)
{
	return func_74(bParam0, *uParam1, fParam2, iParam3, 1, fParam4) > 0;
}

bool func_68(bool bParam0, int iParam1, float fParam2)
{
	var uVar0;

	if (func_75(bParam0, &uVar0, iParam1, fParam2))
	{
...
struct<4> func_69(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1292096.f_8 = { func_64(3.507197E-29f, func_65(bParam0), 12999093, 0) };
		}
		return Global_1292096.f_8;
	}
	return func_64(3.507197E-29f, func_65(bParam0), 12999093, 0);
}
...
int func_71(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
...
int func_73()
{
	if (func_78(-0.0002099206f, 0, 0, 0) == 0)
	{
		return 0;
	}
	return 1;
...
int func_74(bool bParam0, struct<4> Param1, float fParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (bParam7)
	{
		Var1 = { func_64(bParam0, Param1, fParam5, bParam6) };
...
bool func_75(bool bParam0, int iParam1, int iParam2, float fParam3)
{
	int iVar0;

	iVar0 = func_55(0);
	*iParam1 = { func_64(bParam0, func_60(0), fParam3, 0) };
...
int func_77(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_78(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_79(iParam0) && !bParam2)
	{
