...
bool func_13()
{
	...
	iLocal_22 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-9.406495E-20f, -1575.384f, 488.262f, 114.515f, 0f, 0f, 90f, 1f, 1f, 2f);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_HORSE(iLocal_22, true);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_PLAYER(iLocal_22, true);
	iLocal_23 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-9.406495E-20f, -1575.096f, 486.386f, 114.515f, 0f, 0f, 90f, 3.2f, 7.3f, 2f);
