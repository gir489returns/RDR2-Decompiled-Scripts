...
bool func_62()
{
	...
	{
		iLocal_14 = OBJECT::CREATE_OBJECT(func_53(), func_91(), false, false, false, false, true);
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_14))
		{
			ENTITY::SET_ENTITY_COORDS(iLocal_14, func_91(), true, false, true, true);
			ENTITY::SET_ENTITY_ROTATION(iLocal_14, func_92(), 2, true);
		}
		else
		{
			return false;
...
{
	iParam0 = iParam0;
	OBJECT::DELETE_OBJECT(&iLocal_14);
...
Vector3 func_91()
{
	return -988681585, 1120680018, 1130233070;
}

Vector3 func_92()
{
	return 0f, 0f, 1125842944 /* Float: 155f */;
}
...
char* func_95(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_130(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_132(func_131(Global_34));
	}
...
char* func_107(char* sParam0, int iParam1)
{
	...
	return func_136(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_137(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_138(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_114(int iParam0)
{
	...
	if (func_87(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_140(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_141(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_142(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_143(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_145(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_121(int iParam0, bool bParam1)
{
	...
	else if (func_155(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_145(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_167(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
