...
bool func_13()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1095.52f, -576.564f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1094.093f, -574.7371f, 82.8243f, 0f, 0f, 52.00422f, 2.27305f, 1.013785f, 2.820909f);
...
{
	func_58(2, iLocal_19, iParam0, iLocal_20, iLocal_21, 1277952, 0, 0, -1f, 0);
	func_59(2, 308649.3f, 0, 0, 0);
	func_60(2, 0);
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_66(Global_1940186, 32768)) || func_66(Global_1940186, 2.350989E-38f))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-1.042271E+15f, 0.4424044f))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_79(iLocal_26, 0), 1);
					break;
			}
		}
		if (func_10(func_72()))
...
void func_59(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0] = func_105(iParam1, 0, 0);
	if (func_106(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_107(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0]))
		{
			func_108(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_109(iParam0, 16384) || func_109(iParam0, 32768)) || func_110(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
...
void func_65(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_119(Global_33, iParam1, 1, 0))
		{
			func_121(func_120(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_119(Global_33, iParam1, 1, 0))
	{
		*uParam2 = 0;
	}
}
...
bool func_68()
{
	return func_66(Global_1940186, 8192);
}
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_63(iParam0) && func_87(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_136(&cVar6, 4.808429E-35f), sVar9, func_136(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_136(&cVar6, 4.808429E-35f), func_136(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_137(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_75(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_139(&Global_1940186, 16384);
	func_121(func_140(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_121(func_140(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_121(func_140(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_121(func_140(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_121(func_140(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_121(func_140(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_121(func_140(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_88(int iParam0)
{
	...
	return func_87(iParam0, 9.403955E-38f);
}
...
void func_98(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_166(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
void func_108(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_106(iParam0))
	{
		...
		if (bParam3)
		{
			func_174(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_112(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_179(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", vParam3);
}

bool func_113(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_179(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", vParam3);
}
...
void func_114(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_180(iParam1, vParam2, fParam5, 0, 0, 0);
...
struct<2> func_120(int iParam0)
{
	...
	return func_140(-7.709348E+28f, iVar0);
}
...
char* func_124(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_186(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_188(func_187(Global_34));
	}
...
int func_127(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_191(PLAYER::PLAYER_ID()) };
...
char* func_136(char* sParam0, int iParam1)
{
	...
	return func_192(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

int func_137(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	int iVar16;
...
struct<2> func_140(float fParam0, int iParam1)
{
	struct<2> Var0;
...
void func_142(int iParam0)
{
	...
	if (func_91(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_196(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_197(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_198(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_199(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_166(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_172(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_219(12, func_218(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_174(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_106(iParam0))
	{
...
int func_179(int iParam0, char* sParam1, int* iParam2, char* sParam3, float* fParam4, char* sParam5, Vector3* vParam6)
{
	struct<4> Var0;
...
int func_180(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, bool bParam7)
{
...
{
	func_228(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_221()
{
	...
	if (!func_223(Global_1051268) && Global_1572887.f_8 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_240(int iParam0, int iParam1, bool bParam2)
{
	*bParam2 = Global_1149417.f_7;
	...
	bParam2->f_3 = func_249(iParam0);
	bParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(bParam2->f_1), bParam2);
}

void func_241(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_250(struct<2> Param0, bool bParam2)
{
	if (!func_223(Param0))
	{
		return false;
