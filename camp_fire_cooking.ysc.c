...
void func_6()
{
	...
	if (bLocal_18)
	{
		...
		else if (!PED::IS_PED_USING_THIS_SCENARIO(Local_19.f_3, iLocal_16))
		{
			bLocal_13 = false;
		}
	}
	...
	switch (Local_19.f_7)
	{
		case 0:
			...
			break;
		case 1:
			if (ENTITY::HAS_ANIM_EVENT_FIRED(Local_19.f_3, -0.01354304f))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(Local_19.f_2))
				{
					Local_19.f_2 = PED::_GET_PED_REGISTER_PROP(Local_19.f_3, "s_meatbit_Chunck_small01x_PH_L_HAND", false);
				}
				Local_19.f_7 = 2;
			}
			break;
		case 2:
			...
			break;
		case 3:
			if (ENTITY::HAS_ANIM_EVENT_FIRED(Local_19.f_3, -8.795626E-10f))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_19.f_2))
				{
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(Local_19.f_2))
			{
				...
				if (Local_19 > 0f && Local_19 <= 1092616192)
				{
					OBJECT::_SET_OBJECT_BURN_LEVEL(Local_19.f_1, (Local_19 / 1092616192), true);
				}
				else
				{
					bLocal_13 = false;
