...
void __EntryFunction__()
{
	...
	Var0.f_180 = 1;
	iVar182 = func_4(&Var0, &(ScriptParam_0.f_1));
	if (Var0.f_180)
	{
		Var0.f_2.f_2 = 1f;
	}
	...
	while (!SCRIPTS::IS_THREAD_EXIT_REQUESTED())
	{
		if (!ScriptParam_0.f_3)
		{
			if (!Var0.f_180)
			{
				iVar184 = TASK::GET_ITEM_INTERACTION_STATE(Global_33);
				func_6(&Var0);
				if (iVar184 == 5.897283E+18f || iVar184 == 17328.23f)
				{
					func_7(&Var0);
				}
				else if (iVar184 == 8.549509E+09f || iVar184 == 4.408839E-36f)
				{
					func_8(&Var0);
				}
		...
		switch (Var0)
		{
			...
			case 1:
				...
				if (!Var0.f_180)
				{
					if ((MISC::GET_FRAME_COUNT() % 10) == 0 && ENTITY::GET_ENTITY_SUBMERGED_LEVEL(Global_33) > 1045220557)
					{
						func_12(&Var0, 2);
					}
				}
			...
			case 2:
				if (!Var0.f_180)
				{
					if (iVar184 == -1.722085E-15f || iVar184 == -6.858475E+11f)
					{
						TASK::_0xB35370D5353995CB(Global_33, func_17(Var0.f_2, iVar184), 0.25f);
						func_12(&Var0, 4);
					}
					else if (iVar184 == 5.897283E+18f)
					{
						if (TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_33) == -0.0004018912f)
						{
							PED::_GIVE_PED_HASH_COMMAND(Global_33, 61.36521f, 1.5f);
							PED::_ADD_SCENARIO_TRANSITION(Global_33);
						}
						else
						{
							PED::_GIVE_PED_HASH_COMMAND(Global_33, -3.319287E+07f, 3f);
							PED::_ADD_SCENARIO_TRANSITION(Global_33);
						}
						func_12(&Var0, 4);
					}
					else if (iVar184 != 8.549509E+09f)
					{
					}
					else
					{
						PED::_GIVE_PED_HASH_COMMAND(Global_33, -2.101885E-07f, 1.5f);
						PED::_ADD_SCENARIO_TRANSITION(Global_33);
						func_12(&Var0, 4);
					}
				}
			...
			case 4:
				...
				{
					if ((func_18() == -1 && func_19(0)) && func_20(Var0.f_2, 1.898534E+15f))
					{
						if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 4.543783E-35f))
						{
							if (!AUDIO::IS_SCRIPTED_SPEECH_PLAYING(Global_33))
							{
								if (func_21(Global_33, "Player_Sick_Drinking_Cough", -1.799829E+34f, 0, 1, 0, 0, 1))
								{
									bVar183 = true;
								}
							}
...
int func_4(var uParam0, var uParam1)
{
	...
	switch (uParam0->f_2)
	{
		...
		case joaat("CONSUMABLE_RUM"):
			iVar0 = 1043207291; /* Float: 0.17f */
			break;
		case joaat("CONSUMABLE_SALOON_BEER"):
			iVar0 = 1020054733; /* Float: 0.025f */
			uParam0->f_180 = 0;
			break;
		...
		case joaat("CONSUMABLE_CYPRUS_BRANDY"):
			iVar0 = 1055286886; /* Float: 0.45f */
			break;
		default:
			if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
			{
				iVar1 = ENTITY::GET_ENTITY_MODEL(*uParam1);
				if (iVar1 == -1.709536E+14f)
				{
					uParam0->f_2 = -9.321459E+37f;
					iVar0 = 1020054733; /* Float: 0.025f */
					uParam0->f_180 = 0;
				}
				else if (iVar1 == -1.20569E-32f)
				{
					uParam0->f_2 = -4.202746E+25f;
					iVar0 = 1020054733; /* Float: 0.025f */
					uParam0->f_180 = 0;
				}
			}
...
void func_5()
{
	...
	{
		if (TASK::GET_ITEM_INTERACTION_STATE(Global_33) == -1.020445E+15f)
		{
			STREAMING::_REQUEST_CLIP_SET_BY_HASH(-0.002654737f);
		}
		else
		{
			STREAMING::_REQUEST_CLIP_SET_BY_HASH(-4.106091E-24f);
		}
	}
	else if (TASK::GET_ITEM_INTERACTION_STATE(Global_33) == -1.020445E+15f)
	{
		STREAMING::_REQUEST_CLIP_SET_BY_HASH(-6.807686E+36f);
	}
	else
	{
		STREAMING::_REQUEST_CLIP_SET_BY_HASH(-4.976737E+11f);
	}
}

void func_6(var uParam0)
{
	if ((IntToFloat(uParam0->f_2.f_1) / uParam0->f_2.f_2) > 1056964608)
	{
	...
	switch (uParam0->f_1)
	{
		case 0:
			...
			{
				if (!ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 5.593845E+36f))
				{
					uParam0->f_1 = 1;
				}
			}
...
{
	if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 2.506291E-18f))
	{
		PED::_ADD_SCENARIO_TRANSITION(Global_33);
		PED::_GIVE_PED_HASH_COMMAND(Global_33, 61.36521f, 1.5f);
	}
...
{
	if (iParam0 == -1.722085E-15f)
	{
		if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 1) && (TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_33) == -1.822616E+19f || TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_33) == -0.0004018912f))
		{
			TASK::_0xB35370D5353995CB(Global_33, 5.897283E+18f, 1f);
		}
	}
	else if (iParam0 == 5.897283E+18f)
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 1) || TASK::IS_PED_EXITING_SCENARIO(Global_33, false))
		{
			TASK::_0xB35370D5353995CB(Global_33, -1.722085E-15f, 1f);
		}
	}
	else if (iParam0 == -6.858475E+11f)
	{
		if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 1) && TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_33) == -0.0004018912f)
		{
			TASK::_0xB35370D5353995CB(Global_33, 8.549509E+09f, 1f);
		}
	}
	else if (iParam0 == 8.549509E+09f)
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 1) || TASK::IS_PED_EXITING_SCENARIO(Global_33, false))
		{
			TASK::_0xB35370D5353995CB(Global_33, -6.858475E+11f, 1f);
		}
	}
}
...
void func_15(var uParam0, bool bParam1)
{
	...
	if ((func_20(*uParam0, 1.763507E+18f) || func_20(*uParam0, 8.273569E-15f)) || func_20(*uParam0, -1.230845E+19f))
	{
		bVar10 = true;
	}
	...
	{
		func_35(uParam0);
		func_36(*uParam0, bVar8, iVar9, 9.275179E-19f);
	}
	func_22(uParam0);
...
void func_16(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1324459658:
			...
			break;
		case -611782825:
			func_39(-4.241801E+09f, -1.319926E-36f, 1800);
			break;
		case -1088257729:
			func_39(-2.329539E-22f, -4.815331E-35f, 1800);
			if (func_40() || func_41())
			{
				func_43(func_42(7.642884E+10f, 0.005450568f), 1);
			}
			break;
		case -1706054699:
		case -1004468971:
...
float func_17(bool bParam0, int iParam1)
{
	switch (func_48(bParam0, -60352.49f))
	{
		case -476940445:
			if (iParam1 == 5.897283E+18f)
			{
				return 7.123575E+16f;
			}
			else
			{
				return -7.531712E-36f;
			}
			break;
		case -2001232688:
			return -2.480234E+22f;
	}
	return -7.531712E-36f;
}
...
bool func_20(bool bParam0, int iParam1)
{
	...
	{
		return func_50(func_49(bParam0), iParam1);
	}
	if (iParam1 == 0)
	{
		return false;
...
bool func_21(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
{
	func_53((Global_1940013.f_9 + fParam0), bParam1);
}
...
void func_35(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1879593571:
		case 1934214136:
			func_39(-8.650952E-05f, -2.629533E+32f, 8100);
			break;
	}
}

void func_36(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (iParam2 || func_20(bParam0, -3.480943E+19f))
	{
		func_43(func_67(-3.750745E+13f), 1);
	}
	if (func_20(bParam0, -3.458856E-14f))
	{
		func_43(func_67(-2.12416E-30f), 1);
	}
	if (func_20(bParam0, 1.763507E+18f))
	{
		func_69(func_68(bParam0), 1);
	}
	if (func_20(bParam0, 2.343408E+31f))
	{
		func_43(func_42(7.642884E+10f, -129968.5f), 1);
	}
	if (func_20(bParam0, 1.987618E+33f))
	{
		func_43(func_67(-2.413646E-08f), 1);
	}
	if (func_20(bParam0, 1894063f))
	{
		func_43(func_67(1.884128E-06f), 1);
	}
	switch (bParam0)
	{
		...
		case joaat("CONSUMABLE_HAYCUBE"):
			func_43(func_42(7.642884E+10f, -2.03267E-35f), 1);
			break;
	}
	switch (bParam0)
	{
		case -611782825:
			func_43(func_42(7.642884E+10f, -3.483875E-29f), 1);
			break;
		case joaat("CONSUMABLE_MOONSHINE"):
			func_43(func_42(7.642884E+10f, 5.234738E-28f), 1);
			break;
		case joaat("CONSUMABLE_WHISKEY_USED"):
		case joaat("CONSUMABLE_WHISKEY"):
			func_43(func_42(7.642884E+10f, 7.840773E-07f), 1);
			break;
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM_USED"):
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM"):
			func_43(func_42(7.642884E+10f, 7.177263E+37f), 1);
			break;
		case joaat("CONSUMABLE_SNAKE_OIL"):
		case joaat("CONSUMABLE_POTENT_SNAKE_OIL"):
		case joaat("CONSUMABLE_SNAKE_OIL_USED"):
			func_43(func_42(7.642884E+10f, -3.568742E-26f), 1);
			break;
		case joaat("CONSUMABLE_CHEWING_TOBACCO"):
		case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
			func_43(func_42(7.642884E+10f, -1.888559E+33f), 1);
			break;
		...
		case joaat("CONSUMABLE_POTENT_HORSE_MEDICINE"):
			func_43(func_42(7.642884E+10f, 4.325028E-21f), 1);
			break;
		case joaat("CONSUMABLE_HERBIVORE_BAIT"):
		case joaat("CONSUMABLE_POTENT_HERBIVORE_BAIT"):
			func_43(func_42(7.642884E+10f, -4.824814E+07f), 1);
			break;
		case joaat("CONSUMABLE_PREDATOR_BAIT"):
		case joaat("CONSUMABLE_POTENT_PREDATOR_BAIT"):
			func_43(func_42(7.642884E+10f, -2.336031E+31f), 1);
			break;
	}
	if (func_18() == -1)
	{
		...
		{
			func_43(func_42(7.642884E+10f, 1.386211E-17f), 1);
		}
	}
	if (bParam1)
	{
		func_43(func_67(1.131948E-13f), 1);
	}
	func_70(bParam0, iParam3);
}
...
struct<2> func_42(float fParam0, int iParam1)
{
	struct<2> Var0;
...
void func_44(struct<16> Param0, int iParam16)
{
	...
	{
		if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&(Param0.f_10))) > 0 || func_86(&(Param0.f_10)))
		{
			return;
		}
	}
...
void func_53(float fParam0, bool bParam1)
{
	if (PED::IS_PED_ON_MOUNT(Global_33) || PED::IS_PED_IN_ANY_VEHICLE(Global_33, false))
	{
		if (fParam0 >= func_93())
		{
			Global_1940013.f_9 = (func_93() - 1008981770);
			return;
		}
	}
	if (fParam0 < 0f)
...
bool func_63()
{
	...
	return func_107(Global_1956862.f_1431.f_107, 0);
}
...
void func_64(float fParam0, int iParam1)
{
	...
	fVar0 = (fVar0 + fParam0);
	fVar0 = func_110(fVar0, 0f, 1120403456 /* Float: 100f */);
	iVar2 = func_109(fVar0);
	if (iVar1 != iVar2)
	{
		Global_1956862.f_1431.f_107 = func_96();
		func_111(&(Global_1956862.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_112(13, fVar0, 2);
...
struct<2> func_67(float fParam0)
{
	struct<2> Var0;
...
void func_69(int iParam0, int iParam1)
{
	...
	Var0 = { func_42(-3.114499E+25f, func_122(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_43(func_123(3.939822E-35f), iParam1);
}
...
void func_70(bool bParam0, int iParam1)
{
	...
	if (func_18() == 0)
	{
		iVar0 = func_48(bParam0, -60352.49f);
		if (iParam1 == -1.202057E-11f)
		{
			return;
		}
		if (func_20(bParam0, -8.87647E+33f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, -9.82979E+16f, 1);
		}
		if ((func_20(bParam0, 1.378098E+25f) || 3.62898E+13f == iVar0) || -9.276053E-31f == iVar0)
		{
		...
		if (func_20(bParam0, -1.064618E-36f) && !func_20(bParam0, -2.927334E-06f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, -4.02404E-14f, 1);
		}
		if (func_20(bParam0, 9.495676E-32f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, 2.208807E+11f, 1);
		}
		if (((func_20(bParam0, -1.051639E+07f) || func_20(bParam0, -5.092244E+08f)) || func_20(bParam0, 1.431632E+07f)) || bParam0 == -1.954145E-33f)
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, 2.96823E-25f, 1);
		}
		if (func_20(bParam0, -2.529679E+11f))
		{
...
bool func_72(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	var uVar0;
...
void func_75(bool bParam0, bool bParam1)
{
	...
	if (func_133(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false, false)))
	{
		return;
	}
	if (!bParam0)
...
bool func_80(int iParam0)
{
	...
	return Global_1156096.f_35859.f_919[func_88(iParam0, 1) /*12*/] == -1;
}
...
int func_81(int iParam0)
{
	...
	iVar0 = func_88(iParam0, 1);
	if (!func_77(Global_1156096.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_141(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_142(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1156096.f_35859.f_11700)
				{
					...
					{
						func_143(iVar1, iParam0, iVar4);
						func_144(&(Global_1156096.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_144(&(Global_1156096.f_35859.f_9503[Global_1156096.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_148(&(Global_1156096.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
bool func_95(int iParam0)
{
	...
	fVar0 = (func_162(iParam0) - PLAYER::_GET_PLAYER_CACHED_DEAD_EYE_AMOUNT(iParam0));
	return fVar0 <= 1f;
}
...
bool func_103(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_172(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_105(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_174(iParam1), fParam2, -1);
	}
}
...
bool func_114(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_182(iParam0, 262144) || !Global_1904398.f_8866)
		{
			return false;
		}
	}
...
void func_118(int iParam0)
{
	...
	iVar1 = func_54(2);
	func_55(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_119(int iParam0)
{
	...
	iVar1 = func_58(2);
	func_59(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_120(int iParam0, bool bParam1)
{
	...
	iVar0 = func_56(2);
	func_57(BUILTIN::TO_FLOAT((iParam0 * iVar0)), 0, bParam1);
}

void func_121(int iParam0, bool bParam1, bool bParam2)
{
	func_62(iParam0, 1120403456 /* Float: 100f */, bParam1, bParam2, 1, 2);
}
...
struct<2> func_123(float fParam0)
{
	struct<2> Var0;
...
var func_125(bool bParam0, int iParam1, int iParam2)
{
	var uVar0;
...
int func_143(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_201(Global_1156096.f_35859.f_3116[iVar0 /*31*/]) && func_202(iParam0, Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_203(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_204(vVar1))
		{
			if (func_205(vVar1.x, vVar1.y, vVar1.z))
			{
				func_206(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_207(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_150(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_201(Global_1156096.f_35859.f_3116[iVar0 /*31*/]);
	if (bVar1 && func_209(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar2 = { func_210(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4) };
	...
	if (func_205(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_206(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
{
	return func_211(Global_1940072.f_38, iParam0);
}
...
{
	return func_214(&(Global_1956862.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_GET_PLAYER_MAX_DEAD_EYE(iParam0, 0) - IntToFloat(func_215(2)));
}
...
{
	func_225(&Global_1300338, iParam0);
}
...
var func_186(int iParam0, int iParam1)
{
	...
	iVar0 = func_226(iParam0, 0, Global_1300340.f_52.f_31, iParam1);
	if (iVar0 == -1)
	{
		return -1;
	}
...
bool func_200(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_141(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1156096.f_2169[iVar5 /*205*/].f_201 = (Global_1156096.f_2169[iVar5 /*205*/].f_201 - func_231(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_232(iVar3);
		}
		iVar4++;
	}
...
bool func_205(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_240(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_242(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
float func_231(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		fVar0 = func_248(1.959415E-10f, uParam0->f_2, uParam0->f_1, "");
		return fVar0;
	}
	return uParam0->f_1;
}
...
void func_232(int iParam0)
{
	...
	iVar0 = func_229(iParam0, 1);
	if (!func_249(Global_1156096.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_250(Global_1156096.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_251(Global_1156096.f_2169[iVar0 /*205*/].f_203, 1);
...
int func_238(int iParam0)
{
	...
	{
		iVar64 = func_145(Global_1156096.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_258(Global_1156096.f_35859.f_9503[iVar65 /*3*/], Global_1156096.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_259(Global_1156096.f_35859.f_9503[iVar65 /*3*/]) };
...
bool func_240(var uParam0)
{
	...
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_260(1.959415E-10f, uParam0->f_1, 1, "");
		return bVar0;
	}
	return true;
}
...
void func_241(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_261(iParam0, 0));
			func_262(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_261(iParam0, 1));
			func_262(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_261(iParam0, 2));
			func_262(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_261(iParam0, 3));
			func_262(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			iVar2 = func_255(iParam0);
...
void func_252()
{
	...
	{
		if (!func_211(Global_1297553[Global_1295619 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_258(int iParam0, int iParam1)
{
	...
	if (func_201(Global_1156096.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1156096.f_35859.f_9286[func_237(iVar2, 1) /*3*/];
		Var4 = { func_259(iVar3) };
	...
	switch (Global_1156096.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1295619 && !func_270(Global_1295619.f_149[iVar1]))
			{
				return false;
			}
...
bool func_266(struct<2> Param0, bool bParam2)
{
	if (!func_212(Param0))
	{
		return false;
