...
bool func_40(int iParam0)
{
	if (!bLocal_22)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_20))
		{
			...
			{
				if (!DECORATOR::DECOR_EXIST_ON(iLocal_20, "HAS_VOICE") || !DECORATOR::DECOR_GET_BOOL(iLocal_20, "HAS_VOICE"))
				{
					DECORATOR::DECOR_SET_BOOL(iLocal_20, "HAS_VOICE", true);
					AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_20, "0941_A_M_M_Foreman_White_AVOID_01");
					bLocal_22 = true;
				}
			}
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_19))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_19))
			{
				if (!DECORATOR::DECOR_EXIST_ON(iLocal_19, "HAS_VOICE") || !DECORATOR::DECOR_GET_BOOL(iLocal_19, "HAS_VOICE"))
				{
					...
					AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_19, "0946_A_M_M_Guard_White_AGGRESSIVE_01");
					bLocal_21 = true;
				}
			}
		}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-1.042271E+15f, 0.4424044f))
		{
			switch (iLocal_31)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_75(iLocal_31, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_59(iParam0) && func_83(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_107(&cVar6, 4.808429E-35f), sVar9, func_107(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_107(&cVar6, 4.808429E-35f), func_107(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_108(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_110(&Global_1940186, 16384);
	func_112(func_111(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_112(func_111(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_112(func_111(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_112(func_111(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_112(func_111(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_112(func_111(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_112(func_111(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
{
	if (func_113(iLocal_20, 0))
	{
		DECORATOR::DECOR_SET_BOOL(iLocal_20, "HAS_VOICE", false);
	}
...
int func_108(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	int iVar16;
