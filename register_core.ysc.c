...
void __EntryFunction__()
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(ScriptParam_0.f_1))
	{
		...
		Local_13.f_1 = TASK::_GET_SCENARIO_POINT_ENTITY(Local_13.f_2);
	}
	else
	{
		func_1(&Local_13);
	...
	while (true)
	{
		...
		if (func_4(Global_1940186, 4194304))
		{
			func_3(&Local_13, 5);
		}
		...
		switch (func_5(&Local_13))
		{
			case 0:
				...
				if (TASK::DOES_SCENARIO_POINT_EXIST(Local_13.f_2))
				{
					if (func_9(Global_34) && func_10(&Local_13))
					{
						func_3(&Local_13, 1);
					}
				}
...
{
	uParam0->f_3[0] = 6.425846E+14f;
	uParam0->f_3[1] = 6.425846E+14f;
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_11))
	{
