...
bool func_13()
{
	...
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -131.6045f, -34.30135f, 102.2093f, 0f, 0f, -24.47213f, 46.71921f, 37.52021f, 13.16044f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -117.99f, -66.781f, 100f, 0f, 0f, 94f, 16.719f, 19.52f, 13.16044f);
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((func_100(iParam0, 16384) || func_100(iParam0, 32768)) || func_101(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_121(&cVar6, 4.808429E-35f), sVar9, func_121(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_121(&cVar6, 4.808429E-35f), func_121(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_122(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_124(&Global_1940186, 16384);
	func_126(func_125(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_126(func_125(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_126(func_125(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_126(func_125(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_126(func_125(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_126(func_125(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_126(func_125(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_94(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_154(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
bool func_103(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_161(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", vParam3);
}

bool func_104(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_161(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", vParam3);
}
...
char* func_109(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_166(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_168(func_167(Global_34));
	}
...
char* func_121(char* sParam0, int iParam1)
{
	...
	return func_172(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
struct<2> func_125(float fParam0, float fParam1)
{
	struct<2> Var0;
...
{
	func_173(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_174(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_128(int iParam0)
{
	...
	if (func_87(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_176(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_177(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_178(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_179(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_154(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_160(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_200(12, func_199(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_161(int iParam0, char* sParam1, int* iParam2, char* sParam3, float* fParam4, char* sParam5, Vector3* vParam6)
{
	struct<4> Var0;
...
{
	func_209(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_179(int iParam0, float fParam1)
{
	if (!func_216(iParam0))
	{
		return;
...
bool func_187(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_219(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_220())
	{
		return func_219(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_219(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_223(int iParam0, int iParam1, bool bParam2)
{
	*bParam2 = Global_1149417.f_7;
	...
	bParam2->f_3 = func_232(iParam0);
	bParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(bParam2->f_1), bParam2);
}

void func_224(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_233(struct<2> Param0, bool bParam2)
{
	if (!func_204(Param0))
	{
		return false;
