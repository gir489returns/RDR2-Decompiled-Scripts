...
bool func_13()
{
	...
	iLocal_16 = Global_1887363[33 /*36*/].f_5;
	...
	POPULATION::SET_POPZONE_POPULATION_SET(iVar0, 4.761979E-24f);
	...
	POPULATION::SET_POPZONE_POPULATION_SET(iVar1, 4.761979E-24f);
...
bool func_40(int iParam0)
{
	...
	if (bVar0 && func_65(255))
	{
		if (bVar1)
		{
			func_66(PLAYER::PLAYER_PED_ID(), -2.88136E+38f, 0, 0);
		}
		else
		{
			func_67(5, 0);
...
bool func_62()
{
	return func_98(Global_1572887.f_8, 1);
}
...
void func_66(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Global_1295619.f_3))
	{
		...
		func_101(&Var0, &(Global_1102813.f_3599));
...
void func_67(int iParam0, bool bParam1)
{
	...
	func_107(Var30.f_6, Var30, -1f, -1f, 1, 1, 1);
	if (bParam1)
	{
		func_106(0);
	}
...
void func_75(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_59(iParam0) && func_89(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_122(&cVar6, 4.808429E-35f), sVar9, func_122(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_122(&cVar6, 4.808429E-35f), func_122(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_123(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_77(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_125(&Global_1940186, 16384);
	func_127(func_126(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_127(func_126(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_127(func_126(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_127(func_126(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_127(func_126(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_127(func_126(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_127(func_126(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_102(Vector3* vParam0, float* fParam1)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (func_146(uVar0, iVar2, vParam0, fParam1))
		{
			return true;
		}
	}
...
void func_107(vector3 vParam0, float fParam3, float fParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	float fVar3;
	...
	fVar3 = fParam3;
	if (!func_155(Global_1295619.f_12, &vVar0, &fVar3))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false) };
		fVar3 = fParam3;
	}
	func_156(vParam0, fParam3, vVar0, fVar3, fParam4, fParam5, iParam6, fParam7, fParam8, 1);
}
...
struct<2> func_126(float fParam0, float fParam1)
{
	struct<2> Var0;
...
void func_129(int iParam0)
{
	...
	if (func_93(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_170(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
...
void func_136(int iParam0, bool bParam1)
{
	...
	else if (func_185(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
...
bool func_142(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_190(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_191())
	{
		return func_190(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_190(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_146(var uParam0, int iParam1, Vector3* vParam2, float* fParam3)
{
	struct<5> Var0;
...
bool func_155(vector3 vParam0, Vector3* vParam3, float* fParam4)
{
	var uVar0;
	int iVar1;
	int iVar2;

	uVar0 = Global_1072759.f_23824.f_383[func_199(vParam0) /*272*/];
	iVar1 = func_145(uVar0);
	if (iVar1 <= 0)
	{
		return false;
	...
	{
		iVar2 = MISC::GET_RANDOM_INT_IN_RANGE(0, iVar1);
		if (func_146(uVar0, iVar2, vParam3, fParam4))
		{
			return true;
		}
	}
...
void func_156(vector3 vParam0, float fParam3, vector3 vParam4, float fParam7, float fParam8, float fParam9, bool bParam10, float fParam11, float fParam12, int iParam13)
{
	if (func_148(255) == 4)
	{
		return;
...
{
	func_208(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_186(int iParam0, float fParam1)
{
...
bool func_201()
{
	...
	if (!func_203(Global_1051268) && Global_1572887.f_8 & 1 != 0)
	{
		return true;
	}
	return false;
