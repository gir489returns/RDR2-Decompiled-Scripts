...
void func_1(int iParam0)
{
	...
	func_9(NETWORK::_NETWORK_GET_SIZE_OF_HOST_BROADCAST_DATA_STORAGE(&uLocal_14), 1, "m_hostData");
	func_10(0);
...
void func_2(var uParam0)
{
	...
	Local_0.f_12 = GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
...
bool func_3()
{
	...
	if ((Local_0.f_4 == -1 || Local_0.f_11 == -1) || Global_1225084.f_369[Local_0.f_4 /*2*/] != Local_0.f_11)
	{
		return true;
	}
	if (Local_0.f_12 != 0 && GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID()) != Local_0.f_12)
	{
		return true;
	}
	return false;
...
bool func_14(struct<2> Param0, int iParam2, int iParam3)
{
	...
	if (func_21(Global_1051268) && !func_22(Global_1051268, Param0))
	{
...
void func_15()
{
	...
	{
		if (PED::IS_PED_HOGTIED(Local_0.f_13) && PED::_0x3D9F958834AB9C30(Local_0.f_13) == Global_33)
		{
			func_11(1);
			return;
		}
...
void func_16()
{
	if (GANG::NETWORK_IS_GANG_LEADER(PLAYER::PLAYER_ID()))
	{
		if (Local_0.f_1)
		{
			func_28(6.538902E+31f, 1, 1);
		}
		else
		{
			func_28(4.065167E-25f, 1, 1);
		}
	}
	func_11(2);
}
	...
	while (iVar0 < SCRIPTS::GET_NUMBER_OF_EVENTS(1))
	{
		switch (SCRIPTS::GET_EVENT_AT_INDEX(1, iVar0))
		{
			case -1315570756:
				...
				return GANG::NETWORK_GET_GANG_ID(NETWORK::NETWORK_GET_PLAYER_INDEX_FROM_PED(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Var1.f_1))) == GANG::NETWORK_GET_GANG_ID(PLAYER::PLAYER_ID());
		}
		iVar0++;
	}
	return false;
...
void func_27()
{
	...
	{
		func_36(Local_0.f_13, "HIDEOUT_LEADER_FLEE", 0.02074981f, 0, 1, 0, 0, 1);
		func_37(&uLocal_14, 1);
	}
	if ((!func_33(uLocal_14, 2) && func_34(&(Local_0.f_8), 1000)) && PED::_0x5203038FF8BAE577(Local_0.f_13, 26, 750))
	{
		func_36(Local_0.f_13, "HIDEOUT_LEADER_TURN", 0.02074981f, 0, 1, 0, 0, 1);
		func_37(&uLocal_14, 2);
	}
}
...
void func_28(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!bParam1)
	{
		if (!Global_1149417.f_3876.f_2[func_39(iParam0, 1) /*4*/])
		{
			return;
		}
	}
	Global_1149417.f_3876.f_2[func_39(iParam0, 1) /*4*/].f_2++;
	if (!bParam2)
	{
		return;
	}
...
bool func_35()
{
	...
	while (iVar0 <= 31)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar1) && GANG::NETWORK_GET_GANG_ID(iVar1) == Local_0.f_12)
		{
			iVar2 = PLAYER::GET_PLAYER_PED(iVar1);
			if ((!ENTITY::IS_ENTITY_DEAD(iVar2) && ENTITY::GET_ENTITY_SPEED(iVar2) > 0f) && BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(iVar2, true, false), ENTITY::GET_ENTITY_COORDS(Local_0.f_13, true, false)) < 1090519040)
			{
				return true;
			}
		}
...
bool func_36(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
