...
bool func_27(bool bParam0, int iParam1)
{
	...
	if (func_64("ALL WEAPONS", &iVar1, &iVar2, -5.45926E-19f, 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_65(&Var4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_66(Var4.f_4))
			{
			}
...
bool func_28(bool bParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_70(&(Global_17418.f_55.f_664.f_1354.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
	}
	iVar1 = func_71(bParam0);
	iVar2 = func_70(&(Global_17418.f_55.f_664.f_1354.f_5), iVar1);
	if (iVar2 == -1)
	{
		return false;
...
int func_29(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_73(bParam0, -3.294982E+22f) != 0)
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_74(bParam2), bParam0, bParam3);
	}
	else
	{
		Var3 = { func_75(bParam0, bParam2) };
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Var3))
		{
			return 0;
		}
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_74(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
void func_37(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!func_77() || bParam6)
	{
		func_78(bParam0, iParam1, bParam2, bParam4, bParam3, bParam5);
		return;
	}
	bVar0 = false;
	iVar1 = MISC::ABSI(iParam1);
	StringCopy(&cVar2, func_79(iVar1 == 1, "ITEM_GET_PUMP", "ITEM_GET_PUMP_MULT"), 32);
	...
	else if (bParam2 && func_80(bParam0, 2097152))
	{
	...
	else if (!func_81(bParam0, &Var7, fVar11, iVar10, 0, -2.889029E+24f))
	{
		Var7 = "_PLACEHOLDER";
	...
	bVar18 = func_84(bParam0, 0);
	if ((func_85(iVar12) && func_48(bParam0, -7.13245E+27f)) && bVar18 != 0)
	{
		bVar18 = func_86(bParam0);
	}
	else if (func_26(bParam0) == -42.1084f)
	{
		bVar19 = func_87(bParam0);
		if (func_25(bVar19, 0))
		{
			bVar18 = func_84(bVar19, 0);
		}
	}
	if (func_88(bParam0, 3.62898E+13f) && bParam3)
	{
		iVar20 = 1;
		func_89(bParam0, -982726.7f, &iVar20, 0);
	...
	sVar21 = func_90(MISC::VAR_STRING(10, &cVar2, MISC::VAR_STRING(0, bVar18), iVar1), fVar13);
	if (iParam1 == 1)
	{
	...
	{
		sVar21 = MISC::VAR_STRING(0, func_91(bParam0, -9.085264E+22f));
	}
	if (iVar12 == -1.955052E+34f || iVar12 == 4.029065E+31f)
	{
		StringCopy(&cVar22, "", 128);
		if (func_92(bParam0, &cVar22))
		{
			sVar21 = func_94(func_93(cVar22), 4.808429E-35f);
		}
	}
	func_95(sVar21, Var7.f_1, MISC::GET_HASH_KEY(Var7), iVar16, fVar13, sVar15, sVar14, 0, 1);
}
...
bool func_39(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	Var0 = { func_96(bParam0, -5.45926E-19f, -5.45926E-19f, -5.45926E-19f, 0, 0, 0) };
	if (bParam2)
	{
		func_98(&Var0, func_97(0));
	}
	if (!func_99(&Var0, &iVar18, &iVar19, 0))
	{
		return false;
	}
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_65(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_100(bParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
bool func_40(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = func_73(bParam0, -3.294982E+22f);
	if (iVar0 != 0)
	{
		return func_101(bParam0, iParam1, iParam2, bParam3, bParam4);
	}
	Var1 = { func_41(bParam0, bParam4, 0) };
	Var6 = { func_102(bParam0, Var1, Var1.f_4, bParam4) };
	return func_100(bParam0, &Var6, &Var1, iParam1, iParam2, bParam3, bParam4);
}
...
struct<5> func_41(bool bParam0, bool bParam1, int iParam2)
{
	...
	Var0 = { func_103(bParam1) };
	Var0.f_4 = 4.978612f;
	iVar5 = func_26(bParam0);
	switch (iVar5)
	{
		case joaat("CLOTHING"):
			Var0 = { func_102(5.207907E-07f, Var0, 0.08386164f, bParam1) };
			Var0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, 5.207907E-07f);
			break;
		case joaat("WEAPON"):
			Var0 = { func_97(bParam1) };
			if (iParam2 && func_104(bParam0, 1))
			{
				Var6.f_9 = -5.45926E-19f;
				if (!func_105(bParam0, &Var0, 6.282013E+23f, 0, 0))
				{
					Var0.f_4 = 6.282013E+23f;
				}
				else if (!func_105(bParam0, &Var0, -3.587391E+15f, 0, 0))
				{
					Var0.f_4 = -3.587391E+15f;
				}
				else if (func_106(bParam0, &Var6, 6.282013E+23f))
				{
					Var0.f_4 = 6.282013E+23f;
				}
				else
		...
		case joaat("EMOTE"):
			...
			Var0 = { func_107(bParam1) };
			switch (func_68(bParam0))
			{
				case -1070622585:
					Var0.f_4 = NaNf;
					break;
		...
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_108(bParam0, -2.580501E-27f))
			{
				Var0 = { func_102(-7.437896E-28f, Var0, 4.978612f, bParam1) };
				Var0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, -7.437896E-28f);
			}
			else if (func_108(bParam0, -4.220332E-15f))
			{
				Var0 = { func_102(5.207907E-07f, Var0, 0.08386164f, bParam1) };
				Var0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, 5.207907E-07f);
			}
			...
			else if (func_108(bParam0, -3.171238E-21f))
			{
				Var0 = { func_102(2.884954E+11f, Var0, 6.727819E+25f, bParam1) };
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, -8.915019E+08f))
			{
				...
				if (!func_109(Var0, &Var28, bParam1, 0, -1))
				{
					Var0.f_4 = 0;
				}
				else
...
void func_50(int iParam0)
{
	...
	iVar1 = func_116(2);
	func_117(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_51(int iParam0, bool bParam1)
{
	...
	iVar0 = func_118(2);
	func_119(BUILTIN::TO_FLOAT((iParam0 * iVar0)), 0, bParam1);
}
...
void func_54(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		fParam1 = func_122(iParam0, fParam1, 1);
	}
	func_124(iParam0, (func_123(iParam0, 2) + fParam1), bParam2, bParam3, 1, 2);
}
...
bool func_64(char* sParam0, int iParam1, int* iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_74(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
int func_73(bool bParam0, int iParam1)
{
	...
	if (func_132(func_114(bParam0), 2))
	{
		return 0;
	}
...
struct<4> func_75(bool bParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_41(bParam0, bParam1, 0) };
	return func_102(bParam0, Var0, Var0.f_4, bParam1);
}

void func_76(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
void func_78(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
char* func_79(bool bParam0, char* sParam1, char* sParam2)
{
	if (bParam0)
	{
		return sParam1;
...
bool func_81(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_83(bool bParam0)
{
	...
	{
		if (((func_133(bParam0, -9.979451E-09f) || func_133(bParam0, 2.758862E+11f)) || func_133(bParam0, 1.868312E+36f)) || func_133(bParam0, -2.847523E-24f))
		{
			return true;
		}
	}
...
bool func_84(bool bParam0, bool bParam1)
{
	...
	iVar0 = func_134(bParam0, bParam1);
	if (iVar0 != 0)
	{
		return iVar0;
	}
...
bool func_87(bool bParam0)
{
	...
	Var1 = { func_136(-5.45926E-19f, -5.45926E-19f, 0, 0, 0, 0, -1, iVar0, 0) };
	if (func_137(Var1, &iVar11, &iVar12, 0))
	{
		iVar13 = 0;
		while (iVar13 < iVar12)
		{
			if (ITEMDATABASE::_ITEMDATABASE_GET_COMPONENT_ITEM(iVar11, iVar13, &bVar14) && func_138(bVar14))
			{
				func_139(iVar11);
				return bVar14;
			}
...
int func_89(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	struct<37> Var0;

	if (!func_25(bParam0, 0) && !func_132(func_114(bParam0), 2))
	{
		return 0;
	}
	Var0.f_4 = 15;
...
char* func_90(char* sParam0, int iParam1)
{
...
int func_91(bool bParam0, int iParam1)
{
	...
	iVar0 = func_140(bParam0, iParam1);
	if (iVar0 == 0)
	{
		return 0;
	}
...
bool func_92(bool bParam0, char* sParam1)
{
	int iVar0;
	char cVar1[128];
...
char* func_93(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)
{
	return HUD::_GET_TEXT_SUBSTRING_2(&cParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&cParam0));
}

char* func_94(char* sParam0, int iParam1)
{
...
int func_95(char* sParam0, char* sParam1, int iParam2, int iParam3, float fParam4, char* sParam5, char* sParam6, int iParam7, bool bParam8)
{
	struct<4> Var0;
	struct<7> Var13;
	int iVar20;
...
struct<18> func_96(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<18> Var0;
...
struct<4> func_97(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1292096.f_4 = { func_102(8.681942E-06f, func_103(bParam0), -1.942248E+12f, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1292096.f_16 = { func_102(8.681942E-06f, func_103(bParam0), -1.942248E+12f, 0) };
		}
		return Global_1292096.f_16;
	}
	return func_102(8.681942E-06f, func_103(bParam0), -1.942248E+12f, 0);
}

void func_98(var uParam0, struct<4> Param1)
{
...
bool func_99(var uParam0, int iParam1, int* iParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_74(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_100(bool bParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	struct<14> Var0;
	int iVar14;
	struct<13> Var15;
	...
	if (!func_109(*iParam1, &Var0, bParam6, 0, -1))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!func_42(bParam6))
	{
		...
		else if (func_61() == 0)
		{
			...
			Var15.f_9 = iParam3;
			Var15.f_12 = iParam4;
			iVar14 = func_146(7.184882E+22f, &Var15, 1);
			if (iVar14 != -1)
			{
				...
				Var32 = bParam5;
				Var32.f_7 = iParam4;
				func_147(iVar14, Var32);
			}
		}
		return iVar14 != -1;
	}
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_74(bParam6), iParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
int func_101(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	struct<6> Var1[10];
	int iVar62;
	...
	if (!func_42(bParam4))
	{
		...
		if (!func_148(&Var1, &iVar62, bParam0, iVar0, iParam1, 1) || iVar62 < 1)
		{
			return 0;
		}
		iVar64 = -1;
		...
		while (iVar63 < iVar62)
		{
			Var65 = { func_149(bParam0, &(Var1[iVar63 /*6*/])) };
			Var65.f_12 = iParam2;
			iVar64 = func_146(7.184882E+22f, &Var65, 1);
			if (iVar64 == -1)
			{
				return 0;
			}
		...
		if (iVar64 != -1)
		{
			...
			Var82 = bParam3;
			Var82.f_7 = iParam2;
			func_147(iVar64, Var82);
			return 1;
		}
		return 0;
	}
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_74(bParam4), bParam0, iParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
struct<4> func_102(bool bParam0, var uParam1, float fParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_74(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

struct<4> func_103(bool bParam0)
{
	int iVar0;
	...
	if (Global_1572887.f_14 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1292096 = { func_102(2.982335E+09f, func_150(), -5.45926E-19f, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1292096.f_12 = { func_102(2.982335E+09f, func_150(), -5.45926E-19f, 0) };
			}
			return Global_1292096.f_12;
		}
	}
	return func_102(2.982335E+09f, func_150(), -5.45926E-19f, bParam0);
}

int func_104(bool bParam0, bool bParam1)
{
	if (func_68(bParam0) == 4.161967E+25f)
	{
		return 0;
	}
...
bool func_105(bool bParam0, var uParam1, float fParam2, int iParam3, float fParam4)
{
	return func_152(bParam0, *uParam1, fParam2, iParam3, 1, fParam4) > 0;
}

bool func_106(bool bParam0, int iParam1, float fParam2)
{
	var uVar0;
...
struct<4> func_107(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1292096.f_8 = { func_102(3.507197E-29f, func_103(bParam0), 12999093, 0) };
		}
		return Global_1292096.f_8;
	}
	return func_102(3.507197E-29f, func_103(bParam0), 12999093, 0);
}
...
bool func_108(bool bParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_154(bParam0, iParam1, iVar0))
			{
				return true;
			}
		}
...
int func_109(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
...
bool func_110()
{
	if ((Global_1940239.f_11596 != (Global_1940239.f_41.f_203 - 1) || func_157(func_156(0), Global_1940239.f_11588, 0, 1, 1) > 0) || Global_1940239.f_11596 == 15)
	{
		return true;
	}
	func_158(0);
...
{
	if (ANIMSCENE::GET_ANIM_SCENE_PHASE(iParam0) >= 1061158912)
	{
		return true;
	}
	return false;
...
void func_117(float fParam0, int iParam1)
{
	if (fParam0 == 0f)
	{
		return;
...
void func_119(float fParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
float func_122(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	iVar0 = func_161();
	func_162(&iVar0, 0, 0, 0, 1, 0, 0);
	iVar1 = func_163(iParam0, 2);
	if (func_165(iVar0, func_164(iParam0, 2), 1))
	{
...
int func_124(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	int iVar0;
	...
	iVar0 = PLAYER::PLAYER_PED_ID();
	if (func_168(iVar0, iParam0, fParam1))
	{
		if (bParam2)
		{
		...
		func_170(iVar0, iParam0, fParam1);
		func_171(iParam0, fParam1, bParam4, iParam5);
	}
	return 1;
}

int func_125(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	char* sVar0;
	int iVar1;
...
bool func_126()
{
	...
	return func_176(Global_1956862.f_1431.f_107, 0);
}
...
void func_127(float fParam0, int iParam1)
{
	...
	fVar0 = func_177(13, 2);
	iVar1 = func_178(fVar0);
	fVar0 = (fVar0 + fParam0);
	fVar0 = func_179(fVar0, 0f, 1120403456 /* Float: 100f */);
	iVar2 = func_178(fVar0);
	if (iVar1 != iVar2)
	{
		Global_1956862.f_1431.f_107 = func_161();
		func_180(&(Global_1956862.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_181(13, fVar0, 2);
...
{
	return func_182(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 4.795139E-15f, iParam0, iParam1);
}
...
bool func_130(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_186(iParam0, 262144) || !Global_1904398.f_8866)
		{
			return false;
		}
	}
...
{
	if (func_68(bParam0) == -1.955052E+34f || func_68(bParam0) == 4.029065E+31f)
	{
		return true;
	}
	return false;
...
int func_146(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		{
			return func_191(func_190(iVar0, iParam0, iParam1), iVar0, iParam1);
		}
	}
	else
	{
		return func_192(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, iParam1, 17), iVar0, iParam1);
	}
	return -1;
}

void func_147(int iParam0, struct<17> Param1)
{
	int iVar0;
...
bool func_148(var uParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5)
{
	*iParam1 = 0;
	if (iParam4 < 1)
	{
	...
	if (iParam3 == 0)
	{
		iParam3 = func_73(bParam2, -3.294982E+22f);
		if (iParam3 == 0)
		{
			return false;
		}
	...
	if (!func_193(uParam0, iParam1, iParam4, bParam5))
	{
		return false;
	}
	return true;
...
struct<17> func_149(bool bParam0, var uParam1)
{
	struct<17> Var0;

	Var0.f_9 = 1;
	Var0.f_11 = -5.45926E-19f;
	Var0 = { func_102(bParam0, *uParam1, uParam1->f_4, 1) };
	Var0.f_4 = { *uParam1 };
	Var0.f_8 = bParam0;
...
int func_151()
{
	if (func_194(-0.0002099206f, 0, 0, 0) == 0)
	{
		return 0;
	}
	return 1;
...
int func_152(bool bParam0, struct<4> Param1, float fParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_73(bParam0, -3.294982E+22f) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		Var1 = { func_102(bParam0, Param1, fParam5, bParam6) };
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Var1))
		{
			return 0;
		}
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_74(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_74(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
bool func_153(bool bParam0, int iParam1, int iParam2, float fParam3)
{
	...
	iVar0 = func_74(0);
	*iParam1 = { func_102(bParam0, func_97(0), fParam3, 0) };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(iParam1))
	{
		return false;
	}
...
bool func_154(bool bParam0, int iParam1, int iParam2)
{
...
int func_157(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = (iVar0 + func_195(iParam0, bParam1));
	if (bParam3)
	{
		iVar0 = (iVar0 + func_196(bParam1, bParam4));
	}
	return iVar0;
}
...
bool func_160(int iParam0)
{
	...
	fVar0 = (func_199(iParam0) - PLAYER::_GET_PLAYER_CACHED_DEAD_EYE_AMOUNT(iParam0));
	return fVar0 <= 1f;
}
...
void func_162(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	iVar0 = (iVar0 - iParam6);
	func_207(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
bool func_168(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_209(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_170(int iParam0, int iParam1, float fParam2)
{
	char* sVar0;

	sVar0 = func_210(iParam1);
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_211(iParam1), fParam2, -1);
	}
}

void func_171(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	var uVar0;
	...
	if (bParam2)
	{
		func_213(iParam0, uVar0, iParam3);
	}
}
...
{
	func_124(iParam0, 1120403456 /* Float: 100f */, bParam1, bParam2, 1, 2);
}
...
int func_181(int iParam0, float fParam1, int iParam2)
{
	if (!func_216(iParam0))
	{
		return 0;
...
var func_182(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_219());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_219());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_219());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_220(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1295619.f_149[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_222(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
bool func_193(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
	...
	*iParam1 = 0;
	...
	while (iVar0 < 10)
	{
		...
		else if (func_227(uParam0[iVar0 /*6*/]))
		{
		}
		else
		{
...
int func_194(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_228(iParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_33, iParam0);
	}
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_74(bParam1), iParam0, bParam3);
}
...
int func_195(int iParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		{
			return func_230(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iParam0), bParam1);
		}
	}
	return 0;
}
...
int func_196(bool bParam0, bool bParam1)
{
	if (!bParam1 || func_231())
	{
		return func_152(bParam0, func_103(1), -3.233114E-34f, 1, 1, 0);
	}
	return 0;
}
...
{
	return func_232(&(Global_1956862.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_GET_PLAYER_MAX_DEAD_EYE(iParam0, 0) - IntToFloat(func_233(2)));
}
...
void func_212(int iParam0, float fParam1, int iParam2)
{
	if (iParam2 == 2)
	{
		iParam2 = func_159(2);
...
int func_215(int iParam0)
{
	...
	if (!func_242(Global_1156096.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_243(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_244(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1156096.f_35859.f_11700)
				{
					...
					{
						func_245(iVar1, iParam0, iVar4);
						func_246(&(Global_1156096.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_246(&(Global_1156096.f_35859.f_9503[Global_1156096.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_250(&(Global_1156096.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
void func_217(int iParam0, float fParam1, int iParam2)
{
	if (fParam1 < 0f)
	{
		return;
...
{
	if (!func_88(bParam0, 9.300934E+31f))
	{
		return false;
	}
...
int func_245(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_264(Global_1156096.f_35859.f_3116[iVar0 /*31*/]) && func_265(iParam0, Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_266(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_267(vVar1))
		{
			if (func_268(vVar1.x, vVar1.y, vVar1.z))
			{
				func_269(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_270(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
bool func_252(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_232(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_271())
	{
		return func_232(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_232(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
void func_256(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_274(&(Global_1292096.f_20.f_1[(Global_1292096.f_20 - 1) /*21*/]));
...
struct<4> func_259(int iParam0, bool bParam1)
{
	...
	return func_277(iParam0, bParam1, Var0, Var0.f_4);
}
...
int func_263(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_214(iParam1, 1);
	iVar1 = func_247(iParam0, 1);
	iVar2 = func_243(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1156096.f_2169[iVar5 /*205*/].f_201 = (Global_1156096.f_2169[iVar5 /*205*/].f_201 - func_282(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_283(iVar3);
		}
		iVar4++;
	}
...
bool func_264(struct<5> Param0, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30)
{
	return Param0.f_4 != 0;
}
...
bool func_268(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_292(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_294(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
struct<5> func_276(int iParam0)
{
	...
	Var0 = { func_277(iParam0, 2.982335E+09f, func_150(), -5.45926E-19f) };
	Var0.f_4 = 4.978612f;
	return Var0;
}

struct<4> func_277(int iParam0, bool bParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
int func_289(int iParam0)
{
	...
	{
		iVar64 = func_247(Global_1156096.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_313(Global_1156096.f_35859.f_9503[iVar65 /*3*/], Global_1156096.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_314(Global_1156096.f_35859.f_9503[iVar65 /*3*/]) };
...
bool func_292(var uParam0)
{
	...
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_315(1.959415E-10f, uParam0->f_1, 1, "");
		return bVar0;
	}
	return true;
}
...
void func_293(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_316(iParam0, 0));
			func_317(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_316(iParam0, 1));
			func_317(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_316(iParam0, 2));
			func_317(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_316(iParam0, 3));
			func_317(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			iVar2 = func_309(iParam0);
			func_317(iVar2, 3, 1, -1, 1);
			break;
		case joaat("SLOW_AND_STEADY_VFX"):
			iVar2 = func_309(iParam0);
			func_317(iVar2, 4, 1, -1, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_AURA"):
...
void func_294(int iParam0)
{
	...
	sVar0 = func_319(iParam0);
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		return;
	}
	sVar1 = func_320(iParam0);
...
void func_306()
{
	...
	{
		if (!func_255(Global_1297553[Global_1295619 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_313(int iParam0, int iParam1)
{
	...
	if (func_264(Global_1156096.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1156096.f_35859.f_9286[func_288(iVar2, 1) /*3*/];
		Var4 = { func_314(iVar3) };
	...
	switch (Global_1156096.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1295619 && !func_223(Global_1295619.f_149[iVar1]))
			{
				return false;
			}
			if (!func_324(512, iVar1))
			{
				return false;
			}
			return true;
...
struct<31> func_314(int iParam0)
{
	int iVar0;
...
bool func_315(int iParam0, int iParam1, bool bParam2, char* sParam3)
{
	struct<11> Var0;
	bool bVar22;
...
bool func_321(int iParam0, int iParam1, var uParam2)
{
	...
	if (DATAFILE::_PARSEDDATA_GET_SECTION(&iVar7, &Var0, -5.324383E+23f))
	{
		*uParam2 = iParam0;
		...
		uParam2->f_10.f_3 = func_325(iVar7);
