...
void __EntryFunction__()
{
	...
	while (true)
	{
		while (UIEVENTS::EVENTS_UI_IS_PENDING(fLocal_0))
		{
			if (UIEVENTS::EVENTS_UI_PEEK_MESSAGE(fLocal_0, &iVar1))
			{
				switch (iVar1)
				{
					case -1203660660:
				...
				UIEVENTS::EVENTS_UI_POP_MESSAGE(fLocal_0);
			}
		}
		BUILTIN::WAIT(0);
	}
