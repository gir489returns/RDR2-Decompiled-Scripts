...
void __EntryFunction__()
{
	...
	vVar184 = { 0f, 0f, 0f };
	vVar187 = { 0f, 0f, 0f };
	switch (func_1(Var0.f_2, -60352.49f))
	{
		case -1919515848:
			vVar181 = { 1103626240 /* Float: 25f */, 0f, 1119092736 /* Float: 90f */ };
			vVar184 = { 0f, 0f, 0f };
			vVar187 = { -1115151362, -1143230401, 1022351681 };
			break;
		case 1443104131:
			iVar190 = TASK::GET_ITEM_INTERACTION_STATE(Global_33);
			switch (iVar190)
			{
				case joaat("QUICK_SMOKE_CIGARETTE_RIGHT_HAND"):
					vVar187 = { -1133070784, -1158801418, 1011492179 };
					break;
				case joaat("QUICK_SMOKE_CIGARETTE_LEFT_HAND"):
					vVar187 = { -1133430488, -1148736226, 961497445 };
					break;
				case joaat("QUICK_SMOKE_CIGARETTE_RIFLE"):
					vVar187 = { -1148952714, -1165622427, 1002731218 };
					break;
			}
			break;
	}
	...
	while (!SCRIPTS::IS_THREAD_EXIT_REQUESTED())
	{
		if (!ScriptParam_0.f_3)
		{
			...
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 0.02435817f))
				{
					ENTITY::DETACH_ENTITY(Var0.f_180, false, true);
					func_2(&Var0, 7966, 0f, 0f, 0f, vVar184);
					bVar192 = false;
				}
				else if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, -0.0001631358f))
				{
					ENTITY::DETACH_ENTITY(Var0.f_180, false, true);
					func_2(&Var0, 37709, 0f, 0f, 0f, vVar184);
					bVar192 = false;
				}
				else if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 1.701159E+11f))
				{
					func_2(&Var0, 9650, vVar187, vVar181);
					bVar192 = true;
				}
				else if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, NaNf))
				{
			...
			{
				Var0.f_180 = TASK::_GET_ITEM_INTERACTION_ENTITY_FROM_PED(Global_33, 7.655073E+37f);
			}
		}
		if (!ScriptParam_0.f_3)
		{
				...
				else if (!bVar191)
				{
					if (func_8() == -1 && func_9(0))
					{
						if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 4.543783E-35f))
						{
							...
							{
								if (func_10(Global_33, "Player_Sick_Smoking_Cough", -1.799829E+34f, 0, 1, 0, 0, 1))
								{
									bVar191 = true;
								}
							}
...
void func_7(var uParam0, bool bParam1)
{
	...
	if ((func_12(*uParam0, 1.763507E+18f) || func_12(*uParam0, 8.273569E-15f)) || func_12(*uParam0, -1.230845E+19f))
	{
		bVar10 = true;
	}
	...
	{
		func_23(uParam0);
		func_24(*uParam0, bVar8, iVar9, 9.275179E-19f);
	}
	func_11(uParam0);
...
bool func_10(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
void func_23(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1879593571:
		case 1934214136:
			func_41(-8.650952E-05f, -2.629533E+32f, 8100);
			break;
	}
}
...
{
	if (iParam2 || func_12(bParam0, -3.480943E+19f))
	{
		func_43(func_42(-3.750745E+13f), 1);
	}
	if (func_12(bParam0, -3.458856E-14f))
	{
		func_43(func_42(-2.12416E-30f), 1);
	}
	if (func_12(bParam0, 1.763507E+18f))
	{
		func_45(func_44(bParam0), 1);
	}
	if (func_12(bParam0, 2.343408E+31f))
	{
		func_43(func_46(7.642884E+10f, -129968.5f), 1);
	}
	if (func_12(bParam0, 1.987618E+33f))
	{
		func_43(func_42(-2.413646E-08f), 1);
	}
	if (func_12(bParam0, 1894063f))
	{
		func_43(func_42(1.884128E-06f), 1);
	}
	switch (bParam0)
	{
		...
		case joaat("CONSUMABLE_HAYCUBE"):
			func_43(func_46(7.642884E+10f, -2.03267E-35f), 1);
			break;
	}
	switch (bParam0)
	{
		case -611782825:
			func_43(func_46(7.642884E+10f, -3.483875E-29f), 1);
			break;
		case joaat("CONSUMABLE_MOONSHINE"):
			func_43(func_46(7.642884E+10f, 5.234738E-28f), 1);
			break;
		case joaat("CONSUMABLE_WHISKEY_USED"):
		case joaat("CONSUMABLE_WHISKEY"):
			func_43(func_46(7.642884E+10f, 7.840773E-07f), 1);
			break;
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM_USED"):
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM"):
			func_43(func_46(7.642884E+10f, 7.177263E+37f), 1);
			break;
		case joaat("CONSUMABLE_SNAKE_OIL"):
		case joaat("CONSUMABLE_POTENT_SNAKE_OIL"):
		case joaat("CONSUMABLE_SNAKE_OIL_USED"):
			func_43(func_46(7.642884E+10f, -3.568742E-26f), 1);
			break;
		case joaat("CONSUMABLE_CHEWING_TOBACCO"):
		case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
			func_43(func_46(7.642884E+10f, -1.888559E+33f), 1);
			break;
		...
		case joaat("CONSUMABLE_POTENT_HORSE_MEDICINE"):
			func_43(func_46(7.642884E+10f, 4.325028E-21f), 1);
			break;
		case joaat("CONSUMABLE_HERBIVORE_BAIT"):
		case joaat("CONSUMABLE_POTENT_HERBIVORE_BAIT"):
			func_43(func_46(7.642884E+10f, -4.824814E+07f), 1);
			break;
		case joaat("CONSUMABLE_PREDATOR_BAIT"):
		case joaat("CONSUMABLE_POTENT_PREDATOR_BAIT"):
			func_43(func_46(7.642884E+10f, -2.336031E+31f), 1);
			break;
	}
	if (func_8() == -1)
	{
		...
		{
			func_43(func_46(7.642884E+10f, 1.386211E-17f), 1);
		}
	}
	if (bParam1)
	{
		func_43(func_42(1.131948E-13f), 1);
	}
	func_47(bParam0, iParam3);
}
...
bool func_37()
{
	...
	return func_62(Global_1956862.f_1431.f_107, 0);
}
...
void func_38(float fParam0, int iParam1)
{
	...
	iVar1 = func_64(fVar0);
	fVar0 = (fVar0 + fParam0);
	fVar0 = func_65(fVar0, 0f, 1120403456 /* Float: 100f */);
	iVar2 = func_64(fVar0);
	if (iVar1 != iVar2)
	{
		Global_1956862.f_1431.f_107 = func_51();
		func_66(&(Global_1956862.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_67(13, fVar0, 2);
...
struct<2> func_42(float fParam0)
{
	struct<2> Var0;
...
void func_45(int iParam0, int iParam1)
{
	...
	Var0 = { func_46(-3.114499E+25f, func_86(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_43(func_87(3.939822E-35f), iParam1);
}

struct<2> func_46(float fParam0, int iParam1)
{
	struct<2> Var0;
...
void func_47(bool bParam0, int iParam1)
{
	...
	if (func_8() == 0)
	{
		...
		if (func_12(bParam0, -8.87647E+33f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, -9.82979E+16f, 1);
		}
		if ((func_12(bParam0, 1.378098E+25f) || 3.62898E+13f == iVar0) || -9.276053E-31f == iVar0)
		{
		...
		if (func_12(bParam0, -1.064618E-36f) && !func_12(bParam0, -2.927334E-06f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, -4.02404E-14f, 1);
		}
		if (func_12(bParam0, 9.495676E-32f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, 2.208807E+11f, 1);
		}
		if (((func_12(bParam0, -1.051639E+07f) || func_12(bParam0, -5.092244E+08f)) || func_12(bParam0, 1.431632E+07f)) || bParam0 == -1.954145E-33f)
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, 2.96823E-25f, 1);
		}
		if (func_12(bParam0, -2.529679E+11f))
		{
...
bool func_50(int iParam0)
{
	...
	fVar0 = (func_90(iParam0) - PLAYER::_GET_PLAYER_CACHED_DEAD_EYE_AMOUNT(iParam0));
	return fVar0 <= 1f;
}
...
bool func_69(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_110(iParam0, 262144) || !Global_1904398.f_8866)
		{
			return false;
		}
	}
...
{
	func_36(iParam0, 1120403456 /* Float: 100f */, bParam1, bParam2, 1, 2);
}
...
bool func_82(int iParam0)
{
	...
	return Global_1156096.f_35859.f_919[func_113(iParam0, 1) /*12*/] == -1;
}
...
int func_83(int iParam0)
{
	...
	iVar0 = func_113(iParam0, 1);
	if (!func_79(Global_1156096.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_114(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_115(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1156096.f_35859.f_11700)
				{
					...
					{
						func_116(iVar1, iParam0, iVar4);
						func_117(&(Global_1156096.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_117(&(Global_1156096.f_35859.f_9503[Global_1156096.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_121(&(Global_1156096.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
struct<2> func_87(float fParam0)
{
	struct<2> Var0;
...
{
	return func_130(&(Global_1956862.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_GET_PLAYER_MAX_DEAD_EYE(iParam0, 0) - IntToFloat(func_131(2)));
}
...
int func_116(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_144(Global_1156096.f_35859.f_3116[iVar0 /*31*/]) && func_145(iParam0, Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_146(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_147(vVar1))
		{
			if (func_148(vVar1.x, vVar1.y, vVar1.z))
			{
				func_149(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_150(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_123(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_144(Global_1156096.f_35859.f_3116[iVar0 /*31*/]);
	if (bVar1 && func_152(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar2 = { func_153(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4) };
	...
	if (func_148(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_149(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
bool func_143(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_114(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1156096.f_2169[iVar5 /*205*/].f_201 = (Global_1156096.f_2169[iVar5 /*205*/].f_201 - func_156(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_157(iVar3);
		}
		iVar4++;
	}
...
bool func_148(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_165(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_167(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
float func_156(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		fVar0 = func_169(1.959415E-10f, uParam0->f_2, uParam0->f_1, "");
		return fVar0;
	}
	return uParam0->f_1;
}
...
void func_157(int iParam0)
{
	...
	iVar0 = func_154(iParam0, 1);
	if (!func_170(Global_1156096.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_171(Global_1156096.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_172(Global_1156096.f_2169[iVar0 /*205*/].f_203, 1);
...
int func_163(int iParam0)
{
	...
	{
		iVar64 = func_118(Global_1156096.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_179(Global_1156096.f_35859.f_9503[iVar65 /*3*/], Global_1156096.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_180(Global_1156096.f_35859.f_9503[iVar65 /*3*/]) };
...
bool func_165(var uParam0)
{
	...
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_181(1.959415E-10f, uParam0->f_1, 1, "");
		return bVar0;
	}
	return true;
}
...
void func_173()
{
	...
	{
		if (!func_188(Global_1297553[Global_1295619 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_179(int iParam0, int iParam1)
{
	...
	if (func_144(Global_1156096.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1156096.f_35859.f_9286[func_162(iVar2, 1) /*3*/];
		Var4 = { func_180(iVar3) };
	...
	switch (Global_1156096.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1295619 && !func_191(Global_1295619.f_149[iVar1]))
			{
				return false;
			}
