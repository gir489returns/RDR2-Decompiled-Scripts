...
void __EntryFunction__()
{
	...
	if (!func_2(bVar183, 0))
	{
		bVar183 = 1.982309E-17f;
	}
	STREAMING::_REQUEST_CLIP_SET_BY_HASH(-4.067891E+13f);
	STREAMING::REQUEST_MODEL(-3.170696E-24f, false);
	...
	while (!SCRIPTS::IS_THREAD_EXIT_REQUESTED() && !ENTITY::IS_ENTITY_DEAD(Global_33))
	{
		if (!ScriptParam_0.f_3)
		{
			...
			func_4(&Var0);
			if (func_5(&uLocal_16) && func_6(&uLocal_16, 1048576000 /* Float: 0.25f */))
			{
				func_7(Var0.f_182);
			}
		}
		...
		switch (Var0)
		{
			case 0:
				...
				break;
			case 1:
				iVar185 = TASK::GET_ITEM_INTERACTION_STATE(Global_33);
				if (iVar185 != -8.14985E+17f)
				{
					if (iVar185 == 8.865877E-33f || iVar185 == 1.972774E+29f)
					{
						if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 1) || TASK::IS_PED_EXITING_SCENARIO(Global_33, false))
						{
							TASK::_0xB35370D5353995CB(Global_33, -8.14985E+17f, 1f);
						}
					}
				}
				else if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_33, 1))
				{
					...
					if (iVar186 == -0.0004018912f)
					{
						TASK::_0xB35370D5353995CB(Global_33, 8.865877E-33f, 1f);
					}
					else if (iVar186 != -6.356208E+22f)
					{
					}
					else
					{
						TASK::_0xB35370D5353995CB(Global_33, 1.972774E+29f, 1f);
					}
				}
				if (IntToFloat(Var0.f_1.f_1) >= (Var0.f_1.f_2 - 1f) || ((MISC::GET_FRAME_COUNT() % 10) == 0 && ENTITY::GET_ENTITY_SUBMERGED_LEVEL(Global_33) > 1045220557))
				{
					func_10(&Var0, 2);
				}
				break;
			case 2:
				...
				if (iVar185 == -8.14985E+17f || iVar185 == 1.972774E+29f)
				{
					PED::_SET_PED_BLACKBOARD_BOOL(Global_33, "HIDE_STEW_EAT_PROMPT", true, 1);
					if (iVar185 != 1.972774E+29f)
					{
						TASK::_0xB35370D5353995CB(Global_33, -5.310118E+16f, 0.25f);
					}
					else
					{
						TASK::_0xB35370D5353995CB(Global_33, -8.359511E+09f, 0.25f);
					}
					func_10(&Var0, 3);
				}
				else if (iVar185 == 8.865877E-33f || (iVar185 == 1.109502E+11f && ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, 2799.592f)))
				{
					PED::_SET_PED_BLACKBOARD_BOOL(Global_33, "HIDE_STEW_EAT_PROMPT", true, 1);
					PED::_ADD_SCENARIO_TRANSITION(Global_33);
					PED::_GIVE_PED_HASH_COMMAND(Global_33, -0.01386686f, 1.5f);
				}
				break;
			case 3:
				PED::_SET_PED_BLACKBOARD_BOOL(Global_33, "HIDE_STEW_EAT_PROMPT", true, 1);
...
void func_4(var uParam0)
{
	...
	{
		if (STREAMING::HAS_MODEL_LOADED(-3.170696E-24f))
		{
			uParam0->f_179 = OBJECT::CREATE_OBJECT(-3.170696E-24f, Global_34, false, true, false, false, true);
	...
	else if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, -4.854551E+13f))
	{
		ENTITY::SET_ENTITY_VISIBLE(uParam0->f_179, true);
	}
	else if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_33, -3.264944E-12f))
	{
		ENTITY::SET_ENTITY_VISIBLE(uParam0->f_179, false);
	}
	func_11(uParam0->f_1, &(uParam0->f_180), 2.654967E-11f, uParam0->f_182, 1);
	func_11(uParam0->f_1, &(uParam0->f_181), 2.107521E+23f, -5.20523E+11f, 0);
}
...
void func_8(var uParam0, bool bParam1)
{
	...
	if ((func_17(*uParam0, 1.763507E+18f) || func_17(*uParam0, 8.273569E-15f)) || func_17(*uParam0, -1.230845E+19f))
	{
		bVar10 = true;
	}
	...
	{
		func_28(uParam0);
		func_29(*uParam0, bVar8, iVar9, 9.275179E-19f);
	}
	func_30(uParam0);
...
{
	return func_33(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 4.795139E-15f, iParam0, iParam1);
}
...
void func_28(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1879593571:
		case 1934214136:
			func_50(-8.650952E-05f, -2.629533E+32f, 8100);
			break;
	}
}

void func_29(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	if (iParam2 || func_17(bParam0, -3.480943E+19f))
	{
		func_52(func_51(-3.750745E+13f), 1);
	}
	if (func_17(bParam0, -3.458856E-14f))
	{
		func_52(func_51(-2.12416E-30f), 1);
	}
	if (func_17(bParam0, 1.763507E+18f))
	{
		func_54(func_53(bParam0), 1);
	}
	if (func_17(bParam0, 2.343408E+31f))
	{
		func_52(func_55(7.642884E+10f, -129968.5f), 1);
	}
	if (func_17(bParam0, 1.987618E+33f))
	{
		func_52(func_51(-2.413646E-08f), 1);
	}
	if (func_17(bParam0, 1894063f))
	{
		func_52(func_51(1.884128E-06f), 1);
	}
	switch (bParam0)
	{
		...
		case joaat("CONSUMABLE_HAYCUBE"):
			func_52(func_55(7.642884E+10f, -2.03267E-35f), 1);
			break;
	}
	switch (bParam0)
	{
		case -611782825:
			func_52(func_55(7.642884E+10f, -3.483875E-29f), 1);
			break;
		case joaat("CONSUMABLE_MOONSHINE"):
			func_52(func_55(7.642884E+10f, 5.234738E-28f), 1);
			break;
		case joaat("CONSUMABLE_WHISKEY_USED"):
		case joaat("CONSUMABLE_WHISKEY"):
			func_52(func_55(7.642884E+10f, 7.840773E-07f), 1);
			break;
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM_USED"):
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM"):
			func_52(func_55(7.642884E+10f, 7.177263E+37f), 1);
			break;
		case joaat("CONSUMABLE_SNAKE_OIL"):
		case joaat("CONSUMABLE_POTENT_SNAKE_OIL"):
		case joaat("CONSUMABLE_SNAKE_OIL_USED"):
			func_52(func_55(7.642884E+10f, -3.568742E-26f), 1);
			break;
		case joaat("CONSUMABLE_CHEWING_TOBACCO"):
		case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
			func_52(func_55(7.642884E+10f, -1.888559E+33f), 1);
			break;
		...
		case joaat("CONSUMABLE_POTENT_HORSE_MEDICINE"):
			func_52(func_55(7.642884E+10f, 4.325028E-21f), 1);
			break;
		case joaat("CONSUMABLE_HERBIVORE_BAIT"):
		case joaat("CONSUMABLE_POTENT_HERBIVORE_BAIT"):
			func_52(func_55(7.642884E+10f, -4.824814E+07f), 1);
			break;
		case joaat("CONSUMABLE_PREDATOR_BAIT"):
		case joaat("CONSUMABLE_POTENT_PREDATOR_BAIT"):
			func_52(func_55(7.642884E+10f, -2.336031E+31f), 1);
			break;
	}
	if (func_56() == -1)
	{
		...
		{
			func_52(func_55(7.642884E+10f, 1.386211E-17f), 1);
		}
	}
	if (bParam1)
	{
		func_52(func_51(1.131948E-13f), 1);
	}
...
bool func_46()
{
	...
	return func_81(Global_1956862.f_1431.f_107, 0);
}
...
void func_47(float fParam0, int iParam1)
{
	...
	iVar1 = func_83(fVar0);
	fVar0 = (fVar0 + fParam0);
	fVar0 = func_84(fVar0, 0f, 1120403456 /* Float: 100f */);
	iVar2 = func_83(fVar0);
	if (iVar1 != iVar2)
	{
		Global_1956862.f_1431.f_107 = func_70();
...
struct<2> func_51(float fParam0)
{
	struct<2> Var0;
...
void func_54(int iParam0, int iParam1)
{
	...
	Var0 = { func_55(-3.114499E+25f, func_105(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_52(func_106(3.939822E-35f), iParam1);
}
...
void func_57(bool bParam0, int iParam1)
{
	...
	if (func_56() == 0)
	{
		iVar0 = func_107(bParam0, -60352.49f);
		if (iParam1 == -1.202057E-11f)
		{
			return;
		}
		if (func_17(bParam0, -8.87647E+33f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, -9.82979E+16f, 1);
		}
		if ((func_17(bParam0, 1.378098E+25f) || 3.62898E+13f == iVar0) || -9.276053E-31f == iVar0)
		{
		...
		if (func_17(bParam0, -1.064618E-36f) && !func_17(bParam0, -2.927334E-06f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, -4.02404E-14f, 1);
		}
		if (func_17(bParam0, 9.495676E-32f))
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, 2.208807E+11f, 1);
		}
		if (((func_17(bParam0, -1.051639E+07f) || func_17(bParam0, -5.092244E+08f)) || func_17(bParam0, 1.431632E+07f)) || bParam0 == -1.954145E-33f)
		{
			STATS::CHAL_ADD_GOAL_PROGRESS_INT(-2.526142E-27f, 2.96823E-25f, 1);
		}
		if (func_17(bParam0, -2.529679E+11f))
		{
...
bool func_69(int iParam0)
{
	...
	fVar0 = (func_115(iParam0) - PLAYER::_GET_PLAYER_CACHED_DEAD_EYE_AMOUNT(iParam0));
	return fVar0 <= 1f;
}
...
bool func_88(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_135(iParam0, 262144) || !Global_1904398.f_8866)
		{
			return false;
		}
	}
...
{
	func_45(iParam0, 1120403456 /* Float: 100f */, bParam1, bParam2, 1, 2);
}
...
bool func_101(int iParam0)
{
	...
	return Global_1156096.f_35859.f_919[func_138(iParam0, 1) /*12*/] == -1;
}
...
int func_102(int iParam0)
{
	...
	iVar0 = func_138(iParam0, 1);
	if (!func_98(Global_1156096.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_139(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_140(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1156096.f_35859.f_11700)
				{
					...
					{
						func_141(iVar1, iParam0, iVar4);
						func_142(&(Global_1156096.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_142(&(Global_1156096.f_35859.f_9503[Global_1156096.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_146(&(Global_1156096.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
struct<2> func_106(float fParam0)
{
	struct<2> Var0;
...
bool func_110(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_155(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_156())
	{
		return func_155(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_155(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
{
	return func_155(&(Global_1956862.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_GET_PLAYER_MAX_DEAD_EYE(iParam0, 0) - IntToFloat(func_159(2)));
}
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_172(Global_1156096.f_35859.f_3116[iVar0 /*31*/]) && func_173(iParam0, Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_174(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_175(vVar1))
		{
			if (func_176(vVar1.x, vVar1.y, vVar1.z))
			{
				func_177(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_178(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_172(Global_1156096.f_35859.f_3116[iVar0 /*31*/]);
	if (bVar1 && func_180(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar2 = { func_181(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4) };
	...
	if (func_176(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_177(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
bool func_171(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_139(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1156096.f_2169[iVar5 /*205*/].f_201 = (Global_1156096.f_2169[iVar5 /*205*/].f_201 - func_184(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_185(iVar3);
		}
		iVar4++;
	}
...
bool func_176(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_193(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_195(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
float func_184(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		fVar0 = func_197(1.959415E-10f, uParam0->f_2, uParam0->f_1, "");
		return fVar0;
	}
	return uParam0->f_1;
}
...
void func_185(int iParam0)
{
	...
	iVar0 = func_182(iParam0, 1);
	if (!func_198(Global_1156096.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_199(Global_1156096.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_200(Global_1156096.f_2169[iVar0 /*205*/].f_203, 1);
...
int func_191(int iParam0)
{
	...
	{
		iVar64 = func_143(Global_1156096.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_207(Global_1156096.f_35859.f_9503[iVar65 /*3*/], Global_1156096.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_208(Global_1156096.f_35859.f_9503[iVar65 /*3*/]) };
...
bool func_193(var uParam0)
{
	...
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_209(1.959415E-10f, uParam0->f_1, 1, "");
		return bVar0;
	}
	return true;
}
...
void func_201()
{
	...
	{
		if (!func_216(Global_1297553[Global_1295619 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_207(int iParam0, int iParam1)
{
	...
	if (func_172(Global_1156096.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1156096.f_35859.f_9286[func_190(iVar2, 1) /*3*/];
		Var4 = { func_208(iVar3) };
	...
	switch (Global_1156096.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1295619 && !func_66(Global_1295619.f_149[iVar1]))
			{
				return false;
			}
