	...
	switch (iLocal_39)
	{
		case 0:
			if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_16))
			{
				...
				{
					iLocal_37 = PED::_GET_PED_REGISTER_PROP(iLocal_36, "p_fishingPole02x_PH_R_HAND", false);
		...
		case 1:
			...
			if (!bLocal_38)
			{
				if (Local_18 == 1)
				{
					if (ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_36, 109842.8f))
					{
						func_13();
						bLocal_38 = true;
					}
...
bool func_20(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_18.f_5) && ENTITY::DOES_ENTITY_EXIST(Local_18.f_6))
	{
		if (!PHYSICS::DOES_ROPE_EXIST(Local_18.f_8))
		{
			...
			PHYSICS::_0xD699E688B49C0FD2(Local_18.f_8, 0.5f, Local_18.f_10, Local_18.f_10, true);
			PHYSICS::_ATTACH_ENTITIES_TO_ROPE_2(Local_18.f_8, iParam0, Local_18.f_5, 0f, 0f, 0f, 0f, 0f, 0f, Local_18.f_4, "rod_attach");
			PHYSICS::_CREATE_ROPE_WINDING_ABILITY(Local_18.f_8, 0, 0, -1f, true);
			PHYSICS::_0xBB3E9B073E66C3C9(Local_18.f_8, true, true, true, false);
		...
		if (!PHYSICS::DOES_ROPE_EXIST(Local_18.f_9))
		{
			...
			PHYSICS::_0xD699E688B49C0FD2(Local_18.f_9, 0.5f, Local_18.f_11, Local_18.f_11, true);
			PHYSICS::_ATTACH_ENTITIES_TO_ROPE_2(Local_18.f_9, Local_18.f_5, Local_18.f_6, 0f, 0f, 0f, 0f, 0f, 0f, "hook_attach", "fishingLine_bone");
			PHYSICS::_CREATE_ROPE_WINDING_ABILITY(Local_18.f_9, 0, 0, -1f, true);
			PHYSICS::_0xBB3E9B073E66C3C9(Local_18.f_9, true, true, true, false);
...
bool func_22(int iParam0)
{
	...
	else if (PHYSICS::_ROPE_GET_FORCED_LENGTH(Local_18.f_8) >= Local_18.f_12)
	{
...
bool func_23()
{
	...
	else if (PHYSICS::_ROPE_GET_FORCED_LENGTH(Local_18.f_8) <= Local_18.f_10)
	{
		PHYSICS::STOP_ROPE_UNWINDING_FRONT(Local_18.f_8);
		Local_18.f_17 = 0;
		PHYSICS::SET_DAMPING(Local_18.f_5, 0, Local_18.f_15);
...
void func_25(int iParam0)
{
	...
	vVar4 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vVar0, fVar3, 0f, 10f, 0f) };
	vVar7 = { func_26(vVar4 - vVar0) };
	fVar10 = 1f;
	fVar11 = 0f;
	func_27(&fVar10, &fVar11, 1110704128 /* Float: 45f */);
