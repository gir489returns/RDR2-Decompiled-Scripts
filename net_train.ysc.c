...
void func_5(var uParam0, var uParam1)
{
	...
	if ((NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::NETWORK_GET_NUM_PARTICIPANTS() <= 1) && NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		while (iVar0 <= 3)
		{
			if (VOLUME::IS_VOLUME_LOCK_REQUEST_VALID(uParam0->f_3[iVar0]))
			{
				uParam0->f_3[iVar0] = 0;
			}
			if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(uParam0->f_8[iVar0]))
			{
				VOLUME::_RELEASE_LOCK_VOLUME(uParam0->f_8[iVar0]);
			}
			iVar0++;
		}
	}
...
void func_17(int iParam0)
{
	...
	iVar1 = VEHICLE::_GET_NUM_CARS_FROM_TRAIN_CONFIG(iParam0);
	iVar2 = 0;
	iVar2 = 0;
	while (iVar2 <= (iVar1 - 1))
	{
		iVar0 = VEHICLE::_GET_TRAIN_MODEL_FROM_TRAIN_CONFIG_BY_CAR_INDEX(iParam0, iVar2);
		if (iVar0 != 0)
		{
...
void func_22(var uParam0, var uParam1)
{
	...
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0->f_1))
	{
		...
		VEHICLE::_SET_TRAIN_STOPS_FOR_STATIONS(iVar5, func_41(uParam1->f_1));
		VEHICLE::_0xE6BD7DD3FD474415(iVar5, func_42(uParam1->f_1));
		VEHICLE::_0x06A09A6E0C6D2A84(iVar5, false);
		if (!func_43(uParam1->f_1))
		{
			VEHICLE::_0xA72B1BF3857B94D7(iVar5, true);
		}
	...
	else
	{
		...
		else if (VEHICLE::_HAS_TRAIN_LOADED(iVar7))
		{
...
void func_28(var uParam0, var uParam1)
{
	...
	if (*uParam0 > 2 && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(uParam0->f_1))
	{
		...
		else if (VEHICLE::_HAS_TRAIN_LOADED(iVar0))
		{
			...
			if (func_50(uParam1->f_1))
			{
				if (MAP::DOES_BLIP_EXIST(func_51(*uParam1)))
				{
					...
					MAP::_BLIP_SET_STYLE(uParam1->f_3, -3.327737E+24f);
				}
				else
				{
					uParam1->f_3 = MAP::BLIP_ADD_FOR_ENTITY(-3.327737E+24f, iVar0);
				}
				MAP::SET_BLIP_SPRITE(uParam1->f_3, -7.208583E+29f, true);
				if (!func_52(*uParam1, 16))
				{
					MAP::BLIP_REMOVE_MODIFIER(uParam1->f_3, -0.0001894792f);
				}
				else
				{
					MAP::BLIP_ADD_MODIFIER(uParam1->f_3, -0.0001894792f);
				}
			...
			iVar1 = VEHICLE::_GET_TRAIN_CARRIAGE_TRAILER_NUMBER(iVar0);
			func_55(*uParam1, iVar1);
			iVar12 = 0;
			iVar12 = 0;
			while (iVar12 <= (iVar1 - 1))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_4[iVar12]) && !ENTITY::IS_ENTITY_DEAD(uParam1->f_4[iVar12]))
				{
					if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam1->f_4[iVar12]))
					{
						...
						ENTITY::_SET_ENTITY_FADE_IN(uParam1->f_4[iVar12]);
					}
					MISC::GET_MODEL_DIMENSIONS(ENTITY::GET_ENTITY_MODEL(uParam1->f_4[iVar12]), &vVar3, &vVar6);
					vVar9 = { vVar6 - vVar3 };
					vVar9.x = (vVar9.x * 1063675494);
					vVar9.f_2 = (vVar9.z * 1067450368);
					iVar2 = VOLUME::CREATE_VOLUME_BOX(ENTITY::GET_ENTITY_COORDS(uParam1->f_4[iVar12], false, false), 0f, 0f, ENTITY::GET_ENTITY_HEADING(uParam1->f_4[iVar12]), vVar9);
					PED::_ATTACH_VOLUME_TO_ENTITY(iVar2, uParam1->f_4[iVar12], 0f, 0f, (vVar9.z * 1058642330), 0f, 0f, 0f, 2, true);
					func_57(*uParam1, iVar12, uParam1->f_4[iVar12]);
					func_58(*uParam1, iVar12, iVar2);
				}
				iVar12++;
			}
			func_59(*uParam1, 4);
...
void func_31(var uParam0)
{
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iVar0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		...
		if (!func_64(vVar1))
		{
			vVar4 = { Global_1148603[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*13*/][*uParam0 /*4*/].f_1 };
			if (BUILTIN::VDIST(vVar4, vVar1) > 1092616192)
			{
				Global_1148603[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*13*/][*uParam0 /*4*/].f_1 = { vVar1 };
			}
		}
	}
	else if (!func_64(Global_1148603[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*13*/][*uParam0 /*4*/].f_1))
	{
		Global_1148603[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*13*/][*uParam0 /*4*/].f_1 = { 0f, 0f, 0f };
	}
}
...
int func_32(int iParam0, bool bParam1)
{
	...
	if (!func_65(iParam0, bParam1))
	{
		...
		return func_68(&Var0, func_67(0, 8));
	}
	return 1;
}
...
bool func_34(int iParam0)
{
	...
	iVar0 = 1;
	iVar2 = VEHICLE::_GET_NUM_CARS_FROM_TRAIN_CONFIG(iParam0);
	iVar3 = 0;
	iVar3 = 0;
	while (iVar3 <= (iVar2 - 1))
	{
		iVar1 = VEHICLE::_GET_TRAIN_MODEL_FROM_TRAIN_CONFIG_BY_CAR_INDEX(iParam0, iVar3);
		if (iVar1 != 0)
		{
...
{
	return Global_1148491.f_2[iParam0 /*18*/].f_3;
}

var func_36(int iParam0)
{
	return Global_1148491.f_2[iParam0 /*18*/].f_6;
}
...
bool func_38(var uParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!NETWORK::CAN_REGISTER_MISSION_VEHICLES(VEHICLE::_GET_NUM_CARS_FROM_TRAIN_CONFIG(iParam1)))
	{
	}
	...
	if (bParam7)
	{
		iVar1 = VEHICLE::_GET_NUM_CARS_FROM_TRAIN_CONFIG(iParam1);
		iVar0 = 0;
		while (iVar0 <= (iVar1 - 1))
		{
			if (!func_70(VEHICLE::_GET_TRAIN_MODEL_FROM_TRAIN_CONFIG_BY_CAR_INDEX(iParam1, iVar0)))
			{
				bVar2 = true;
			}
			iVar0++;
	...
	VEHICLE::_0x06A09A6E0C6D2A84(iVar3, false);
...
bool func_45(var uParam0, var uParam1)
{
	...
	else if (Global_1149020.f_2[*uParam1 /*43*/].f_3 == 0f)
	{
		return true;
	}
	...
	else if (Global_1149020.f_2[*uParam1 /*43*/] != 3)
	{
		return true;
	}
...
bool func_46(var uParam0)
{
	...
	while (iVar0 <= 31)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)) && func_73((*uParam0)[iVar0], iVar1))
		{
			return true;
		}
		iVar0++;
...
void func_47(var uParam0, var uParam1)
{
	...
	if (iVar3 < iVar1)
	{
		...
		{
			func_74(uParam0, uParam1, iVar2, uParam1->f_4[iVar3]);
		}
		iVar2++;
	}
	else
...
{
	Global_1149020.f_2[iParam0 /*43*/].f_2 = iParam1;
}
...
{
	return Global_1149020.f_2[iParam0 /*43*/].f_6;
}
...
bool func_52(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 31)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(PLAYER::INT_TO_PLAYERINDEX(iVar0)) && func_73(Global_1148603[iVar0 /*13*/][iParam0 /*4*/], iParam1))
		{
			return true;
		}
		iVar0++;
...
{
	Global_1149020.f_2[iParam0 /*43*/].f_6 = uParam1;
}
...
{
	Global_1149020.f_2[iParam0 /*43*/].f_5 = iParam1;
}
...
{
	Global_1149020.f_2[iParam0 /*43*/].f_12[iParam1 /*2*/] = uParam2;
}

void func_58(int iParam0, int iParam1, int iParam2)
{
	Global_1149020.f_2[iParam0 /*43*/].f_12[iParam1 /*2*/].f_1 = iParam2;
}

void func_59(int iParam0, int iParam1)
{
	if (!func_73(Global_1148603[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*13*/][iParam0 /*4*/], iParam1))
	{
		func_75(&(Global_1148603[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*13*/][iParam0 /*4*/]), iParam1);
	}
}
...
void func_62()
{
	...
	uVar7 = 1;
	iVar0 = func_76(&uVar3, &uVar7, 3, Global_34, iVar2, 0, 0, 0, -1, 1, 1, -1f, 0, 1);
	iVar1 = 0;
	while (iVar1 <= (iVar0 - 1))
	{
		if ((ENTITY::DOES_ENTITY_EXIST(uVar3[iVar1]) && !ENTITY::IS_ENTITY_DEAD(uVar3[iVar1])) && !LAW::_0x40851BCC33ACD9AB(uVar3[iVar1]))
		{
			...
			Var9.f_6 = func_77();
			Var9.f_9 = 1;
			Var9.f_2 = 1.868031E+22f;
			Var9.f_8 = 1;
			LAW::_0x018F30D762E62DF8(uVar3[iVar1], &Var9);
			func_78(uVar3[iVar1], Global_34, 2, 1, 1);
			TASK::TASK_FLEE_PED(uVar3[iVar1], Global_33, 3, 0, -1f, -1, 0);
		}
		iVar1++;
	}
}
...
bool func_63(var uParam0)
{
	...
	fVar4 = Global_1149020.f_2[*uParam0 /*43*/].f_3;
	if (fVar4 > 0f)
	{
		fVar5 = (fVar4 + 1112014848);
		fVar6 = BUILTIN::VDIST(Global_34, vVar1);
		if (fVar6 > fVar5 && !func_81(*uParam0))
		{
			func_80(uParam0, 1);
			return true;
		}
...
{
	return func_84(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 4.795139E-15f, iParam0, iParam1);
}
...
{
	return func_73(Global_1149020.f_1, iParam0);
}
...
void func_74(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	fVar3 = 1109393408; /* Float: 40f */
	if (!VOLUME::IS_VOLUME_LOCK_REQUEST_VALID(uParam0->f_3[iParam2]))
	{
		iVar4 = MISC::GET_HASH_KEY("NET_TRAIN");
		if (VOLUME::DOES_VOLUME_COLLIDE_WITH_ANY_VOLUME_LOCK(vVar0, fVar3, true, 0, iVar4))
		{
			return;
		}
		Var5 = { vVar0 };
		Var5.f_4 = 1109393408; /* Float: 40f */
		Var5.f_6 = MISC::GET_HASH_KEY("NET_TRAIN");
		Var5.f_7 = *uParam1;
		Var5.f_5 = 48;
		uParam0->f_3[iParam2] = VOLUME::REQUEST_VOLUME_LOCK_WITH_ARGS(&Var5);
	}
	...
	else
	{
		...
		{
			VOLUME::_MODIFY_VOLUME_LOCK_LOCATION(uParam0->f_8[iParam2], vVar0);
		}
	}
}
...
int func_76(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	int iVar0;
	int iVar1;
	...
	iVar1 = func_86(uParam0, uParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_87(iVar0);
	return iVar1;
}
...
void func_78(int iParam0, vector3 vParam1, int iParam4, bool bParam5, int iParam6)
{
...
var func_84(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_90());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_90());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_90());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_91(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1295619.f_149[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_93(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
int func_86(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar6 > 0)
	{
		...
		while (iVar5 < iVar6)
		{
			...
			{
				if (func_95(iVar2, bParam4, bParam6, bParam8, bParam9, bParam10) && !DECORATOR::DECOR_EXIST_ON(iVar2, "bIgnoreThisPed"))
				{
					if (!func_96(iVar2, uParam1))
					{
						bVar3 = false;
						if (iParam7 != -1)
						{
...
bool func_95(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
{
	return func_105(iParam0, Global_1893611.f_2, bParam1);
}
...
int func_105(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_106(iParam1, &uVar0, &iVar1, 0, 0))
	{
		return -1;
	}
	return func_107(iParam0, uVar0, iVar1, bParam2);
}

bool func_106(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_107(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_108(iVar2) != 0 && PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_109(iVar2)))
		{
			if (func_109(iVar2) == iVar0)
			{
				return iVar2;
			}
		}
