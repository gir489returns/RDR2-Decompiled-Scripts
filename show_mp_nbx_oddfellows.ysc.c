...
bool func_21(var uParam0)
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		uParam0->f_23 = 4;
		uParam0->f_2 = 0;
		uParam0->f_1401[0] = -1.473874E-35f;
		uParam0->f_1401[1] = -3.243742E-14f;
		uParam0->f_1401[2] = 1.565532E+19f;
		uParam0->f_1401[3] = 45.29495f;
		uParam0->f_1385[0] = 6.284094E-27f;
...
int func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_175(uParam0[iVar0 /*5*/], func_173(iParam2), func_174(iParam2, iVar3), 1f))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_175(&(uParam0->f_31[iVar0 /*5*/]), func_177(iParam2), func_178(iParam2, iVar4), 1f))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_175(&(uParam0->f_107[iVar0 /*5*/]), func_180(iParam2), func_181(iParam2, iVar5), 1f))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_175(&(uParam0->f_118[0 /*5*/]), func_182(iParam2, 0), func_183(iParam2, 0), 1f))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_175(&(uParam0->f_118[1 /*5*/]), func_182(iParam2, 1), func_183(iParam2, 1), 1f)) && func_175(&(uParam0->f_118[2 /*5*/]), func_182(iParam2, 2), func_183(iParam2, 2), 1f))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_175(&(uParam0->f_118[iVar0 /*5*/]), func_182(iParam2, 0), func_183(iParam2, iVar6), 1f))
					{
						iVar2++;
					}
					iVar0++;
...
void func_134(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		if (func_13(*uParam0, 64))
		{
			...
			if (func_13(*uParam0, 512) && func_199(&(uParam1->f_118[0 /*5*/]), func_197(uParam1), &(uParam1->f_238), 1056964608 /* Float: 0.5f */, func_187(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_201(&(uParam1->f_118[0 /*5*/]), func_200(uParam1), &(uParam1->f_238), 1056964608 /* Float: 0.5f */, func_187(uParam1)))
			{
		...
		if (func_13(*uParam0, 16384))
		{
			...
			if (func_13(*uParam0, 131072) && func_204(1, 2, &(uParam1->f_118), func_202(uParam1), &(uParam1->f_241), 1056964608 /* Float: 0.5f */, func_187(uParam1)))
			{
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_206(1, 2, &(uParam1->f_118), func_205(uParam1), &(uParam1->f_241), 1056964608 /* Float: 0.5f */, func_187(uParam1)))
			{
		...
		{
			bVar0 = true;
			if (!func_188(&(uParam1->f_31), func_191(uParam1), &(uParam1->f_232), 1036831949 /* Float: 0.1f */, func_187(uParam1)))
			{
				bVar0 = false;
			}
			if (bVar0)
		...
		{
			bVar1 = true;
			if (!func_190(&(uParam1->f_31), func_193(uParam1), &(uParam1->f_232), 1036831949 /* Float: 0.1f */, func_187(uParam1)))
			{
				bVar1 = false;
			}
			if (bVar1)
...
{
	return func_212(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 4.795139E-15f, iParam0, iParam1);
}
...
Vector3 func_153(int iParam0)
{
	...
	{
		case 0:
			return 1159697174, -995900596, 1111809497;
		default:
			break;
	}
	return 1159697174, -995900596, 1111809497;
...
bool func_175(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	if (uParam0->f_1 == 0)
	{
...
bool func_233(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_236(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_237())
	{
		return func_236(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_236(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
