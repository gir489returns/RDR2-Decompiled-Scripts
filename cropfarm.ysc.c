...
bool func_13()
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 1119.103f, 491.625f, 94.789f, 0f, 0f, 40.29281f, 4.983408f, 12.47093f, 20f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 1116.402f, 489.3356f, 94.789f, 0f, 0f, 40.29281f, 11.85608f, 5.358582f, 20f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 1178.083f, 428.8635f, 93.85277f, 0f, 0f, 53.30451f, 6.700057f, 7.386477f, 11.96838f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 1122.726f, 433.0324f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 1117.072f, 440.526f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 1111.182f, 447.2959f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, joaat("SMB_LEAF_DECALS_27"), 410.6769f, 92.74591f, 0f, 0f, -42.87345f, 53.38902f, 36.78405f, 32.92925f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1183.084f, 409.2454f, 94.789f, 0f, 0f, 62.77261f, 47.98455f, 17.14376f, 15.40531f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1155.914f, 449.3743f, 96.1861f, 0f, 0f, 47.14103f, 50.95671f, 69.55695f, 12.92893f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1195.093f, 434.533f, 81.04297f, 0f, 0f, 0f, 7.797928f, 12.21736f, 21.62953f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1170.392f, 385.8856f, 94.80865f, 0f, 0f, 21.33961f, 15.42121f, 9.785769f, 12.92893f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1125.095f, 489.7792f, 81.04297f, 0f, 0f, 0f, 22.93393f, 22.40263f, 21.62953f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 1116.016f, 455.3546f, 94.789f, 0f, 0f, 39.8431f, 36.45f, 74.7347f, 15.40531f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, 1125.095f, 466.7386f, 81.04297f, 0f, 0f, 31.95184f, 48.08396f, 52.23304f, 21.62953f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, 1151.546f, 440.5756f, 81.04297f, 0f, 0f, -44.24499f, 55.60196f, 50.99452f, 21.62953f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, 1158.093f, 392.0394f, 81.04297f, 0f, 0f, -24.17386f, 18.53472f, 13.09556f, 21.62953f);
...
void func_30(int iParam0)
{
	...
	func_58(739, iLocal_17, 1);
	func_58(740, iLocal_17, 0);
	func_58(742, iLocal_17, 0);
	VOLUME::_0x4A8FEFC43FD8AC9B(iLocal_17, 3, 1);
	VOLUME::_0x53D05D60E5F5B40C(iLocal_17, 3, 1, func_59(740));
	VOLUME::_0x53D05D60E5F5B40C(iLocal_17, 3, 1, func_59(742));
...
void func_64()
{
	...
	iVar0 = PERSCHAR::_0x112DDF56300BC6E5(-3.775564E+37f);
	iVar1 = PERSCHAR::_0x112DDF56300BC6E5(-1.45127E-20f);
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar0))
	{
	...
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar1))
	{
		...
		else if (PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar1) && !TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-3.199967E-20f))
		{
...
char* func_98(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_133(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_135(func_134(Global_34));
	}
...
{
	func_140(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_141(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_118(int iParam0)
{
	...
	if (func_90(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_143(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_144(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_145(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_146(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_148(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_125(int iParam0, bool bParam1)
{
	...
	else if (func_158(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_148(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_170(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
