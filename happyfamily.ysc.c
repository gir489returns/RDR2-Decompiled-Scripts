...
char* func_95(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_137(Global_1893611.f_162);
	}
...
{
	func_144(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_145(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_114(int iParam0)
{
	...
	if (func_87(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_147(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_148(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_149(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_150(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_152(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_121(int iParam0, bool bParam1)
{
	...
	else if (func_162(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_152(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_175(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
