...
void func_32(var uParam0)
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(Global_33, false))
	{
		if (PED::GET_VEHICLE_PED_IS_IN(Global_33, false) == iVar0)
		{
			...
			if (VEHICLE::GET_DRIVER_OF_VEHICLE(iVar0) == Global_33)
			{
...
void func_33(var uParam0)
{
	if (!MAP::DOES_BLIP_EXIST(uParam0->f_7))
	{
		if (func_59(uParam0))
		{
			uParam0->f_7 = MAP::BLIP_ADD_FOR_ENTITY(1.185241E-31f, uParam0->f_6);
			MAP::SET_BLIP_SPRITE(uParam0->f_7, 1.453596E-07f, true);
		}
	}
...
void func_35(var uParam0)
{
	...
	if (!MAP::DOES_BLIP_EXIST(uParam0->f_7))
	{
		...
		{
			uParam0->f_7 = MAP::BLIP_ADD_FOR_ENTITY(1.185241E-31f, uParam0->f_6);
			MAP::SET_BLIP_SPRITE(uParam0->f_7, -5.595988E+15f, true);
		}
	}
...
int func_41(int iParam0, bool bParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam0))
	{
		if (func_66(iParam0) != bParam1)
		{
			...
			if (TASK::GET_IS_CARRIABLE_ENTITY(iParam0))
			{
...
int func_85(struct<2> Param0)
{
	...
	while (iVar6 <= iVar7)
	{
		...
		func_93(Global_1072759.f_19487.f_1[iVar8 /*3*/], &vVar3);
		if (vVar3.x > vVar0.x)
		{
			iVar7 = (iVar8 - 1);
		}
...
bool func_93(struct<2> Param0, bool bParam2)
{
	if (!func_49(Param0))
	{
		return false;
...
bool func_94(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_98(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_99())
	{
		return func_98(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_98(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
