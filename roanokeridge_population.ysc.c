...
void func_2()
{
	...
	FLOCK::_0xF2CCA7B68CFAB2B9(1.783083E-06f, 2638.8f, 1972.1f, 185.1f, vVar0, vVar3, 9.5f, 50f, 1f, 6f);
}
...
void func_3()
{
	...
	func_8(iLocal_22);
	iLocal_23 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2930f, 1360f, 75f, 0f, 0f, 0f, 170f, 170f, 75f, "m_volAnnesburg_Restriction");
	func_9(iLocal_23);
	iLocal_24 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2350f, 1370f, 105f, 0f, 0f, 0f, 35f, 35f, 15f, "m_volBeaverHollow_Restriction");
	func_9(iLocal_24);
	iLocal_25 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2590f, 827.5f, 85f, 0f, 0f, 0f, 80f, 80f, 20f, "m_volButchersCreek_Restriction");
	func_9(iLocal_25);
	iLocal_26 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2270f, -95f, 45f, 0f, 0f, 0f, 65f, 65f, 15f, "m_volMacleansHouse_Restriction");
	func_8(iLocal_26);
	iLocal_27 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(3085f, 2232.5f, 210f, 0f, 0f, 7f, 130f, 150f, 75f, "m_volRockySeven_Restriction");
	func_10(iLocal_27, 0, 0);
	iLocal_28 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2965f, 475f, 45f, 0f, 0f, 0f, 75f, 75f, 15f, "m_volTallulahJetty_Restriction");
	func_10(iLocal_28, 0, 0);
	iLocal_29 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2518.25f, 2293f, 185.25f, 0f, 0f, 0f, 40f, 40f, 25f, "m_volTeslaLab_Restriction");
	func_10(iLocal_29, 0, 0);
	iLocal_30 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2964f, 780f, 52f, 0f, 0f, 0f, 45f, 35f, 25f, "m_volVanHornHorseShop_Restriction");
...
void func_6()
{
	...
	iVar0 = PERSCHAR::_0x112DDF56300BC6E5(3.961224E-11f);
	iVar1 = PERSCHAR::_0x112DDF56300BC6E5(3.44259E+08f);
	...
	{
		if (!func_11(2.848056E+34f))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(2.181255E-20f, Global_34))
			{
				func_12(2.848056E+34f);
			}
		}
	}
	else if (func_11(2.848056E+34f))
	{
		if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(2.181255E-20f, Global_34))
		{
			func_13(2.848056E+34f);
		}
	}
}
...
void func_14()
{
	...
	{
		PATHFIND::_REMOVE_NAVMESH_BLOCKING_VOLUME(iLocal_31);
