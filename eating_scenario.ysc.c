...
void func_6()
{
	...
	{
		func_12(0, 1095237632 /* Float: 12.5f */, 0, 0, 0);
		func_13(1092616192 /* Float: 10f */, 1);
		switch (iLocal_17)
		{
			case joaat("PROP_PLAYER_EAT_ALMONDS_COUNTER"):
			case joaat("PROP_PLAYER_EAT_ALMONDS_COUNTER_NO_DOF"):
				func_14(-1.558377E+30f);
				break;
			case joaat("PROP_PLAYER_EAT_PICKLED_EGG"):
				func_14(-3.542006E-24f);
				break;
		}
		if (func_15(1))
		{
			func_16(-1110651699 /* Float: -0.1f */, 0);
		}
	}
}
...
void func_14(bool bParam0)
{
	...
	Var0.f_1 = 20;
	if ((func_26(bParam0, 1.763507E+18f) || func_26(bParam0, 8.273569E-15f)) || func_26(bParam0, -1.230845E+19f))
	{
		bVar37 = true;
	}
	if (func_27(bParam0) == 4.324946E+36f)
	{
		...
		if (iVar39 || func_26(bParam0, -3.480943E+19f))
		{
			func_36(func_35(-3.750745E+13f), 1);
		}
		if (func_26(bParam0, -3.458856E-14f))
		{
			func_36(func_35(-2.12416E-30f), 1);
		}
		if (bVar38)
		{
			func_36(func_35(1.131948E-13f), 1);
		}
		switch (bParam0)
		{
...
{
	func_37((Global_1940013.f_9 + fParam0), bParam1);
}
...
bool func_23()
{
	...
	return func_50(Global_1956862.f_1431.f_107, 0);
}
...
void func_24(float fParam0, int iParam1)
{
	...
	iVar1 = func_52(fVar0);
	fVar0 = (fVar0 + fParam0);
	fVar0 = func_53(fVar0, 0f, 1120403456 /* Float: 100f */);
	iVar2 = func_52(fVar0);
	if (iVar1 != iVar2)
	{
		Global_1956862.f_1431.f_107 = func_38();
		func_54(&(Global_1956862.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_55(13, fVar0, 2);
...
struct<2> func_35(float fParam0)
{
	struct<2> Var0;
...
void func_37(float fParam0, bool bParam1)
{
	if (PED::IS_PED_ON_MOUNT(Global_33) || PED::IS_PED_IN_ANY_VEHICLE(Global_33, false))
	{
		if (fParam0 >= func_69())
		{
			Global_1940013.f_9 = (func_69() - 1008981770);
			return;
		}
	}
	if (fParam0 < 0f)
...
bool func_57(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_91(iParam0, 262144) || !Global_1904398.f_8866)
		{
			return false;
		}
	}
...
{
	return func_107(&(Global_1956862.f_1565), iParam0, 1);
}
...
bool func_95(int iParam0)
{
	...
	fVar0 = (func_110(iParam0) - PLAYER::_GET_PLAYER_CACHED_DEAD_EYE_AMOUNT(iParam0));
	return fVar0 <= 1f;
}
...
{
	func_22(iParam0, 1120403456 /* Float: 100f */, bParam1, bParam2, 1, 2);
}
...
{
	return (PLAYER::_GET_PLAYER_MAX_DEAD_EYE(iParam0, 0) - IntToFloat(func_113(2)));
}
...
int func_112(int iParam0)
{
	...
	iVar3 = func_116(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_117(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1156096.f_35859.f_11700)
				{
					...
					{
						func_118(iVar1, iParam0, iVar4);
						func_119(&(Global_1156096.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_119(&(Global_1156096.f_35859.f_9503[Global_1156096.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_123(&(Global_1156096.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
int func_118(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_127(Global_1156096.f_35859.f_3116[iVar0 /*31*/]) && func_128(iParam0, Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_129(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_130(vVar1))
		{
			if (func_131(vVar1.x, vVar1.y, vVar1.z))
			{
				func_132(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_133(Global_1156096.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_126(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_116(Global_1156096.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1156096.f_2169[iVar5 /*205*/].f_201 = (Global_1156096.f_2169[iVar5 /*205*/].f_201 - func_138(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_139(iVar3);
		}
		iVar4++;
	}
...
bool func_131(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_148(&(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_150(Global_1156096.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
float func_138(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		fVar0 = func_157(1.959415E-10f, uParam0->f_2, uParam0->f_1, "");
		return fVar0;
	}
	return uParam0->f_1;
}
...
void func_139(int iParam0)
{
	...
	iVar0 = func_136(iParam0, 1);
	if (!func_158(Global_1156096.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_159(Global_1156096.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_160(Global_1156096.f_2169[iVar0 /*205*/].f_203, 1);
...
int func_145(int iParam0)
{
	...
	{
		iVar64 = func_120(Global_1156096.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_168(Global_1156096.f_35859.f_9503[iVar65 /*3*/], Global_1156096.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_169(Global_1156096.f_35859.f_9503[iVar65 /*3*/]) };
...
bool func_148(var uParam0)
{
	...
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_170(1.959415E-10f, uParam0->f_1, 1, "");
		return bVar0;
	}
	return true;
}
...
void func_161()
{
	...
	{
		if (!func_177(Global_1297553[Global_1295619 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_168(int iParam0, int iParam1)
{
	...
	if (func_127(Global_1156096.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1156096.f_35859.f_9286[func_144(iVar2, 1) /*3*/];
		Var4 = { func_169(iVar3) };
	...
	switch (Global_1156096.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1295619 && !func_180(Global_1295619.f_149[iVar1]))
			{
				return false;
			}
