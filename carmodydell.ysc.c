	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-1.042271E+15f, 0.4424044f))
		{
			switch (iLocal_23)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_74(iLocal_23, 0), 1);
					break;
			}
		}
		if (func_10(func_67()))
...
void func_68(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_82(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
...
void func_114(int iParam0)
{
	...
	if (func_86(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_140(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
