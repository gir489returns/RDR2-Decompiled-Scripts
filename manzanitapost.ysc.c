...
bool func_13()
{
	iLocal_19 = Global_1887363[116 /*36*/].f_5;
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1987.5f, -1619.5f, 119f, 0f, 0f, 108f, 13f, 7.5f, 3.3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1993.957f, -1616.896f, 119f, 0f, 0f, 108f, 4f, 3.2f, 3.3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1993.276f, -1625.02f, 118.1032f, 0f, 0f, 18.70994f, 6.771215f, 10.15464f, 4.094861f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, -1979.72f, -1641.667f, 118.1032f, 0f, 0f, 18.70994f, 18.24065f, 21.29219f, 4.094861f);
	iLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Manzanita - m_volArtistOwner Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -1978.791f, -1668.522f, 118.1032f, 0f, 0f, 144.4009f, 7.96674f, 8.658496f, 4.094861f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, -1975.129f, -1655.416f, 118.1032f, 0f, 0f, 106.1859f, 3.915041f, 4.647958f, 4.094861f);
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_109(&cVar6, 4.808429E-35f), sVar9, func_109(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_109(&cVar6, 4.808429E-35f), func_109(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_110(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_72(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_112(&Global_1940186, 16384);
	func_114(func_113(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_114(func_113(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_114(func_113(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_114(func_113(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_114(func_113(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_114(func_113(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_114(func_113(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
struct<2> func_113(float fParam0, float fParam1)
{
	struct<2> Var0;
...
void func_116(int iParam0)
{
	...
	if (func_88(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_142(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
...
{
	func_169(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
