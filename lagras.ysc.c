...
bool func_13()
{
	...
	iLocal_19 = Global_1887363[3 /*36*/].f_5;
	...
	iLocal_25 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-9.406495E-20f, 1964.789f, -528.676f, 41.852f, 0f, 0f, 0f, 1f, 1f, 2f);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_HORSE(iLocal_25, true);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_PLAYER(iLocal_25, true);
	iLocal_26 = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(-9.406495E-20f, 1966.414f, -528.38f, 41.852f, 0f, 0f, 0f, 3.2f, 7.3f, 2f);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_HORSE(iLocal_26, true);
	VOLUME::_SET_ANTI_GRIEF_VOLUME_BLOCKS_PLAYER(iLocal_26, false);
	return true;
}
...
{
	func_58(14, iLocal_20, iParam0, iLocal_21, 0, 4, 0, 0, -1f, 0);
	func_59(14, 0);
	func_58(39, iLocal_22, iParam0, iLocal_23, iLocal_24, 2097164, 1, 0, -1f, 0);
	func_60(39, 65536);
	func_60(39, 32768);
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_Naturalist_Camp", true, true);
	AUDIO::_SET_AMBIENT_ZONE_POSITION("AZ_Naturalist_Camp", VOLUME::GET_VOLUME_COORDS(iLocal_22), 0f);
	func_61(39, 4096);
}
...
{
	iParam0 = iParam0;
	func_63(1061997773 /* Float: 0.8f */, 1045220557 /* Float: 0.2f */, 0f, 0f);
}
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((func_105(iParam0, 16384) || func_105(iParam0, 32768)) || func_106(Global_1051832.f_92[iParam0 /*75*/].f_3))
	{
	...
	if ((!bParam1 && func_108(iVar0, &iVar1, &fVar2, &vVar3)) || (bParam1 && func_109(iVar0, &iVar1, &fVar2, &vVar3)))
	{
		func_110(iParam0, iVar1, vVar3, fVar2, 0);
...
void func_61(int iParam0, int iParam1)
{
	...
	func_111(&(Global_1915643.f_3[iParam0 /*447*/].f_7), iParam1);
}
...
void func_63(int iParam0, int iParam1, int iParam2, float fParam3)
{
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_65(iParam0) && func_88(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_131(&cVar6, 4.808429E-35f), sVar9, func_131(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_131(&cVar6, 4.808429E-35f), func_131(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_132(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_76(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_134(&Global_1940186, 16384);
	func_136(func_135(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_136(func_135(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_136(func_135(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_136(func_135(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_136(func_135(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_136(func_135(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_136(func_135(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_83(int iParam0)
{
	...
	func_63(1061578342 /* Float: 0.775f */, 1045220557 /* Float: 0.2f */, 1020054733 /* Float: 0.025f */, 0f);
	iParam0 = iParam0;
}
...
void func_99(int iParam0, bool bParam1)
{
	...
	else if (func_160(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_163(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
bool func_108(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_170(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", vParam3);
}

bool func_109(int iParam0, int* iParam1, float* fParam2, Vector3* vParam3)
{
	return func_170(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", vParam3);
}

void func_110(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051832.f_92[iParam0 /*75*/].f_6 = func_171(iParam1, vParam2, fParam5, 0, 0, 0);
...
char* func_119(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_176(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_178(func_177(Global_34));
	}
...
char* func_131(char* sParam0, int iParam1)
{
	...
	return func_182(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
struct<2> func_135(float fParam0, float fParam1)
{
	struct<2> Var0;
...
{
	func_183(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_184(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_138(int iParam0)
{
	...
	if (func_92(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_186(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_187(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_188(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_189(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_163(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
bool func_160(int iParam0, float fParam1)
{
...
int func_169(int iParam0)
{
	...
	if (DATAFILE::PARSEDDATA_IS_FILE_LOADED(Global_1149417.f_7) && !func_210(12, func_209(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_170(int iParam0, char* sParam1, int* iParam2, char* sParam3, float* fParam4, char* sParam5, Vector3* vParam6)
{
	struct<4> Var0;
...
int func_171(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, bool bParam7)
{
...
{
	func_219(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_197(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_227(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_228())
	{
		return func_227(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_227(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_231(int iParam0, int iParam1, bool bParam2)
{
	*bParam2 = Global_1149417.f_7;
	...
	bParam2->f_3 = func_240(iParam0);
	bParam2->f_4 = iParam1;
	return DATAFILE::PARSEDDATA_RQ_FILLOUT_NODE(&(bParam2->f_1), bParam2);
}

void func_232(bool bParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_241(struct<2> Param0, bool bParam2)
{
	if (!func_214(Param0))
	{
		return false;
