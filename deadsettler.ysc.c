...
{
	STREAMING::REQUEST_MODEL(6.196482E+07f, false);
	PED::_RESERVE_AMBIENT_PEDS(6);
	iLocal_21 = ANIMSCENE::_CREATE_ANIM_SCENE(func_53(), 8, func_54(), false, true);
...
bool func_40(int iParam0)
{
	...
	{
		case 0:
			if ((((STREAMING::HAS_MODEL_LOADED(6.196482E+07f) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY()) && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_21)) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_21, true, false)) && !func_62())
			{
				iLocal_22 = 1;
			}
			break;
		...
		case 4:
			func_69();
			ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_21, func_54());
			iLocal_22 = 5;
			break;
		case 5:
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_21) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_21, true, false)) && ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iLocal_21, func_54()))
			{
				ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(iLocal_21, func_54(), true);
				ANIMSCENE::START_ANIM_SCENE(iLocal_21);
				iLocal_22 = 6;
			}
			break;
		case 6:
			if (ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_21, false))
			{
				func_70();
				func_71();
				iLocal_22 = 7;
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_34, 0f, 0f, 0f) <= 5f || func_72(Global_1940186, 32768)) || func_72(Global_1940186, 2.350989E-38f))
	{
		return;
	}
...
bool func_62()
{
	return func_72(Global_1940186, 8192);
}
...
int func_63()
{
	...
	if (((((func_102(&(uLocal_14[0]), 6.196482E+07f, &uVar0, func_100(0), func_101(0)) && func_102(&(uLocal_14[1]), 6.196482E+07f, &uVar0, func_100(1), func_101(1))) && func_102(&(uLocal_14[2]), 6.196482E+07f, &uVar0, func_100(2), func_101(2))) && func_102(&(uLocal_14[3]), 6.196482E+07f, &uVar0, func_100(3), func_101(3))) && func_102(&(uLocal_14[4]), 6.196482E+07f, &uVar0, func_100(4), func_101(4))) && func_102(&(uLocal_14[5]), 6.196482E+07f, &uVar0, func_100(5), func_101(5)))
	{
		return 1;
	}
	return 0;
...
void func_66()
{
	func_105(uLocal_14[0], -7.063968E-37f);
	func_105(uLocal_14[1], 1.888959E+30f);
	func_105(uLocal_14[2], 8.330584E-30f);
	func_105(uLocal_14[3], -9.068712E+36f);
	func_105(uLocal_14[4], -7.714744E-05f);
	func_105(uLocal_14[5], -4.19545E-13f);
}
...
void func_69()
{
	...
	while (iVar0 < 6)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_14[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_14[iVar0]))
		{
			sVar1 = func_108(iVar0);
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar1) && ANIMSCENE::_DOES_ENTITY_WITH_ID_EXIST_IN_ANIM_SCENE(iLocal_21, sVar1))
			{
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_21, sVar1, uLocal_14[iVar0], 0);
			}
		}
		iVar0++;
	}
...
void func_78(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_92(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_124(&cVar6, 4.808429E-35f), sVar9, func_124(&cVar10, 4.808429E-35f));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_124(&cVar6, 4.808429E-35f), func_124(&cVar10, 4.808429E-35f));
		}
		Global_1893611.f_9 = 0;
	}
	Global_1939089.f_145 = func_125(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_80(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_127(&Global_1940186, 16384);
	func_129(func_128(-7.103403E-17f, -3.542793E+37f), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_129(func_128(-7.103403E-17f, 2.866541E-31f), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_129(func_128(-7.103403E-17f, 3.024173E-30f), 1);
			break;
		case 3:
		case 10:
			func_129(func_128(-7.103403E-17f, 1.603649E+10f), 1);
			break;
		case 4:
		case 9:
			func_129(func_128(-7.103403E-17f, 497.0886f), 1);
			break;
		case 8:
			func_129(func_128(-7.103403E-17f, -4.726794E+32f), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_129(func_128(-7.103403E-17f, -1566073f), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_87(int iParam0)
{
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(6.196482E+07f);
...
Vector3 func_100(int iParam0)
{
	...
	{
		case 0:
			return -989944863, -991053811, 1121642178;
		case 1:
			return -989992036, -990802332, 1121524043;
		case 2:
			return -989932471, -991076614, 1121628966;
		case 3:
			return -989728421, -991148160, 1122065410;
		case 4:
			return -989988731, -990820636, 1121543415;
		case 5:
			return -989795927, -990852104, 1122025013;
	}
	return 0f, 0f, 0f;
}
...
float func_101(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			return 1127272284;
		case 1:
			return 1119343084 /* Float: 91.91f */;
		case 2:
			return -1027549430;
		case 3:
			return -1023965921;
...
char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_154(Global_1893611.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_156(func_155(Global_34));
	}
...
char* func_124(char* sParam0, int iParam1)
{
	...
	return func_160(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

int func_125(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	int iVar16;
...
struct<2> func_128(float fParam0, float fParam1)
{
	struct<2> Var0;
...
{
	func_161(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_162(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_131(int iParam0)
{
	...
	if (func_96(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_164(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_165(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_166(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_167(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_169(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_138(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_169(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_192(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
