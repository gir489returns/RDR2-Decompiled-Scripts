...
bool func_40(int iParam0)
{
	...
	if (func_61(&bLocal_17))
	{
		if (bLocal_17)
		{
			func_62(2.514747E+35f, 1, -1f, 0, 0, 0, 0, 0);
			func_63(2.514747E+35f, 1, 1);
		}
	}
	return true;
}
...
void func_60()
{
	...
	bVar0 = false;
	if (func_93(3.830978E-26f) || func_93(-0.0001690958f))
	{
		bVar0 = true;
	}
	if (bVar0 != bLocal_16)
	{
		if (bVar0)
		{
			if (!STREAMING::IS_IPL_ACTIVE_HASH(-2.049931E+12f))
			{
				func_94(-2.049931E+12f);
			}
		}
		else if (STREAMING::IS_IPL_ACTIVE_HASH(-2.049931E+12f))
		{
			func_95(-2.049931E+12f);
		}
		bLocal_16 = bVar0;
	}
}
...
char* func_106(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_146(Global_1893611.f_162);
	}
...
{
	func_153(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_154(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_125(int iParam0)
{
	...
	if (func_89(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_156(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_157(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_158(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_159(iParam0, 1.084202E-19f);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_161(Global_1915643.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_132(int iParam0, bool bParam1)
{
	...
	else if (func_171(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_161(Global_1051832.f_92[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_185(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
