...
bool func_8(var uParam0)
{
	...
	func_39(uParam0->f_6, *uParam0, uParam0->f_1, 10f);
	switch (func_30(uParam0))
	{
		case 0:
			...
			func_40(&(uParam0->f_28.f_6), uParam0->f_6, 1069547520 /* Float: 1.5f */, 1, 319, 0);
			if (func_27(uParam0, 32))
			{
				func_32(uParam0, 1);
			}
		...
		case 5:
			if (func_44(uParam0, 15f))
			{
				if (!func_33(uParam0->f_14))
				{
					uParam0->f_14 = func_45("UC_CLT_DIG", -7.068217E+21f, uParam0->f_6, 1.6f, 3, 1, 0, 4, 570, 4000, 10, 2f, 0, 8.750548E+22f, 0);
				}
				func_32(uParam0, 6);
			}
			break;
...
void func_20(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		Var8.f_4 = 103;
		func_72(Var8, func_71(Global_34, 0f, 0f, 0f, 1133903872 /* Float: 300f */, 1133903872 /* Float: 300f */, 1133903872 /* Float: 300f */, -2.19652E+23f, 0, 8), 0, 0);
	}
	func_73(&Var1, &iVar0);
}
...
{
	func_74(&(Global_1222312[iParam0 /*251*/][iParam1]), iParam2);
}
...
{
	if (func_80(6.914108E-36f, 1))
	{
		if (bParam0)
		{
			if (func_80(-8.284301E+07f, 1))
			{
				return true;
			}
		}
...
void func_37(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	bool bVar1;
	float fVar2;
	...
	bVar1 = func_82(uParam0, bParam4, bVar0);
	if (!bVar1)
	{
		if (uParam0->f_8)
		{
...
void func_38(int iParam0)
{
	...
	if (func_33(iParam0))
	{
		...
		if ((((((((((((PED::IS_PED_CARRYING_SOMETHING(Global_1295619.f_3) || TASK::IS_PED_GETTING_UP(Global_1295619.f_3)) || PED::IS_PED_RAGDOLL(Global_1295619.f_3)) || !func_88()) || Global_1102813.f_3664) || ENTITY::DOES_ENTITY_EXIST(iVar0)) || PED::IS_PED_JUMPING(Global_1295619.f_3)) || PED::IS_PED_CLIMBING(Global_1295619.f_3)) || PED::IS_PED_FALLING(Global_1295619.f_3)) || PED::IS_PED_HOGTIED(Global_33)) || func_89(Global_33)) || PED::IS_PED_IN_MELEE_COMBAT(Global_33)) || PED::IS_PED_PERFORMING_MELEE_ACTION(Global_33, 1, 0))
		{
			if (func_90(iParam0, 0))
			{
				func_91(iParam0, 0, 1, 1);
			}
		}
		else if (!func_90(iParam0, 0))
		{
			func_91(iParam0, 1, 1, 1);
		}
	}
}
...
Vector3 func_42(vector3 vParam0, float fParam3)
{
	...
	vVar0 = { func_93(vParam0) };
	vVar3 = { func_95(func_95(vVar0, func_94((fParam3 - 1119092736))), vVar0) };
	...
	vVar11 = { func_95(vVar8, vVar3) };
	fVar14 = (MISC::ATAN2((func_96(vVar8, vVar0) / BUILTIN::VMAG(vVar8)), (func_96(vVar11, vVar0) / BUILTIN::VMAG(vVar11))) + 1127481344);
...
bool func_44(var uParam0, float fParam1)
{
	if (func_80(6.914108E-36f, 1))
	{
		...
		{
			if ((func_27(uParam0, 2) && func_27(uParam0, 1)) && func_52(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), uParam0->f_6, 1) <= 1070386381)
			{
				return true;
			}
		}
		if (func_27(uParam0, 2))
		{
			if (func_54(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) == -8.284301E+07f && func_52(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), uParam0->f_6, 1) <= 1070386381)
			{
				return true;
			}
		}
...
int func_45(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 60)
	{
		if (func_98(iVar0, 2))
		{
			if (func_99(vParam2, Global_1951897[iVar0 /*23*/].f_6, 1008981770 /* Float: 0.01f */, 1) && iParam1 == Global_1951897[iVar0 /*23*/].f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
	...
	if (iVar1 != 0)
	{
		func_100(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, 1f, 0, 0, 0, bParam15, iParam16);
		return iVar1;
	}
	return 0;
}
...
bool func_57(var uParam0)
{
	...
	while (!func_101(uParam0->f_23, &uVar0))
	{
		return false;
	}
	iVar5 = uParam0->f_5;
	...
	func_103(func_102(-0.08089317f, -7.367104E+22f), 1);
	if (func_27(uParam0, 2))
	{
		func_103(func_102(-0.08089317f, 2.217208E-35f), 1);
	}
	return true;
}
...
void func_59(bool bParam0, bool bParam1)
{
	if (bParam1)
	{
		func_104(-6.59161E+11f, 0, 255, 0, 0);
	}
	else if (bParam0)
	{
		func_104(11389876, 0, 255, 0, 0);
	}
}
...
{
	return func_71(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 4.795139E-15f, iParam0, iParam1);
}
...
var func_71(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_108());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_108());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_108());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_109(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1295619.f_149[iVar2]))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_111(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
	...
	if (!bParam20)
	{
		if (Param0.f_18)
		{
			if (bParam21)
			{
				...
				func_113(&(Global_1072759.f_22981), Var0);
				return;
			}
		}
	}
...
bool func_80(bool bParam0, int iParam1)
{
	...
	return func_120(bParam0, 0, 0, 0) >= iParam1;
}
...
int func_82(var uParam0, bool bParam1, bool bParam2)
{
	...
	{
		case 0:
			if (func_120(-4.629755E-24f, 0, 0, 0) <= 0)
			{
				return 0;
			}
			break;
...
bool func_88()
{
	if (((((!ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_33, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_33)) && !func_128(Global_33, 8.330918E+10f)) && !func_128(Global_33, 2.446422E-13f)) && !TASK::IS_PED_RUNNING_TASK_ITEM_INTERACTION(Global_33)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_33, false))
	{
		return true;
	}
	return false;
...
Vector3 func_93(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
bool func_99(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_100(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, float fParam18, float fParam19, float fParam20, bool bParam21, bool bParam22, int iParam23, bool bParam24, bool bParam25)
{
	int iVar0;
...
bool func_101(int iParam0, var uParam1)
{
	...
	Var0.f_1 = 10;
	func_139(&Var0, 2.95884E+10f);
	return func_140(iParam0, &Var0, uParam1, 0, 0);
}

struct<2> func_102(float fParam0, float fParam1)
{
	struct<2> Var0;
...
int func_104(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<2> Var0;
	struct<2> Var12;
	var uVar25;
	...
	Var0.f_1 = 10;
	Var12.f_1 = 11;
	return func_141(bParam0, &uVar25, &Var12, &Var0, iParam1, iParam2, iParam3, bParam4);
}
...
int func_113(var uParam0, struct<21> Param1)
{
	if (!func_145(uParam0))
	{
		return 0;
...
bool func_118(bool bParam0, int iParam1)
{
	...
	bVar0 = func_146(bParam0, iParam1);
	Var4.f_9 = -5.45926E-19f;
	if (func_147("ALL WEAPONS", &iVar1, &iVar2, -5.45926E-19f, 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
...
bool func_119(bool bParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_153(&(Global_17418.f_55.f_664.f_1354.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
...
int func_120(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_156(bParam0, -3.294982E+22f) != 0)
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_157(bParam2), bParam0, bParam3);
	}
	else
	{
		Var3 = { func_158(bParam0, bParam2) };
		if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&Var3))
		{
			return 0;
		}
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_157(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
{
	return func_163(iParam0, 3);
}

bool func_131(int iParam0)
{
	return (func_163(iParam0, 4) || func_163(iParam0, 5));
}

bool func_132(int iParam0)
{
	return func_163(iParam0, 6);
}

bool func_133(int iParam0)
{
	return func_163(iParam0, 7);
}
...
void func_135(int iParam0, bool bParam1)
{
	if (HUD::_UI_PROMPT_IS_VALID(Global_1951897[iParam0 /*23*/].f_3))
	{
		if (Global_1951897[iParam0 /*23*/].f_5 == 5 && !func_98(iParam0, 8))
		{
...
int func_140(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	var uVar0;
	struct<15> Var1;
	...
	Var1.f_3 = { *uParam1 };
	Var1.f_2 = iParam4;
	func_165(uParam2, iParam0, Var1);
	return 1;
}

int func_141(bool bParam0, var uParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	if (iVar1 != 0)
	{
		func_166(iParam2, -3.005759E+25f);
	}
	if (!bParam7)
	{
...
bool func_142(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_168(&(Global_1102813.f_4), iVar0, 5);
	}
	if (iParam1 == func_169())
	{
		return func_168(&(Global_1102813.f_4), iVar0, 5);
	...
	{
		return func_168(&(Global_1101558[iParam1 /*38*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_146(bool bParam0, int iParam1)
{
	...
	if (func_172(bParam0, 9.811189E+11f))
	{
		func_173(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return false;
}

bool func_147(char* sParam0, int iParam1, int* iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_157(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
int func_155(bool bParam0, bool bParam1)
{
	...
	Var0 = { func_174(bParam0, -5.45926E-19f, -5.45926E-19f, -5.45926E-19f, 0, 0, 0) };
	if (bParam1)
	{
		func_176(&Var0, func_175(0));
	}
	if (!func_177(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_150(iVar18);
...
int func_156(bool bParam0, int iParam1)
{
	...
	if (func_179(func_178(bParam0), 2))
	{
		return 0;
	}
...
struct<4> func_158(bool bParam0, bool bParam1)
{
	struct<5> Var0;
...
{
	func_139(uParam0, 8.505438E-34f);
	if (func_182() == 3.272964E+34f)
	{
		func_139(uParam0, 8.967694E-17f);
	}
	else
	{
		func_139(uParam0, 1.721179E-28f);
	}
}

void func_165(var uParam0, int iParam1, struct<15> Param2)
{
	int iVar0;
	struct<22> Var1;
...
void func_167(var uParam0, bool bParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
...
int func_172(bool bParam0, int iParam1)
{
	if (!func_62(bParam0, 0))
	{
		return func_184(func_178(bParam0), iParam1);
	}
	if (iParam1 == 0)
	{
		return 0;
...
void func_173(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<18> func_174(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<18> Var0;
...
struct<4> func_175(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1292096.f_4 = { func_181(8.681942E-06f, func_185(bParam0), -1.942248E+12f, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1292096.f_16 = { func_181(8.681942E-06f, func_185(bParam0), -1.942248E+12f, 0) };
		}
		return Global_1292096.f_16;
	}
	return func_181(8.681942E-06f, func_185(bParam0), -1.942248E+12f, 0);
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_157(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<4> func_181(bool bParam0, var uParam1, float fParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_157(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
struct<4> func_185(bool bParam0)
{
	...
	if (Global_1572887.f_14 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1292096 = { func_181(2.982335E+09f, func_192(), -5.45926E-19f, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1292096.f_12 = { func_181(2.982335E+09f, func_192(), -5.45926E-19f, 0) };
			}
			return Global_1292096.f_12;
		}
	}
	return func_181(2.982335E+09f, func_192(), -5.45926E-19f, bParam0);
}

int func_186(bool bParam0, bool bParam1)
{
	if (func_151(bParam0) == 4.161967E+25f)
	{
		return 0;
	}
...
{
	return func_194(bParam0, *uParam1, fParam2, iParam3, 1, fParam4) > 0;
}
...
bool func_188(bool bParam0, int iParam1, float fParam2)
{
	...
	if (func_195(bParam0, &uVar0, iParam1, fParam2))
	{
...
struct<4> func_189(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1292096.f_8 = { func_181(3.507197E-29f, func_185(bParam0), 12999093, 0) };
		}
		return Global_1292096.f_8;
	}
	return func_181(3.507197E-29f, func_185(bParam0), 12999093, 0);
}
...
bool func_190(bool bParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_196(bParam0, iParam1, iVar0))
			{
				return true;
			}
		}
...
{
	return func_197(&uParam0, iParam4, bParam5, bParam6, iParam7);
}
...
int func_193()
{
	if (func_198(-0.0002099206f, 0, 0, 0) == 0)
	{
		return 0;
	}
	return 1;
...
int func_194(bool bParam0, struct<4> Param1, float fParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_156(bParam0, -3.294982E+22f) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_157(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_157(bParam6), bParam0, bParam8);
	}
	return iVar0;
}

bool func_195(bool bParam0, int iParam1, int iParam2, float fParam3)
{
	int iVar0;

	iVar0 = func_157(0);
	*iParam1 = { func_181(bParam0, func_175(0), fParam3, 0) };
...
bool func_196(bool bParam0, int iParam1, int iParam2)
{
...
int func_198(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_199(iParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_33, iParam0);
	}
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_157(bParam1), iParam0, bParam3);
}
