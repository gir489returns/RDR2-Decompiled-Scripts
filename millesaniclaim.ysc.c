...
bool func_40(int iParam0)
{
	...
	if (func_61(&bLocal_26))
	{
		if (bLocal_26)
		{
			func_62(-1.656526E-11f, 0, 0);
			func_62(-1.245206E+36f, 0, 0);
			OBJECT::_DOOR_SYSTEM_SET_AUTOMATIC_STATE(-1.656526E-11f, false);
			OBJECT::_DOOR_SYSTEM_SET_AUTOMATIC_STATE(-1.245206E+36f, false);
		}
	}
	return false;
}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-1.042271E+15f, 0.4424044f))
		{
			switch (iLocal_33)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_76(iLocal_33, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
...
void func_114(int iParam0)
{
	...
	if (func_88(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_140(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
