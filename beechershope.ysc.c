...
bool func_13()
{
	iLocal_21 = Global_1887363[39 /*36*/].f_5;
...
{
	func_58(38, iLocal_19, iParam0, iLocal_20, 0, 12, 1, 0, -1f, 0);
	func_59(38, 0);
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_62(iParam0) && func_85(iParam0, 2.350989E-38f)) && !Global_1893611.f_9)
	{
