...
{
	func_53();
	if (!func_54(-3.245429E+19f))
	{
		return true;
	}
	iLocal_13 = Global_1887363[22 /*36*/].f_5;
...
Vector3 func_90()
{
	return -988536722, 1139555122, 1124286107;
}
...
char* func_101(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_138(Global_1893611.f_162);
	}
...
char* func_113(char* sParam0, int iParam1)
{
	...
	return func_144(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_145(Global_1939946.f_5[iParam0 /*11*/].f_6, 1);
	func_146(Global_1939946.f_5[iParam0 /*11*/].f_6, 0);
...
void func_121(int iParam0)
{
	...
	if (func_94(Global_1915643.f_3[iParam0 /*447*/].f_21) && func_148(Global_1915643.f_3[iParam0 /*447*/].f_21))
	{
		func_149(Global_1915643.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_150(Global_1915643.f_3[iParam0 /*447*/].f_9, 0);
	func_151(iParam0, 1.084202E-19f);
...
void func_128(int iParam0, bool bParam1)
{
	...
	else if (func_163(iParam0, 1.504633E-36f) && ENTITY::DOES_ENTITY_EXIST(Global_1051832.f_92[iParam0 /*75*/].f_21))
	{
...
{
	func_176(&(Global_1939946.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_169()
{
	...
	if (!func_171(Global_1051268) && Global_1572887.f_8 & 1 != 0)
	{
		return true;
	}
	return false;
